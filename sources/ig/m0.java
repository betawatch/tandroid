...
public final class m0 {
    ...
    /* JADX WARN: Removed duplicated region for block: B:151:0x06b7 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Type inference failed for: r5v40, types: [org.telegram.messenger.ImageReceiver] */
    /* JADX WARN: Type inference failed for: r5v41, types: [org.telegram.messenger.ImageReceiver] */
    /* JADX WARN: Type inference failed for: r5v46, types: [org.telegram.ui.Components.oi0] */
    /* JADX WARN: Type inference failed for: r5v50, types: [org.telegram.ui.Components.oi0] */
    /*
    ...
    */
    public m0(Context context, n2 n2Var, wj0 wj0Var, View view, View view2, float f10, float f11, q0 q0Var, int i10, int i11, boolean z10) {
        ...
        this.a = i11;
        this.v = view;
        o0 l10 = z12 ? ((s1) view).J.l(q0Var) : view instanceof v0 ? ((v0) view).y0.l(q0Var) : null;
        if (z10 && i11 == 2) {
            view3 = view2;
            o0Var = l10;
            j10 = 0;
        ...
        if (wj0Var2 != null) {
            ...
            int i19 = 0;
            while (true) {
                if (i19 >= f1Var.getChildCount()) {
                    break;
                }
                if ((f1Var.getChildAt(i19) instanceof uj0) && ((uj0) f1Var.getChildAt(i19)).e.equals(this.p)) {
                    this.t = (uj0) f1Var.getChildAt(i19);
                    break;
                }
                i19++;
            }
        ...
        if (i11 == 1) {
            ...
            if (arrayList != null && rnVar3 != null && rnVar3.a() < j10) {
                f12 = 0.0f;
                int i20 = 0;
                    ...
                    if (this.p.equals(arrayList.get(i20).reaction) && arrayList.get(i20).unread) {
                        ...
                        if (peerId < j10) {
                            ...
                            if (chat != null) {
                                ...
                                float f16 = 100.0f;
                                l0Var.e = s3.c.c(pa.f(random, 100), 100.0f, 0.1f, 0.3f);
                                l0Var.h = s3.c.c(pa.f(random, 100), 100.0f, 0.4f, 0.8f);
                                l0Var.i = (Math.abs(random.nextInt() % 100) * 60) / 100.0f;
                                l0Var.b = (int) s3.c.c(pa.f(random, 100), 100.0f, 200.0f, 400.0f);
                                float f17 = 0.2f;
                                if (this.x.isEmpty()) {
                                    int i21 = 0;
                                    float f18 = 0.0f;
                                    ...
                                    while (i21 < 10) {
                                        int i22 = i21;
                                        float d = a9.p.d(pa.f(random, 100), 0.6f, f16, f17);
                                        float d10 = a9.p.d(pa.f(random, 100), 0.4f, f16, f17);
                                    ...
                                    l0Var.f = a9.p.d(pa.f(random, 100), 0.6f, 100.0f, 0.2f);
                                    l0Var.g = (pa.f(random, 100) * 0.4f) / 100.0f;
                                }
                                this.x.add(l0Var);
                            }
                        } else {
                            ...
                            if (user != null) {
                                ...
                                float f162 = 100.0f;
                                l0Var2.e = s3.c.c(pa.f(random, 100), 100.0f, 0.1f, 0.3f);
                                l0Var2.h = s3.c.c(pa.f(random, 100), 100.0f, 0.4f, 0.8f);
                                l0Var2.i = (Math.abs(random.nextInt() % 100) * 60) / 100.0f;
                                l0Var2.b = (int) s3.c.c(pa.f(random, 100), 100.0f, 200.0f, 400.0f);
                                float f172 = 0.2f;
                                if (this.x.isEmpty()) {
                                }
                                this.x.add(l0Var2);
                ...
                rnVar = rnVar3;
                uj0 uj0Var = this.t;
                boolean z13 = uj0Var == null || !(f10 == f12 || f11 == f12);
                if (view3 == null) {
                    ...
                    if (view3 instanceof j51) {
                        float f27 = ((j51) view3).C;
                        if (f27 > f12) {
                            f15 = view3.getWidth() * ((f27 * 2.0f) + 1.0f);
                            f25 = y1.a(f15, view3.getWidth(), 2.0f, f25);
                    ...
                    uj0Var.getLocationOnScreen(this.j);
                    float x8 = this.j[0] + this.t.b.getX();
                    ...
                    if (o0Var == null) {
                        ...
                        if (i11 == i13) {
                            ...
                            int dp4 = AndroidUtilities.dp(SharedConfig.deviceIsHigh() ? 240.0f : 140.0f);
                        ...
                        j0Var = new j0(this, context2, n2Var, view5, z10, messageObject4, rnVar, i15, i11, z13, f28, f13, f14, q0Var);
                        this.i = j0Var;
                        ...
                        if (tL_availableReaction != null) {
                            ...
                            if (i11 != 2) {
                                if ((i11 == 1 && LiteMode.isEnabled(LiteMode.FLAG_ANIMATED_EMOJI_CHAT)) || i11 == 0) {
                                    ...
                                    String a2 = i11 == 1 ? a() : com.google.android.recaptcha.internal.a.l(i26, "_", i26);
                                    ImageReceiver imageReceiver2 = k0Var.getImageReceiver();
                            ...
                            if (i11 == i27) {
                                ...
                                ImageReceiver imageReceiver3 = k0Var2.getImageReceiver();
                                ...
                                k0Var2.j(ImageLocation.getForDocument(document2), com.google.android.recaptcha.internal.a.l(i24, "_", i24), null, null, 0, null);
                            } else if (i11 == 0) {
                                ...
                                sb4.append(this.n);
                                sb4.append("_");
                                imageReceiver4.setUniqKeyPrefix(sb4.toString());
                                k0Var2.j(ImageLocation.getForDocument(document3), com.google.android.recaptcha.internal.a.l(i24, "_", i24), null, null, 0, null);
                            }
                            k0Var3 = k0Var4;
                        } else {
                            r11 = 0;
                            ...
                            if (i11 == 0) {
                                ...
                                if (i11 == 2) {
                                    ...
                                    k5 k5Var2 = new k5(2, i16, q0Var.g);
                                    k5Var2.o(k0Var2);
                                    k0Var2.D = k5Var2;
                                    if (k0Var2.F) {
                                        k5Var2.a(k0Var2);
                                    ...
                                    if (i11 != 0 || i11 == 1) {
                                        k5 k5Var3 = new k5(2, i16, q0Var.g);
                                        k5Var3.setColorFilter(new PorterDuffColorFilter(messageObject3 == null ? g6.v0(messageObject3.shouldDrawWithoutBackground() ? messageObject3.isOutOwner() ? g6.Sb : g6.Cj : messageObject3.isOutOwner() ? g6.Gj : g6.Fj, n2Var != null ? n2Var.getResourceProvider() : null) : -1, PorterDuff.Mode.SRC_IN));
                                        boolean z14 = i11 != 0;
                                        k0Var.E = d.a(k5Var3, z14, !z14);
                            ...
                            k5 k5Var32 = new k5(2, i16, q0Var.g);
                            if (messageObject3 == null) {
                            }
                            k5Var32.setColorFilter(new PorterDuffColorFilter(messageObject3 == null ? g6.v0(messageObject3.shouldDrawWithoutBackground() ? messageObject3.isOutOwner() ? g6.Sb : g6.Cj : messageObject3.isOutOwner() ? g6.Gj : g6.Fj, n2Var != null ? n2Var.getResourceProvider() : null) : -1, PorterDuff.Mode.SRC_IN));
                            if (i11 != 0) {
                            }
                            k0Var.E = d.a(k5Var32, z14, !z14);
                            j0Var.setClipChildren(false);
                        }
                        ...
                        j0Var.addView(k0Var);
                        k0Var.getLayoutParams().width = i25;
                        k0Var.getLayoutParams().height = i25;
                        k0Var.getLayoutParams().width = i25;
                        k0Var.getLayoutParams().height = i25;
                    ...
                    ImageReceiver imageReceiver5 = o0Var.C;
                    view4.getLocationInWindow(this.j);
                    float imageX = this.j[0] + (imageReceiver5 == null ? 0.0f : imageReceiver5.getImageX());
                    float imageY = this.j[1] + (imageReceiver5 == null ? 0.0f : imageReceiver5.getImageY());
                    f15 = imageReceiver5 == null ? 0.0f : imageReceiver5.getImageHeight();
                    f13 = imageX;
                    f14 = imageY;
                }
                i13 = 2;
                ...
                j0Var = new j0(this, context2, n2Var, view52, z10, messageObject42, rnVar, i15, i11, z13, f282, f13, f14, q0Var);
                this.i = j0Var;
                k0Var = new k0(this, context2);
                this.b = k0Var;
                k0Var2 = new k0(this, context2);
                ...
                j0Var.addView(k0Var);
                k0Var.getLayoutParams().width = i252;
                k0Var.getLayoutParams().height = i252;
                k0Var.getLayoutParams().width = i252;
                k0Var.getLayoutParams().height = i252;
        ...
        j0Var = new j0(this, context2, n2Var, view522, z10, messageObject422, rnVar, i15, i11, z13, f2822, f13, f14, q0Var);
        this.i = j0Var;
        k0Var = new k0(this, context2);
        this.b = k0Var;
        k0Var2 = new k0(this, context2);
        ...
        j0Var.addView(k0Var);
        k0Var.getLayoutParams().width = i2522;
        k0Var.getLayoutParams().height = i2522;
        k0Var.getLayoutParams().width = i2522;
        k0Var.getLayoutParams().height = i2522;
    ...
    public static void d(n2 n2Var, wj0 wj0Var, View view, View view2, float f10, float f11, q0 q0Var, int i10, int i11) {
        ...
        if (MessagesController.getGlobalMainSettings().getBoolean("view_animations", true)) {
            ...
            if (z10) {
                ...
                ((FrameLayout) n2Var.getParentActivity().getWindow().getDecorView()).addView(m0Var.i);
            }
            view.invalidate();
