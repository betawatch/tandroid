...
public final class e2 extends n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void V(e2 e2Var, ArrayList arrayList, v51 v51Var) {
        ...
        if (!z10) {
            ...
            v51Var.T();
            arrayList.add(h51.B(LocaleController.formatString(R.string.TimezoneDetectAutomaticallyInfo, b10.d(e2Var.n, true))));
        }
        v51Var.U();
        if (!z10) {
        ...
        while (true) {
            ...
            h51Var2.l = e7;
            h51Var2.n = f7;
            h51Var2.K(TextUtils.equals(tL_timezone.id, e2Var.n));
            h51Var2.g = !e2Var.h || z10;
    ...
    public final View createView(Context context) {
        ...
        this.a.setOnScrollListener(new ah.e0(this, 12));
        ...
        this.b.addView(x9Var, x5.t(130, 130, 49, 0, 42, 0, 12));
        TextView textView = new TextView(context);
        textView.setText(LocaleController.getString(R.string.TimezoneNotFound));
        vl.n(j6.y6, this.resourceProvider, textView, 1, 15.0f);
