...
public final class v extends FrameLayout {
    ...
    public v(Context context, f6 f6Var) {
        ...
        final int i11 = 0;
        frameLayout.setOnClickListener(new View.OnClickListener(this) { // from class: ig.t
        ...
        final int i12 = 1;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: ig.t
            public final /* synthetic */ v b;
