...
public final class y extends FrameLayout {
    ...
    public y(Context context, f6 f6Var) {
        super(context);
        this.v = new z5(this, 0L, 500L, nr.h);
        ...
        spannableString.setSpan(new j90(AndroidUtilities.dp(90.0f), k6Var), 0, 1, 33);
        ...
        spannableString2.setSpan(new j90(AndroidUtilities.dp(70.0f), k6Var2), 0, 1, 33);
