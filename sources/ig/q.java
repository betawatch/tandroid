    ...
    public void k(Canvas canvas) {
        ...
        if (this.h0 != null) {
            ...
            while (true) {
                ...
                ((kg.i) arrayList.get(i21)).f.reset();
                ((kg.i) arrayList.get(i21)).g.reset();
                i21++;
            }
            canvas.save();
            ...
            int min = Math.min(((jg.e) this.h0).b.length - 1, this.G + i23 + 1);
            int i24 = max;
            float f35 = 0.0f;
            boolean z12 = false;
            float f36 = 0.0f;
                ...
                while (i18 < arrayList.size()) {
                    ...
                    if (!z13 && fVar2.o == 0.0f) {
                        ...
                        if (f10 != 0.0f) {
                            i10 = i12;
                            z10 = z12;
                            f7 = (((jg.e) this.h0).m[i18][i13] * fVar2.o) / f10;
                            if (f7 == 0.0f) {
                            }
                            int i1922 = this.B0;
                ...
                if (fVar2.n || fVar2.o != 0.0f) {
                    ...
                    if (i17 == i12) {
                        if (jArr[i15] != 0) {
                            f7 = fVar2.o;
                            i10 = i14;
                            float f17 = (((jg.e) this.h0).b[i15] * f13) - f15;
                        ...
                        i10 = i14;
                        f7 = 0.0f;
                        float f172 = (((jg.e) this.h0).b[i15] * f13) - f15;
                        ...
                        if (f16 != 0.0f) {
                            ...
                            float f1722 = (((jg.e) this.h0).b[i15] * f13) - f15;
                        ...
                        i10 = i14;
                        f7 = 0.0f;
                        float f17222 = (((jg.e) this.h0).b[i15] * f13) - f15;
