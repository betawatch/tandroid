    ...
    public static s b(TreeMap treeMap) {
        ...
        if (length == 1) {
            ...
            for (int i12 = 0; i12 < 1; i12++) {
                if (objArr[i12] == null) {
                    throw new NullPointerException(hg.k0.i(i12, "at index "));
                }
            }
        ...
        if (equals) {
            ...
            while (i10 < length) {
                ...
                if (wVar.compare(key3, key4) == 0) {
                    throw new IllegalArgumentException(e2.j("Multiple entries with same key: ", String.valueOf(entry4), " and ", String.valueOf(entry5)));
                }
                i10++;
                key3 = key4;
            }
