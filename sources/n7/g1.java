...
public final class g1 implements Closeable {
    ...
    public final long b() {
        ...
        if (b10 == 0) {
            ...
            if (b10 != 32) {
                throw new IllegalStateException(hg.k0.i((this.b.a >> 5) & 7, "expected major type 0 or 1 but found "));
            }
            z10 = false;
        }
        long f7 = f();
    ...
    */
                ...
                if (b10 != -32) {
                    if (b10 != 0 && b10 != 32) {
                        if (b10 == 64) {
                            ...
                            if (b10 != 96) {
                                throw new IllegalStateException(hg.k0.i((this.b.a >> 5) & 7, "invalid major type: "));
                            }
                            uVar.e0(-2L);
                        }
                        long f02 = uVar.f0();
                    ...
                    long f03 = uVar.f0();
                    if (f03 >= 0) {
                        throw new IOException(a4.a.o(f03, "expected indefinite length scope but found "));
                    }
                    if (f03 == -5) {
    ...
    public final void g() {
        d();
        if (this.b.b == 31) {
            throw new IllegalStateException(hg.k0.i(this.b.b, "expected definite length but found "));
        }
    }
