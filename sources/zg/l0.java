...
public final class l0 {
    ...
    /* JADX WARN: Type inference failed for: r5v46, types: [org.telegram.ui.Components.yi0] */
    /* JADX WARN: Type inference failed for: r5v50, types: [org.telegram.ui.Components.yi0] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public l0(Context context, o2 o2Var, gk0 gk0Var, View view, View view2, float f7, float f10, p0 p0Var, int i10, int i11, boolean z10) {
        ...
        if (z10 && i11 == 2) {
            ...
            view4 = view;
            o2Var2 = o2Var;
            l0 l0Var = new l0(context, o2Var2, gk0Var2, view4, view3, f7, f10, p0Var, i10, 1, true);
            context2 = context;
            i12 = i10;
            this.f = l0Var;
            C = l0Var;
        ...
        bo boVar3 = o2Var2 instanceof bo ? (bo) o2Var2 : null;
        if (gk0Var2 != null) {
            ai.w0 w0Var = gk0Var2.b;
            int i19 = 0;
            while (true) {
                if (i19 >= w0Var.getChildCount()) {
                    break;
                }
                if ((w0Var.getChildAt(i19) instanceof ek0) && ((ek0) w0Var.getChildAt(i19)).e.equals(this.p)) {
                    this.t = (ek0) w0Var.getChildAt(i19);
                    break;
                }
                i19++;
            }
        ...
        if (i11 == 1) {
            ...
            if (arrayList != null && boVar3 != null && boVar3.a() < j3) {
                    ...
                    if (this.p.equals(arrayList.get(i20).reaction) && arrayList.get(i20).unread) {
                        ...
                        if (peerId < j3) {
                            ...
                            if (chat != null) {
                                ...
                                k0Var.e = a4.a.e(p6.c(random, 100), 100.0f, 0.1f, 0.3f);
                                k0Var.h = a4.a.e(p6.c(random, 100), 100.0f, 0.4f, 0.8f);
                                k0Var.i = (Math.abs(random.nextInt() % 100) * 60) / 100.0f;
                                k0Var.b = (int) a4.a.e(p6.c(random, 100), 100.0f, 200.0f, 400.0f);
                                float f15 = 0.6f;
                                float f16 = 0.2f;
                                if (this.x.isEmpty()) {
                                    int i21 = 0;
                                    ...
                                    k0Var.f = a4.a.A(p6.c(random, 100), 0.6f, 100.0f, 0.2f);
                                    k0Var.g = (p6.c(random, 100) * 0.4f) / 100.0f;
                                }
                                this.x.add(k0Var);
                            }
                        } else {
                            ...
                            if (user != null) {
                                ...
                                k0Var2.e = a4.a.e(p6.c(random, 100), 100.0f, 0.1f, 0.3f);
                                k0Var2.h = a4.a.e(p6.c(random, 100), 100.0f, 0.4f, 0.8f);
                                k0Var2.i = (Math.abs(random.nextInt() % 100) * 60) / 100.0f;
                                k0Var2.b = (int) a4.a.e(p6.c(random, 100), 100.0f, 200.0f, 400.0f);
                                float f152 = 0.6f;
                                float f162 = 0.2f;
                                if (this.x.isEmpty()) {
                                }
                ...
                boVar = boVar3;
                ek0 ek0Var = this.t;
                boolean z13 = ek0Var == null || !(f7 == f11 || f10 == f11);
                if (view3 == null) {
                    ...
                    if (view3 instanceof r61) {
                        float f26 = ((r61) view3).G;
                        if (f26 > f11) {
                    ...
                    if (ek0Var == null) {
                        ...
                        i0Var = new i0(this, context2, o2Var, view5, z10, messageObject4, boVar, i15, i11, z13, f27, f12, f13, p0Var);
                        this.i = i0Var;
                        ...
                        if (tL_availableReaction != null) {
                            ...
                            if (i11 == 0) {
                                ...
                                if (i11 == 2) {
                                    ...
                                    if (i11 != 0 || i11 == 1) {
                                        ...
                                        o5Var3.setColorFilter(new PorterDuffColorFilter(messageObject3 == null ? j6.v0(messageObject3.shouldDrawWithoutBackground() ? messageObject3.isOutOwner() ? j6.Sb : j6.Cj : messageObject3.isOutOwner() ? j6.Gj : j6.Fj, o2Var != null ? o2Var.getResourceProvider() : null) : -1, PorterDuff.Mode.SRC_IN));
                                        boolean z14 = i11 != 0;
                            ...
                            o5Var32.setColorFilter(new PorterDuffColorFilter(messageObject3 == null ? j6.v0(messageObject3.shouldDrawWithoutBackground() ? messageObject3.isOutOwner() ? j6.Sb : j6.Cj : messageObject3.isOutOwner() ? j6.Gj : j6.Fj, o2Var != null ? o2Var.getResourceProvider() : null) : -1, PorterDuff.Mode.SRC_IN));
                            if (i11 != 0) {
                            }
                    ...
                    ek0Var.getLocationOnScreen(this.j);
                ...
                i0Var = new i0(this, context2, o2Var, view52, z10, messageObject42, boVar, i15, i11, z13, f272, f12, f13, p0Var);
                this.i = i0Var;
                j0Var = new j0(this, context2);
                this.b = j0Var;
                j0Var2 = new j0(this, context2);
        ...
        i0Var = new i0(this, context2, o2Var, view522, z10, messageObject422, boVar, i15, i11, z13, f2722, f12, f13, p0Var);
        this.i = i0Var;
        j0Var = new j0(this, context2);
        this.b = j0Var;
        j0Var2 = new j0(this, context2);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static void d(o2 o2Var, gk0 gk0Var, View view, View view2, float f7, float f10, p0 p0Var, int i10, int i11) {
        if (view == null || p0Var == null || o2Var == null || o2Var.getParentActivity() == null) {
            return;
        }
        boolean z10 = true;
        if (MessagesController.getGlobalMainSettings().getBoolean("view_animations", true)) {
            if (i11 == 2 || i11 == 0) {
                d(o2Var, null, view, view2, 0.0f, 0.0f, p0Var, i10, 1);
            }
            l0 l0Var = new l0(o2Var.getParentActivity(), o2Var, gk0Var, view, view2, f7, f10, p0Var, i10, i11, false);
            if (i11 == 1) {
                C = l0Var;
            } else {
                B = l0Var;
            ...
            if (z10) {
                ...
                ((FrameLayout) o2Var.getParentActivity().getWindow().getDecorView()).addView(l0Var.i);
            }
            view.invalidate();
