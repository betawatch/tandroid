...
public final class i0 extends FrameLayout {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:191:0x0559, code lost:
        ...
        if (((int) org.telegram.messenger.wl.c(r23.x.b.getImageReceiver().getLottieAnimation().a0, r23.x.b.getImageReceiver().getLottieAnimation().e[0], r8, r8)) < r6.b) goto L262;
     */
        ...
        if (l0Var.l) {
            ...
            if (f21 != 1.0f) {
                ...
                if (f22 > 1.0f) {
                    l0Var.m = 1.0f;
                    final int i11 = 0;
                    AndroidUtilities.runOnUIThread(new Runnable(this) { // from class: zg.h0
