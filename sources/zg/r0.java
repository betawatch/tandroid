...
public abstract class r0 {
    ...
    public static boolean d(TLRPC.Reaction reaction, p0 p0Var) {
        if ((reaction instanceof TLRPC.TL_reactionEmoji) && p0Var.g == 0 && TextUtils.equals(((TLRPC.TL_reactionEmoji) reaction).emoticon, p0Var.f)) {
            return true;
        }
    ...
    public static x5 e(TLRPC.Document document, Long l4, Paint.FontMetricsInt fontMetricsInt) {
        x5 x5Var;
        if (document != null) {
            x5Var = new x5(document.id, 1.0f, fontMetricsInt);
