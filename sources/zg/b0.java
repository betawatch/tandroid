    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (c0Var.l) {
            ...
            if (c0Var.j > 0.05f || i17 == i11) {
                ...
                gk0Var5.f(gk0Var5.E * max, max, gk0Var5.F * max, gk0Var5.M0 == i11 ? 255 : (int) w1.A(1.0f, gk0Var5.w0, Utilities.clamp(gk0Var5.w0 / 0.2f, 1.0f, 0.0f), 255.0f), canvas3);
                gk0Var = gk0Var5;
                canvas2 = canvas3;
                canvas2.restore();
            } else {
            ...
            if (gk0Var != null) {
                for (int childCount = yVar.h0.getChildCount() - 1; childCount >= 0; childCount--) {
                    if (yVar.h0.getChildAt(childCount) instanceof r61) {
                        r61 r61Var = (r61) yVar.h0.getChildAt(childCount);
                        if (r61Var.y && (p0Var = r61Var.x) != null) {
                            hashMap.put(p0Var, r61Var);
                        }
                    }
                }
                ...
                while (i20 < gk0Var.b.getChildCount()) {
                    ...
                    if (childAt.getLeft() < 0 || childAt.getVisibility() == 8) {
                        ...
                        if (childAt instanceof ek0) {
                            ...
                            r61 r61Var2 = (r61) hashMap.get(ek0Var.e);
                            if (r61Var2 != null) {
                                ...
                                i13 = i20;
                                float x13 = ((yVar.h0.getX() + (yVar.getX() + r61Var2.getX())) - dk0Var2.getX()) - AndroidUtilities.dp(1.0f);
                                float y12 = (yVar.h0.getY() + (yVar.g0.getY() + (yVar.getY() + r61Var2.getY()))) - dk0Var2.getY();
                                float measuredWidth = r61Var2.getMeasuredWidth();
                                if (r61Var2.L) {
                                    i16 = 4;
                                } else {
                                    i16 = 4;
                                ...
                                float f34 = r61Var2.L ? 0.95f * f20 : f20;
                            ...
                            if (r61Var2 != null) {
                                if (r61Var2.L) {
                                    ...
                                    float lerp4 = AndroidUtilities.lerp(measuredWidth4, (r61Var2.getMeasuredWidth() - AndroidUtilities.dp(f12)) / f17, c0Var.j);
                ...
                if (r61Var3 != null) {
                    ...
                    if (f38 != 1.0f && !yVar.T0 && yVar.h1) {
                        ...
                        if (f39 >= 1.0f) {
                            ...
                            g71 g71Var = yVar.H;
                            if (g71Var != null) {
                                gk0 gk0Var6 = (gk0) ((v8.s) g71Var).a;
                                if (r61Var3.s) {
                                    gk0Var6.l(r61Var3, r61Var3.x, true);
                                } else {
                                    long j3 = r61Var3.e.documentId;
                                    p0 p0Var2 = new p0();
                                    p0Var2.g = j3;
                                    p0Var2.h = j3;
                                    gk0Var6.l(r61Var3, p0Var2, true);
                                }
                            }
                        }
                        yVar.S0.G = yVar.U0;
                    ...
                    canvas2.save();
                    canvas2.translate(yVar.S0.getX() + f61Var.getX(), yVar.S0.getY() + f61Var.getY() + yVar.g0.getY());
