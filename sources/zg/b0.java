    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (c0Var.l) {
            ...
            hashMap3.clear();
            if (i17 == 1 || (sk0Var5.getDelegate() != null && sk0Var5.getDelegate().q())) {
                f7 = 1.0f;
            ...
            if (sk0Var5.R0 != null) {
                ...
                if (i17 != 3 && i17 != i10) {
                    if (i17 != 5) {
                        ...
                        f11 = lerp;
                        i11 = 5;
                        canvas2.saveLayerAlpha(0.0f, 0.0f, sk0Var5.R0.getMeasuredWidth(), sk0Var5.R0.getMeasuredHeight(), (int) ((f7 - c0Var.j) * sk0Var5.R0.getAlpha() * f10), 31);
            ...
            if (c0Var.j > 0.05f || i17 == i11) {
                ...
                sk0Var5.f(sk0Var5.E * max, max, sk0Var5.F * max, sk0Var5.M0 == i11 ? 255 : (int) org.telegram.messenger.l0.z(1.0f, sk0Var5.w0, Utilities.clamp(sk0Var5.w0 / 0.2f, 1.0f, 0.0f), 255.0f), canvas3);
                sk0Var = sk0Var5;
                canvas2 = canvas3;
                canvas2.restore();
            } else {
            ...
            if (sk0Var != null) {
                for (int childCount = yVar.h0.getChildCount() - 1; childCount >= 0; childCount--) {
                    if (yVar.h0.getChildAt(childCount) instanceof s61) {
                        s61 s61Var = (s61) yVar.h0.getChildAt(childCount);
                        if (s61Var.y && (p0Var = s61Var.x) != null) {
                            hashMap.put(p0Var, s61Var);
                        }
                    }
                }
                int save = canvas2.save();
                canvas2.translate(rectF.left, e2.z(1.0f, c0Var.j, sk0Var.g() + sk0Var.getTopOffset(), rectF.top));
                ...
                while (i20 < sk0Var.b.getChildCount()) {
                    ...
                    if (childAt.getLeft() < 0 || childAt.getVisibility() == 8) {
                        ...
                        if (childAt instanceof qk0) {
                            ...
                            s61 s61Var2 = (s61) hashMap.get(qk0Var.e);
                            if (s61Var2 != null) {
                                ...
                                i13 = i20;
                                float x13 = ((yVar.h0.getX() + (yVar.getX() + s61Var2.getX())) - pk0Var2.getX()) - AndroidUtilities.dp(1.0f);
                                float y12 = (yVar.h0.getY() + (yVar.g0.getY() + (yVar.getY() + s61Var2.getY()))) - pk0Var2.getY();
                            ...
                            if (s61Var2 != null) {
                                if (s61Var2.L) {
                                    ...
                                    float lerp4 = AndroidUtilities.lerp(measuredWidth4, (s61Var2.getMeasuredWidth() - AndroidUtilities.dp(f12)) / f17, c0Var.j);
                ...
                if (s61Var3 != null) {
                    ...
                    if (f38 != 1.0f && !yVar.T0 && yVar.h1) {
                        ...
                        if (f39 >= 1.0f) {
                            ...
                            h71 h71Var = yVar.H;
                            if (h71Var != null) {
                                sk0 sk0Var6 = (sk0) ((o0.b) h71Var).b;
                                if (s61Var3.s) {
                                    sk0Var6.l(s61Var3, s61Var3.x, true);
                                } else {
                                    long j3 = s61Var3.e.documentId;
                                    p0 p0Var2 = new p0();
                                    p0Var2.g = j3;
                                    p0Var2.h = j3;
                                    sk0Var6.l(s61Var3, p0Var2, true);
                                }
                            }
                        }
                        yVar.S0.G = yVar.U0;
                    ...
                    canvas2.save();
                    canvas2.translate(yVar.S0.getX() + g61Var.getX(), yVar.S0.getY() + g61Var.getY() + yVar.g0.getY());
    ...
    public final void invalidate() {
        ...
        c0 c0Var = this.w;
        sk0 sk0Var = c0Var.n;
        if (c0Var.y == 1 || !(sk0Var == null || sk0Var.getDelegate() == null || !sk0Var.getDelegate().q())) {
