...
public final class g extends Drawable implements DownloadController.FileDownloadProgressListener, ln0 {
    ...
    public g(int i10, s1 s1Var, c6 c6Var, boolean z10) {
        ...
        this.G = mn0Var;
        mn0Var.h = this;
        this.a = new ud.a(s1Var, td.a.a, 180L);
    ...
    public final void c(boolean z10) {
        ...
        if (z10) {
            ...
            int i10 = g6.zb;
            mn0Var.h(w02, w03, g6.w0(null, i10, false), g6.w0(null, i10, false), g6.w0(null, g6.yb, false));
        ...
        int i11 = g6.xd;
        mn0Var.h(w04, w05, g6.w0(null, i11, false), g6.w0(null, i11, false), g6.w0(null, g6.wd, false));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (z10 || this.T) {
            ...
            pz0 pz0Var = this.n;
            if (pz0Var != null) {
                pz0Var.e(canvas, AndroidUtilities.dp(56.0f) + dp, AndroidUtilities.dp(15.0f) + dp2 + dp3);
            }
            if (this.T) {
                float f10 = this.a.e;
                ...
                if (f10 > 0.0f) {
                    mn0 mn0Var = this.G;
                    mn0Var.t = f10;
                    mn0Var.j(rl.u(56.0f, dp, bounds.right), AndroidUtilities.dp(30.0f));
                    canvas.save();
            ...
            pz0 pz0Var2 = this.s;
            if (pz0Var2 != null) {
                pz0Var2.e(canvas, AndroidUtilities.dp(56.0f) + dp, AndroidUtilities.dp((this.T ? 20 : 2) + 34) + dp3 + dp2);
            }
    ...
    public final void f(boolean z10) {
        ...
        if (this.V != width || z10) {
            ...
            if (str != null) {
                if (this.n == null) {
                    this.n = new pz0(str, 15.0f, AndroidUtilities.bold());
                }
                pz0 pz0Var = this.n;
                pz0Var.r(TextUtils.ellipsize(this.e, pz0Var.a, width, TextUtils.TruncateAt.MIDDLE));
            }
            String str2 = this.f;
            if (str2 != null) {
                if (this.r == null) {
                    this.r = new pz0(str2, 14.0f, null);
                }
                pz0 pz0Var2 = this.r;
                pz0Var2.r(TextUtils.ellipsize(this.f, pz0Var2.a, width, TextUtils.TruncateAt.END));
            }
            String str3 = this.h;
            if (str3 != null) {
                if (this.s == null) {
                    this.s = new pz0(str3, 12.0f, null);
                }
                pz0 pz0Var3 = this.s;
                pz0Var3.r(TextUtils.ellipsize(this.h, pz0Var3.a, width, TextUtils.TruncateAt.END));
            }
            if (this.C && this.v == null) {
        ...
        if (messageMedia != null && !(messageMedia instanceof TLRPC.TL_messageMediaEmpty)) {
            if (messageMedia instanceof TLRPC.TL_messageMediaPhoto) {
                ...
                if (closestPhotoSizeWithSize2 != null) {
                    ...
                    String l10 = com.google.android.recaptcha.internal.a.l((int) (i13 / f10), "_", (int) (i14 / f10));
                ...
                if (MessageObject.isMusicDocument(document)) {
                    ...
                    if (closestPhotoSizeWithSize4 != null) {
                        ...
                        if (i18 != 0) {
                            i11 = (i19 * i17) / i18;
                            String l11 = com.google.android.recaptcha.internal.a.l(i17, "_", i11);
                            z12 = true;
                            imageReceiver.setImage(null, l11, forDocument, l11, forDocument2, l11, null, 0L, null, messageObject2, 0);
                        }
                        i11 = i17;
                        String l112 = com.google.android.recaptcha.internal.a.l(i17, "_", i11);
                        z12 = true;
                        ...
                        if (closestPhotoSizeWithSize5 != null) {
                            ...
                            if (i20 != 0) {
                                i11 = (i21 * i17) / i20;
                                String l1122 = com.google.android.recaptcha.internal.a.l(i17, "_", i11);
                                z12 = true;
                                imageReceiver.setImage(null, l1122, forDocument, l1122, forDocument2, l1122, null, 0L, null, messageObject2, 0);
                            }
                        }
                        i11 = i17;
                        String l11222 = com.google.android.recaptcha.internal.a.l(i17, "_", i11);
                        z12 = true;
    ...
    public final void n(boolean z10) {
        ...
        if (playingMessageObject == null || !i11) {
            ...
            if (!mn0Var.e) {
                ...
                mn0Var.q = playingMessageObject.bufferedProgress;
            }
