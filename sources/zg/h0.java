...
public final class h0 extends FrameLayout {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:191:0x0559, code lost:
        ...
        if (((int) org.telegram.messenger.ok.b(r23.x.b.getImageReceiver().getLottieAnimation().a0, r23.x.b.getImageReceiver().getLottieAnimation().e[0], r8, r8)) < r6.b) goto L262;
     */
                        ...
                        if (i0Var3.G) {
                            ...
                            while (i15 < this.x.x.size()) {
                                ...
                                if (f34 < 0.5f) {
                                    ...
                                    f19 = 1.0f;
                                    x10 = org.telegram.messenger.f0.x(f34, 0.5f, 0.5f, 1.0f);
                                }
