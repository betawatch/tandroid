        ...
        switch (this.a) {
            case 0:
                ...
                while (parcel.dataPosition() < z10) {
                    ...
                    if (c10 == 2) {
                        ...
                        fVar = (f) q8.g(parcel, readInt, f.CREATOR);
                    }
                }
                q8.m(parcel, z10);
            ...
            case 3:
                ...
                while (parcel.dataPosition() < z13) {
                    ...
                    if (c13 == 2) {
                        ...
                        mVar = (m) q8.g(parcel, readInt4, m.CREATOR);
                    }
                }
                q8.m(parcel, z13);
            ...
            case 7:
                ...
                while (parcel.dataPosition() < z17) {
                    ...
                    if (c16 == 2) {
                        i18 = q8.u(parcel, readInt8);
                    } else if (c16 == 3) {
                        j11 = q8.w(parcel, readInt8);
                    } else if (c16 != 4) {
                        q8.y(parcel, readInt8);
                    } else {
                        arrayList = q8.l(parcel, readInt8, p0.CREATOR);
                    }
                }
                q8.m(parcel, z17);
            ...
            case 8:
                ...
                while (parcel.dataPosition() < z18) {
                    ...
                    if (c17 == 2) {
                        b10 = q8.p(parcel, readInt9);
                    } else if (c17 == 3) {
                        b11 = q8.p(parcel, readInt9);
                    } else if (c17 != 4) {
                        q8.y(parcel, readInt9);
                    } else {
                        str4 = q8.h(parcel, readInt9);
                    }
                }
                q8.m(parcel, z18);
            ...
            case 9:
                ...
                while (parcel.dataPosition() < z19) {
                    ...
                    switch ((char) readInt10) {
                        case 2:
                            i19 = q8.u(parcel, readInt10);
                            break;
                        case 3:
                            str5 = q8.h(parcel, readInt10);
                            break;
                        case 4:
                            str6 = q8.h(parcel, readInt10);
                            break;
                        case 5:
                            str7 = q8.h(parcel, readInt10);
                            break;
                        case 6:
                            str8 = q8.h(parcel, readInt10);
                            break;
                        case 7:
                        ...
                        case '\b':
                            ...
                            break;
                        case '\t':
                            b12 = q8.p(parcel, readInt10);
                            break;
                        case '\n':
                            b13 = q8.p(parcel, readInt10);
                            break;
                        case 11:
                            b14 = q8.p(parcel, readInt10);
                            break;
                        case '\f':
                            b15 = q8.p(parcel, readInt10);
                            break;
                        case '\r':
                ...
                while (parcel.dataPosition() < z20) {
                    ...
                    switch ((char) readInt11) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            b1Var = (b1) q8.g(parcel, readInt11, b1.CREATOR);
                            break;
                        case 4:
                            str14 = q8.h(parcel, readInt11);
                            break;
                        case 5:
                            str15 = q8.h(parcel, readInt11);
                            break;
                        case 6:
                            f10 = q8.s(parcel, readInt11);
                            break;
                        case 7:
                            f1Var = (f1) q8.g(parcel, readInt11, f1.CREATOR);
                            break;
                        default:
            ...
            case 11:
                ...
                while (parcel.dataPosition() < z21) {
                    ...
                    if (c18 == 1) {
                        ...
                        arrayList2 = q8.l(parcel, readInt12, d1.CREATOR);
                    } else if (c18 != 3) {
                        q8.y(parcel, readInt12);
                    } else {
                        b1Var2 = (b1) q8.g(parcel, readInt12, b1.CREATOR);
                    }
                }
                q8.m(parcel, z21);
            ...
            default:
                ...
                while (parcel.dataPosition() < z22) {
                    ...
                    if (c19 == 1) {
                        z23 = q8.n(parcel, readInt13);
                    } else if (c19 != 2) {
                        q8.y(parcel, readInt13);
                    } else {
                        arrayList3 = q8.j(parcel, readInt13);
                    }
                }
                q8.m(parcel, z22);
                return new f1(arrayList3, z23);
        }
    }
