        ...
        switch (this.a) {
            case 0:
                ...
                while (parcel.dataPosition() < z10) {
                    ...
                    if (c10 == 2) {
                        ...
                        arrayList = q8.l(parcel, readInt, m0.CREATOR);
                    }
                }
                q8.m(parcel, z10);
            ...
            case 1:
                ...
                while (parcel.dataPosition() < z11) {
                    ...
                    if (c11 == 2) {
                        fVar = (f) q8.g(parcel, readInt2, f.CREATOR);
                    } else if (c11 == 3) {
            ...
            case 6:
                ...
                while (parcel.dataPosition() < z16) {
                    ...
                    if (c13 == 1) {
                        i16 = q8.u(parcel, readInt7);
                    } else if (c13 == 2) {
                        z17 = q8.n(parcel, readInt7);
                    } else if (c13 == 3) {
                        z18 = q8.n(parcel, readInt7);
                    } else if (c13 == 4) {
                        z19 = q8.n(parcel, readInt7);
                    } else if (c13 != 5) {
            ...
            case 8:
                ...
                while (parcel.dataPosition() < z22) {
                    ...
                    if (c15 == 2) {
                        uri = (Uri) q8.g(parcel, readInt9, Uri.CREATOR);
                    } else if (c15 == 4) {
                        bundle = q8.a(parcel, readInt9);
                    } else if (c15 != 5) {
                        q8.y(parcel, readInt9);
                    } else {
                        bArr = q8.b(parcel, readInt9);
                    }
                }
                q8.m(parcel, z22);
            ...
            case 10:
                ...
                while (parcel.dataPosition() < z24) {
                    ...
                    if (c17 == 2) {
                        ...
                        arrayList2 = q8.l(parcel, readInt11, b.CREATOR);
                    }
                }
                q8.m(parcel, z24);
            ...
            case 11:
                ...
                while (parcel.dataPosition() < z25) {
                    ...
                    if (c18 == 2) {
                        i20 = q8.u(parcel, readInt12);
                    } else if (c18 != 3) {
                        q8.y(parcel, readInt12);
                    } else {
                        bVar = (b) q8.g(parcel, readInt12, b.CREATOR);
                    }
                }
                q8.m(parcel, z25);
            ...
            case 12:
                ...
                while (parcel.dataPosition() < z26) {
                    ...
                    if (c19 == 2) {
                        i21 = q8.u(parcel, readInt13);
                    } else if (c19 != 3) {
                        q8.y(parcel, readInt13);
                    } else {
                        parcelFileDescriptor = (ParcelFileDescriptor) q8.g(parcel, readInt13, ParcelFileDescriptor.CREATOR);
                    }
                }
                q8.m(parcel, z26);
            ...
            case 13:
                ...
                while (parcel.dataPosition() < z27) {
                    ...
                    if (c20 == 2) {
                        i22 = q8.u(parcel, readInt14);
                    } else if (c20 != 3) {
                        q8.y(parcel, readInt14);
                    } else {
                        parcelFileDescriptor2 = (ParcelFileDescriptor) q8.g(parcel, readInt14, ParcelFileDescriptor.CREATOR);
                    }
                }
                q8.m(parcel, z27);
            ...
            case 14:
                ...
                while (parcel.dataPosition() < z28) {
                    ...
                    if (c21 == 2) {
                        i23 = q8.u(parcel, readInt15);
                    } else if (c21 != 3) {
                        q8.y(parcel, readInt15);
                    } else {
                        z29 = q8.n(parcel, readInt15);
                    }
                }
                q8.m(parcel, z28);
            ...
            case 15:
                ...
                while (parcel.dataPosition() < z30) {
                    ...
                    if (c22 == 2) {
                        i24 = q8.u(parcel, readInt16);
                    } else if (c22 == 3) {
                        z31 = q8.n(parcel, readInt16);
                    } else if (c22 != 4) {
                        q8.y(parcel, readInt16);
                    } else {
                        z32 = q8.n(parcel, readInt16);
                    }
                }
                q8.m(parcel, z30);
            ...
            case 17:
                ...
                while (parcel.dataPosition() < z35) {
                    ...
                    if (c24 == 2) {
                        i26 = q8.u(parcel, readInt18);
                    } else if (c24 != 3) {
                        q8.y(parcel, readInt18);
                    } else {
                        str7 = q8.h(parcel, readInt18);
                    }
                }
                q8.m(parcel, z35);
            ...
            case 18:
                ...
                while (parcel.dataPosition() < z36) {
                    ...
                    if (c25 == 2) {
                        i27 = q8.u(parcel, readInt19);
                    } else if (c25 != 3) {
                        q8.y(parcel, readInt19);
                    } else {
                        connectionConfiguration = (ConnectionConfiguration) q8.g(parcel, readInt19, ConnectionConfiguration.CREATOR);
                    }
                }
                q8.m(parcel, z36);
            ...
            case 19:
                ...
                while (parcel.dataPosition() < z37) {
                    ...
                    if (c26 == 2) {
                        ...
                        connectionConfigurationArr = (ConnectionConfiguration[]) q8.k(parcel, readInt20, ConnectionConfiguration.CREATOR);
                    }
                }
                q8.m(parcel, z37);
            ...
            case 20:
                ...
                while (parcel.dataPosition() < z38) {
                    ...
                    if (c27 == 2) {
                        i29 = q8.u(parcel, readInt21);
                    } else if (c27 != 3) {
                        q8.y(parcel, readInt21);
                    } else {
                        arrayList3 = q8.l(parcel, readInt21, m0.CREATOR);
                    }
                }
                q8.m(parcel, z38);
            ...
            case 21:
                ...
                while (parcel.dataPosition() < z39) {
                    ...
                    if (c28 == 2) {
                        i30 = q8.u(parcel, readInt22);
                    } else if (c28 != 3) {
                        q8.y(parcel, readInt22);
                    } else {
                        mVar = (m) q8.g(parcel, readInt22, m.CREATOR);
                    }
                }
                q8.m(parcel, z39);
            ...
            case 23:
                ...
                while (parcel.dataPosition() < z41) {
                    ...
                    if (c30 == 2) {
                        i32 = q8.u(parcel, readInt24);
                    } else if (c30 != 3) {
                        q8.y(parcel, readInt24);
                    } else {
                        parcelFileDescriptor3 = (ParcelFileDescriptor) q8.g(parcel, readInt24, ParcelFileDescriptor.CREATOR);
                    }
                }
                q8.m(parcel, z41);
            ...
            case 24:
                ...
                while (parcel.dataPosition() < z42) {
                    ...
                    if (c31 == 2) {
                        i33 = q8.u(parcel, readInt25);
                    } else if (c31 != 3) {
                        q8.y(parcel, readInt25);
                    } else {
                        m0Var = (m0) q8.g(parcel, readInt25, m0.CREATOR);
                    }
                }
                q8.m(parcel, z42);
            ...
            case 25:
                ...
                while (parcel.dataPosition() < z43) {
                    ...
                    if (c32 == 2) {
                        i34 = q8.u(parcel, readInt26);
                    } else if (c32 != 3) {
                        q8.y(parcel, readInt26);
                    } else {
                        str9 = q8.h(parcel, readInt26);
                    }
                }
                q8.m(parcel, z43);
            ...
            case 26:
                ...
                while (parcel.dataPosition() < z44) {
                    ...
                    if (c33 == 1) {
                        str10 = q8.h(parcel, readInt27);
                    } else if (c33 == 2) {
                        i35 = q8.u(parcel, readInt27);
                    } else if (c33 != 3) {
                        q8.y(parcel, readInt27);
                    } else {
                        i36 = q8.u(parcel, readInt27);
                    }
                }
                q8.m(parcel, z44);
            ...
            case 27:
                ...
                while (parcel.dataPosition() < z45) {
                    ...
                    if (c34 == 2) {
                        i37 = q8.u(parcel, readInt28);
                    } else if (c34 == 3) {
                        str11 = q8.h(parcel, readInt28);
                    } else if (c34 == 4) {
                        bArr2 = q8.b(parcel, readInt28);
                    } else if (c34 != 5) {
                        q8.y(parcel, readInt28);
                    } else {
                        str12 = q8.h(parcel, readInt28);
                    }
                }
                q8.m(parcel, z45);
            ...
            case 28:
                ...
                while (parcel.dataPosition() < z46) {
                    ...
                    if (((char) readInt29) != 2) {
                        q8.y(parcel, readInt29);
                    } else {
                        i38 = q8.u(parcel, readInt29);
                    }
                }
                q8.m(parcel, z46);
                return new g0(i38);
            default:
                ...
                while (parcel.dataPosition() < z47) {
                    ...
                    if (c35 == 2) {
                        str13 = q8.h(parcel, readInt30);
                    } else if (c35 == 3) {
                        str14 = q8.h(parcel, readInt30);
                    } else if (c35 == 4) {
                        i39 = q8.u(parcel, readInt30);
                    } else if (c35 != 5) {
                        q8.y(parcel, readInt30);
                    } else {
                        z48 = q8.n(parcel, readInt30);
                    }
                }
                q8.m(parcel, z47);
                return new m0(i39, str13, str14, z48);
        }
    }
