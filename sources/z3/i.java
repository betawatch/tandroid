    ...
    public final void c(long j10) {
        ...
        while (true) {
            ...
            if (i21 == 1836019574) {
                ...
                a j11 = aVar.j(1836475768);
                j11.getClass();
                SparseArray sparseArray2 = new SparseArray();
                ArrayList arrayList8 = j11.d;
                int size2 = arrayList8.size();
                int i24 = 0;
                long j12 = -9223372036854775807L;
                while (i24 < size2) {
                    b bVar = (b) arrayList8.get(i24);
                    int i25 = bVar.b;
                    w wVar = bVar.c;
                    if (i25 == 1953654136) {
                        wVar.F(i23);
                        ...
                        if (i25 == 1835362404) {
                            wVar.F(8);
                            j12 = n3.a.f(wVar.g()) == 0 ? wVar.v() : wVar.y();
                        }
                    }
                    i24++;
                ...
                ArrayList f10 = e.f(aVar, new r3.p(), j12, a2, (i22 & 16) != 0, false, new rh.e(this, 20));
                int size3 = f10.size();
                if (sparseArray.size() == 0) {
                    for (int i26 = 0; i26 < size3; i26++) {
                        s sVar = (s) f10.get(i26);
                        p pVar = sVar.a;
                        r3.m mVar = this.D;
                        int i27 = pVar.b;
                        int i28 = pVar.a;
                        v c22 = mVar.c2(i26, i27);
                        if (sparseArray2.size() == 1) {
                            fVar = (f) sparseArray2.valueAt(0);
                        } else {
                            fVar = (f) sparseArray2.get(i28);
                            fVar.getClass();
                        }
                        sparseArray.put(i28, new h(c22, sVar, fVar));
                ...
                int i31 = 0;
                while (i31 < size4) {
                    a aVar2 = (a) arrayList6.get(i31);
                    if (aVar2.b == 1953653094) {
                        b k10 = aVar2.k(1952868452);
                        ...
                        if (hVar2 == null) {
                            ...
                            rVar.a = new f(g11, g12, i12, (g10 & 32) != 0 ? wVar2.g() : fVar4.d);
                        }
                        if (hVar2 == null) {
                            ...
                            if (k11 == null || (i22 & 2) != 0) {
                                ...
                                w wVar3 = k11.c;
                                wVar3.F(8);
                                rVar2.p = n3.a.f(wVar3.g()) == 1 ? wVar3.y() : wVar3.v();
                                rVar2.q = true;
                            }
                            ...
                            rVar2.d = i33;
                            rVar2.e = i34;
                            if (rVar2.g.length < i33) {
                                rVar2.f = new long[i33];
                                rVar2.g = new int[i33];
                            }
                            if (rVar2.h.length < i34) {
                                int i36 = (i34 * 125) / 100;
                                rVar2.h = new int[i36];
                                rVar2.i = new long[i36];
                                rVar2.j = new boolean[i36];
                                rVar2.l = new boolean[i36];
                            }
                            int i37 = 0;
                            int i38 = 0;
                            int i39 = 0;
                                ...
                                if (i37 < size5) {
                                    ...
                                    if (bVar3.b == i13) {
                                        ...
                                        if (jArr2 != null && jArr2.length == 1 && jArr3 != null) {
                                            long j16 = jArr2[0];
                                            if (j16 == 0 || d0.N(j16 + jArr3[0], 1000000L, pVar3.d) >= pVar3.e) {
                                                j14 = jArr3[0];
                                            }
                                        }
                                        int[] iArr = rVar2.h;
                                        ...
                                        boolean z18 = pVar3.b == 2 && (i22 & 1) != 0;
                                        int i45 = rVar2.g[i38] + i39;
                                        i17 = i31;
                                        long j17 = pVar3.c;
                                        long j18 = rVar2.p;
                                        while (i39 < i45) {
                                            ...
                                            int g15 = z17 ? wVar5.g() : (i39 == 0 && z12) ? i44 : fVar5.d;
                                            if (z16) {
                                                fVar3 = fVar5;
                                                i20 = wVar5.g();
                                            } else {
                                            ...
                                            int i46 = g15;
                                            long N = d0.N((i20 + j18) - j14, 1000000L, j17);
                                            jArr4[i39] = N;
                                            if (!rVar2.q) {
                                                jArr4[i39] = N + hVar2.d.h;
                                            }
                                            iArr[i39] = i19;
                                            zArr[i39] = ((i46 >> 16) & 1) == 0 && (!z19 || i39 == 0);
                                            j18 += g14;
                                            i39++;
                                            z18 = z19;
                                            i45 = i18;
                                    ...
                                    if (k12 != null) {
                                        ...
                                        int x11 = wVar6.x();
                                        if (x11 > rVar2.e) {
                                            StringBuilder m9 = a2.m(x11, "Saiz sample count ", " is greater than fragment sample count");
                                            m9.append(rVar2.e);
                                            throw r1.a(m9.toString(), null);
                                        }
                                        if (u10 == 0) {
                                            ...
                                            i15 = u10 * x11;
                                            z4 = false;
                                            Arrays.fill(rVar2.l, 0, x11, z20);
                                        }
                                        Arrays.fill(rVar2.l, x11, rVar2.e, z4);
                                        if (i15 > 0) {
                                            rVar2.n.C(i15);
                                            rVar2.k = true;
                                            rVar2.o = true;
                                    ...
                                    if (k13 != null) {
                                        ...
                                        rVar2.c += n3.a.f(g16) == 0 ? wVar7.v() : wVar7.y();
                                    }
                                    byte[] bArr = null;
                                    b k14 = aVar2.k(1936027235);
                                    if (k14 != null) {
                                        b(k14.c, 0, rVar2);
                                    }
                                    ...
                                    if (wVar9 != null && wVar8 != null) {
                                        ...
                                        if (z21) {
                                            ...
                                            rVar2.k = true;
                                            rVar2.m = new q(z21, str, u13, bArr2, i51, i52, bArr);
                ...
                if (a10 != null) {
                    ...
                    for (int i53 = 0; i53 < size6; i53++) {
                        h hVar3 = (h) sparseArray.valueAt(i53);
                        p pVar5 = hVar3.d.a;
                        f fVar7 = hVar3.b.a;
                        int i54 = d0.a;
                        q qVar2 = pVar5.k[fVar7.a];
                        o3.g a11 = a10.a(qVar2 != null ? qVar2.b : null);
                ...
                if (this.v != -9223372036854775807L) {
                    ...
                    for (int i55 = 0; i55 < size7; i55++) {
                        h hVar4 = (h) sparseArray.valueAt(i55);
                        long j19 = this.v;
                        int i56 = hVar4.f;
                        while (true) {
                            r rVar3 = hVar4.b;
                            if (i56 < rVar3.e && rVar3.i[i56] <= j19) {
                                if (rVar3.j[i56]) {
                                    hVar4.i = i56;
                                }
                                i56++;
        ...
        loop0: while (true) {
            while (true) {
                ...
                if (i10 != 0) {
                    ...
                    if (i10 != 1) {
                        ...
                        if (i10 != 2) {
                            ...
                            for (int i11 = 0; i11 < size; i11++) {
                                ...
                                boolean z4 = hVar3.l;
                                r rVar = hVar3.b;
                                if ((z4 || hVar3.f != hVar3.d.b) && (!z4 || hVar3.h != rVar.d)) {
                                    long j14 = !z4 ? hVar3.d.c[hVar3.f] : rVar.f[hVar3.h];
                                    if (j14 < j13) {
                                        hVar2 = hVar3;
                                        j13 = j14;
                                    }
                        ...
                        w wVar2 = this.s;
                        if (wVar2 != null) {
                            ((r3.h) lVar).d(wVar2.a, 8, i16, false);
                            int i17 = this.p;
                    ...
                    w wVar4 = this.k;
                    if (i20 == 0) {
                        if (!((r3.h) lVar).d(wVar4.a, 0, 8, true)) {
                            return -1;
                        }
                        this.r = 8;
                        wVar4.F(0);
