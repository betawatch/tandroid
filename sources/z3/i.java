    ...
    public final void c(long j10) {
        ...
        while (true) {
            ...
            if (i21 == 1836019574) {
                ...
                ArrayList f10 = e.f(aVar, new r3.p(), j12, a2, (i22 & 16) != 0, false, new z8(this, 23));
                int size3 = f10.size();
                if (sparseArray.size() == 0) {
                    for (int i26 = 0; i26 < size3; i26++) {
                        r rVar = (r) f10.get(i26);
                        o oVar = rVar.a;
                        r3.m mVar = this.D;
                        int i27 = oVar.b;
                        int i28 = oVar.a;
                        v d22 = mVar.d2(i26, i27);
                        ...
                        sparseArray.put(i28, new h(d22, rVar, fVar));
                ...
                while (i31 < size4) {
                    ...
                    if (aVar2.b == 1953653094) {
                        ...
                        if (hVar2 == null) {
                            ...
                            qVar2.d = i33;
                            qVar2.e = i34;
                            if (qVar2.g.length < i33) {
                                qVar2.f = new long[i33];
                                qVar2.g = new int[i33];
                            }
                            if (qVar2.h.length < i34) {
                                int i36 = (i34 * 125) / 100;
                                qVar2.h = new int[i36];
                                qVar2.i = new long[i36];
                                qVar2.j = new boolean[i36];
                                qVar2.l = new boolean[i36];
                            }
                            int i37 = 0;
                            int i38 = 0;
                            int i39 = 0;
                                ...
                                if (i37 < size5) {
                                    ...
                                    if (bVar3.b == i13) {
                                        ...
                                        if (jArr2 != null && jArr2.length == 1 && jArr3 != null) {
                                            long j16 = jArr2[0];
                                            if (j16 == 0 || d0.N(j16 + jArr3[0], 1000000L, oVar3.d) >= oVar3.e) {
                                                j14 = jArr3[0];
                                            }
                                        }
                                        int[] iArr = qVar2.h;
                                    ...
                                    if (k12 != null) {
                                        ...
                                        int x11 = wVar6.x();
                                        if (x11 > qVar2.e) {
                                            StringBuilder m9 = k0.m(x11, "Saiz sample count ", " is greater than fragment sample count");
                                            m9.append(qVar2.e);
                                            throw r1.a(m9.toString(), null);
                                        }
                                        if (u10 == 0) {
                                    ...
                                    if (wVar9 != null && wVar8 != null) {
                                        ...
                                        if (z21) {
                                            ...
                                            qVar2.k = true;
                                            qVar2.m = new p(z21, str, u13, bArr2, i51, i52, bArr);
                ...
                if (a10 != null) {
                    ...
                    for (int i53 = 0; i53 < size6; i53++) {
                        ...
                        o3.h a11 = a10.a(pVar2 != null ? pVar2.b : null);
                ...
                if (this.v != -9223372036854775807L) {
                    ...
                    for (int i55 = 0; i55 < size7; i55++) {
                        ...
                        while (true) {
                            q qVar3 = hVar4.b;
                            if (i56 < qVar3.e && qVar3.i[i56] <= j19) {
                                if (qVar3.j[i56]) {
                                    hVar4.i = i56;
                                }
                                i56++;
                    ...
                    if (i10 != 1) {
                        ...
                        if (wVar2 != null) {
                            ...
                            if (!arrayDeque.isEmpty()) {
                                ...
                                w wVar3 = new w(this.j.r(new g4.a(str, str2, N, v, bArr)));
                                int a2 = wVar3.a();
                                for (v vVar : this.E) {
                                    wVar3.F(0);
                                    vVar.d(a2, wVar3);
