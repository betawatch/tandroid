...
public final class l implements r3.k, s {
    ...
    public final void d(long j10, long j11) {
        ...
        for (k kVar : this.r) {
            r rVar = kVar.b;
            int e6 = d0.e(rVar.f, j11, false);
            while (true) {
                if (e6 < 0) {
                    e6 = -1;
                    break;
                } else if ((rVar.g[e6] & 1) != 0) {
                    break;
                } else {
                    e6--;
                }
    ...
    */
    public final r3.r f(long j10) {
        ...
        if (i12 != -1) {
            ...
            j12 = jArr[e6];
            j11 = jArr2[e6];
            if (j12 < j10 && e6 < rVar.b - 1 && (a2 = rVar.a(j10)) != -1 && a2 != e6) {
                j13 = jArr[a2];
                j15 = jArr2[a2];
                long j16 = j11;
                i10 = 0;
                            ...
                            if (!arrayList3.isEmpty()) {
                                ...
                                while (i10 < size) {
                                    ...
                                    if (i37 == 0) {
                                        ...
                                        i13 = size;
                                        k kVar = new k(oVar, rVar, this.q.i2(i10, i39));
                                ...
                                while (i12 < kVarArr.length) {
                                    ...
                                    long[] jArr3 = jArr[i44];
                                    jArr3[i46] = j18;
                                    r rVar2 = kVarArr[i44].b;
                                    long[] jArr4 = jArr2;
                                    j18 += rVar2.d[i46];
                                    int i47 = i46 + 1;
                                    iArr[i44] = i47;
                                    if (i47 < jArr3.length) {
                                        jArr4[i44] = rVar2.f[i47];
                                    } else {
                                        zArr[i44] = true;
                                        i12++;
                                    }
