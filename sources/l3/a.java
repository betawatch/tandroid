...
public abstract class a {
    ...
    */
    public static e8.a g(h5.v vVar) {
        int i10;
        int i11;
        int i12 = vVar.i(16);
        int i13 = vVar.i(16);
        ...
        return new e8.a(i16, i14, i11);
    }

    public static p0 h(h5.v vVar, boolean z4) {
        int i10 = vVar.i(5);
        if (i10 == 31) {
            i10 = vVar.i(6) + 32;
        }
        ...
        if (z4) {
            if (i10 != 1 && i10 != 2 && i10 != 3 && i10 != 4 && i10 != 6 && i10 != 7 && i10 != 17) {
                switch (i10) {
                    ...
                    case 23:
                        break;
                    default:
                        throw r1.c("Unsupported audio object type: " + i10);
                }
            }
            if (vVar.h()) {
                h5.a.K("AacUtil", "Unexpected frameLengthFlag = 1");
            }
            if (vVar.h()) {
                vVar.s(14);
            }
            ...
            switch (i10) {
                ...
                case 23:
                    int i13 = vVar.i(2);
                    if (i13 == 2 || i13 == 3) {
                        throw r1.c("Unsupported epConfig: " + i13);
                    }
            }
        }
        int i14 = b[i11];
