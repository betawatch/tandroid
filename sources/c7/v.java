...
public final class v extends o6.a {
    ...
    */
    public static v b(JSONObject jSONObject) {
        ...
        b0 b0Var = new b0(jSONObject3.getString("name"), u6.b.b(jSONObject3.getString("id")), jSONObject3.has("icon") ? jSONObject3.optString("icon") : null, jSONObject3.optString("displayName"));
        byte[] b11 = u6.b.b(jSONObject.getString("challenge"));
        n6.l.h(b11);
    ...
    public final boolean equals(Object obj) {
        ...
        List list2 = vVar.d;
        List list3 = vVar.f;
        if (n6.l.l(this.a, vVar.a) && n6.l.l(this.b, vVar.b) && Arrays.equals(this.c, vVar.c) && n6.l.l(this.e, vVar.e)) {
            List list4 = this.d;
            if (list4.containsAll(list2) && list2.containsAll(list4) && ((((list = this.f) == null && list3 == null) || (list != null && list3 != null && list.containsAll(list3) && list3.containsAll(list))) && n6.l.l(this.h, vVar.h) && n6.l.l(this.n, vVar.n) && n6.l.l(this.r, vVar.r) && n6.l.l(this.s, vVar.s) && n6.l.l(this.v, vVar.v) && n6.l.l(this.w, vVar.w))) {
                return true;
            }
        }
        return false;
