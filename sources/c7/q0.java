...
public final class q0 extends o6.a {
    ...
    public q0(byte[][] bArr) {
        n6.l.b(bArr != null);
        n6.l.b(1 == ((bArr.length & 1) ^ 1));
        int i10 = 0;
        while (i10 < bArr.length) {
            n6.l.b(i10 == 0 || bArr[i10] != null);
            int i11 = i10 + 1;
            n6.l.b(bArr[i11] != null);
            int length = bArr[i11].length;
            n6.l.b(length == 32 || length == 64);
            i10 += 2;
        }
        this.a = bArr;
    }
    ...
    */
    ...
    public static byte[] f(JSONObject jSONObject) {
        ...
        return !jSONObject.has("second") ? d : n7.a.j(d, d(u6.b.b(jSONObject.getString("second"))));
    }
