    ...
    */
    public final JSONObject b() {
        ...
        try {
            ...
            n7.t0 t0Var = this.b;
            if (t0Var != null) {
                jSONObject.put("clientDataJSON", u6.b.c(t0Var.u()));
            }
            n7.t0 t0Var2 = this.c;
            if (t0Var2 != null) {
                jSONObject.put("attestationObject", u6.b.c(t0Var2.u()));
            }
            ...
            try {
                try {
                    e1 e1Var = (e1) ((b1) e1.d(t0Var2.u()).b(b1.class)).b.get(new c1("authData"));
                    if (e1Var == null) {
                        throw new IllegalArgumentException("attestation object missing authData");
                    }
                    n7.t0 t0Var3 = ((n7.x0) e1Var.b(n7.x0.class)).a;
                    byte[] bArr = t0Var3.b;
                    ByteBuffer asReadOnlyBuffer = ByteBuffer.wrap(bArr, 0, t0Var3.p()).asReadOnlyBuffer();
                    try {
                        ...
                        try {
                            try {
                                ...
                                int s10 = n7.t0.s(position, bArr.length, t0Var3.p());
                                g1 g1Var = new g1((s10 == 0 ? n7.t0.c : new n7.s0(bArr, position, s10)).r());
                                try {
                                    n7.s sVar = ((b1) n7.a.k(g1Var).b(b1.class)).b;
                                    e1 e1Var2 = (e1) sVar.get(new n7.z0(3L));
                                    e1 e1Var3 = (e1) sVar.get(new n7.z0(1L));
                                    if (e1Var2 == null || e1Var3 == null) {
                                        throw new IllegalArgumentException("COSE key missing required fields");
                                    }
                                    try {
                                        long j10 = ((n7.z0) e1Var2.b(n7.z0.class)).a;
                                        long j11 = ((n7.z0) e1Var3.b(n7.z0.class)).a;
                                        byte[] bArr2 = null;
                                        if (j11 != 1) {
                                            if (j11 != 2) {
                                                j3 = j10;
                                                jSONObject.put("authenticatorData", u6.b.c(t0Var3.u()));
                                        ...
                                        e1 e1Var4 = (e1) sVar.get(new n7.z0(-1L));
                                        if (e1Var4 == null) {
                                            throw new IllegalArgumentException("COSE key missing required fields");
                                        }
                                        long j12 = ((n7.z0) e1Var4.b(n7.z0.class)).a;
                                        j3 = j10;
                                        if (j11 == 2 && j12 == 1) {
                                            e1 e1Var5 = (e1) sVar.get(new n7.z0(-2L));
                                            e1 e1Var6 = (e1) sVar.get(new n7.z0(-3L));
                                            if (e1Var5 == null || e1Var6 == null) {
                                                throw new IllegalArgumentException("COSE key missing required fields");
                                            }
                                            n7.t0 t0Var4 = ((n7.x0) e1Var5.b(n7.x0.class)).a;
                                            n7.t0 t0Var5 = ((n7.x0) e1Var6.b(n7.x0.class)).a;
                                            if (t0Var4.b.length != 32 || t0Var5.b.length != 32) {
                                                throw new IllegalArgumentException("COSE coordinates are the wrong size");
                                            }
                                            bArr2 = n7.a.j(Base64.decode("MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAE", 0), t0Var4.u(), t0Var5.u());
                                        } else if (j11 == 1 && j12 == 6) {
                                            e1 e1Var7 = (e1) sVar.get(new n7.z0(-2L));
                                            if (e1Var7 == null) {
                                                throw new IllegalArgumentException("COSE key missing required fields");
                                            }
                                            n7.t0 t0Var6 = ((n7.x0) e1Var7.b(n7.x0.class)).a;
                                            if (t0Var6.b.length != 32) {
                                                throw new IllegalArgumentException("COSE coordinates are the wrong size");
                                            }
                                            bArr2 = n7.a.j(Base64.decode("MCowBQYDK2VwAyEA", 0), t0Var6.u());
                                        }
                                        jSONObject.put("authenticatorData", u6.b.c(t0Var3.u()));
                                        jSONObject.put("publicKeyAlgorithm", j3);
                                        if (bArr2 != null) {
