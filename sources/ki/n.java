...
public final /* synthetic */ class n implements Runnable {
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                if (qVar.V && qVar.G == 0 && qVar.D) {
                    qVar.w.g(qVar.v, qVar.r, false);
                    qVar.E = false;
                    qVar.F = false;
                    qVar.G = 1;
                    ...
                    qVar.e.b("synthetic camera switch started");
                    qVar.A = -1L;
                    handler.removeCallbacks(qVar.a0);
                    handler.post(qVar.a0);
                    return;
                }
                return;
            case 1:
                ...
                r0Var.M++;
                r0Var.v = true;
                r0Var.l.b("camera switch started: target=" + k0Var);
                b60 b60Var = (b60) r0Var.c.a;
                il ilVar = b60Var.E;
                ...
                return;
            case 2:
                ((r0) ((k2.u) this.b).b).g((Exception) this.c);
                return;
            case 3:
    ...
    public /* synthetic */ n(m4.a0 a0Var, m4.r rVar, Runnable runnable) {
        this.a = 4;
        this.b = a0Var;
        this.c = runnable;
    }
