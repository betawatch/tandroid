...
public final class s0 {
    ...
    public s0(j0 j0Var) {
        ...
        mVar.b(sb2.toString());
        this.k = new i(context2, textureView, q0Var, i10, m0Var, n0Var, z10, mVar, uVar);
    }
        ...
        synchronized (this.f) {
            try {
                ...
                if (o0Var != null && !o0Var.d) {
                    o0Var.d = true;
                    this.l.b("output generation invalidated: id=" + o0Var.a + ", reason=" + hg.c.B(i10) + ", availableSize=" + o0Var.c);
                    this.j.execute(new e0(this, o0Var, i10, 1));
                }
                return true;
            } catch (Throwable th2) {
                throw th2;
    ...
    public final void c(boolean z10) {
        synchronized (this.f) {
            ...
            this.O = o0Var;
            this.P = new t(createTempFile, this.m.a, z10, this.l, new ah.b(23, this, o0Var));
            this.l.b("output generation started: id=" + j3 + ", includeAudio=" + z10 + ", file=" + createTempFile.getName());
            this.j.execute(new gg.t(this, o0Var, createTempFile, 24));
        }
    }
    ...
    public final void g(Exception exc) {
        ...
        if (b(4)) {
            ...
            o0 o0Var = this.O;
            if (o0Var != null) {
                this.j.execute(new e0(this, o0Var, exc));
            }
            u(9);
            l("error");
        ...
        synchronized (this.f) {
            try {
                if (!o0Var.d && !o0Var.e) {
                    o0Var.d = true;
                    this.l.b("output generation invalidated: id=" + o0Var.a + ", reason=" + hg.c.B(i10) + ", availableSize=" + o0Var.c);
                    this.j.execute(new e0(this, o0Var, i10, 0));
                }
            } finally {
            }
        }
    ...
    public final void m() {
        l0 l0Var = this.o;
        l0 l0Var2 = this.p;
        k0 k0Var = new k0(l0Var, l0Var2, this.W, this.s);
        b60 b60Var = (b60) this.c.a;
        b60Var.S = k0Var;
        if (l0Var2 != null) {
            pi.e.h.b(l0Var2);
    ...
    public final void n() {
        ...
        b60Var.n0 = Math.max(b60Var.n0, j3);
        if (i10 == 3) {
            if (!b60Var.v0) {
                b60Var.v0 = true;
    ...
    public final void v(float f7) {
        ...
        this.k.z(Math.max(0.0f, Math.min(1.0f, f7)));
    }
