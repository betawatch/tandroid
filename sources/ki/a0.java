...
public final class a0 {
    ...
    public a0(int i10, Size size, int i11, boolean z10) {
        ...
        this.h = new z();
        this.i = new v();
        this.j = z10 ? new x(AndroidUtilities.readRes(R.raw.round_blur_vert), AndroidUtilities.readRes(R.raw.round_blur_stage_3_frag)) : null;
    ...
    public final void e(x xVar, int i10, int i11) {
        GLES20.glUseProgram(xVar.a);
        this.k.position(i11);
        GLES20.glVertexAttribPointer(0, 3, 5126, false, 12, (Buffer) this.k);
        this.l.position(i10);
        GLES20.glVertexAttribPointer(xVar.d, 2, 5126, false, 8, (Buffer) this.l);
    }
    ...
    public final void n(float f7, float f10, float f11, int i10, int i11) {
        ...
        GLES20.glUniform1f(zVar.f, f10);
        GLES20.glUniform1f(zVar.g, f11);
        GLES20.glUniform1f(zVar.h, this.d ? 1.0f : 0.0f);
        GLES20.glDrawArrays(5, 0, 4);
        q();
    }
    ...
    public final void p(int i10, float[] fArr, int i11, float f7) {
        ...
        GLES20.glUniform2f(yVar.f, fArr[0] * height, fArr[1] * height);
        GLES20.glUniform2f(yVar.g, fArr[4] * width, fArr[5] * width);
