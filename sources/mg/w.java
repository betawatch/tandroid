...
public final /* synthetic */ class w implements p51, ug.g, n7, c2, c9.e, org.telegram.ui.Cells.v, jl0, iy, x4, y4, MessagesController.ErrorDelegate, LanguageDetector.ExceptionCallback, xj0, MessagesStorage.BooleanCallback, ResultCallback, MessagesStorage.LongCallback, ag1 {
    ...
    public void e(d8 d8Var, boolean z4, boolean z10, boolean z11, boolean z12, TLRPC.InputPeer inputPeer, int i10, f6 f6Var, org.telegram.ui.web.o0 o0Var) {
        switch (this.a) {
            case 2:
                ...
                tL_stories_editStory.privacy_rules = d8Var.b;
                ConnectionsManager.getInstance(d4Var.z2).sendRequest(tL_stories_editStory, new b1(d4Var, f6Var, storyItem, d8Var, 6));
                break;
            default:
                w3 w3Var = (w3) this.b;
                f8 f8Var = (f8) this.c;
                ...
                if (storyItem3 != null) {
                    ...
                    if (messageMedia instanceof TLRPC.TL_messageMediaVideoStream) {
                        ...
                        ConnectionsManager.getInstance(d4Var2.z2).sendRequest(togglegroupcallsettings, new d3(12, w3Var, f8Var));
                        break;
                    }
                }
                break;
    ...
    public void j(TLRPC.TL_inputCheckPasswordSRP tL_inputCheckPasswordSRP) {
        ((jq) this.b).p0(tL_inputCheckPasswordSRP, (TwoStepVerificationActivity) this.c);
    }
            ...
            default:
                ...
                if (j10 == 0) {
                    ...
                    if (qpVar.s) {
                        ...
                        qpVar.B = j10;
                        qpVar.f = qpVar.getMessagesController().getChat(Long.valueOf(j10));
                    }
                    runnable.run();
                    break;
                }
