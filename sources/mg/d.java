    ...
    */
    public final void b(Canvas canvas) {
        ...
        while (i11 < arrayList.size()) {
            ...
            cVar3.h = clamp;
            mr mrVar = mr.g;
            float interpolation = mrVar.getInterpolation(clamp);
            float lerp = AndroidUtilities.lerp(cVar3.a, cVar3.c, interpolation);
            d dVar = cVar3.l;
            l5 l5Var = dVar.a;
            float f11 = cVar3.h;
            float lerp2 = f11 < 0.3f ? AndroidUtilities.lerp(cVar3.b, cVar3.d, mrVar.getInterpolation(f11 / 0.3f)) : AndroidUtilities.lerp(cVar3.d, cVar3.e, mr.i.getInterpolation((f11 - 0.3f) / 0.7f));
