    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (d0Var.l) {
            ...
            hashMap3.clear();
            if (i17 == 1 || (pk0Var5.getDelegate() != null && pk0Var5.getDelegate().s())) {
                f10 = 1.0f;
                ...
                i10 = 4;
                f11 = 255.0f;
                delegate.n(canvas, rectF9, lerp, x10, i17 == 1 ? c0Var.getY() - AndroidUtilities.statusBarHeight : c0Var.getY() + d0Var.c.getY(), 255, true);
                canvas2 = canvas;
                rectF = rectF9;
            } else {
            ...
            if (pk0Var != null) {
                for (int childCount = zVar.e0.getChildCount() - 1; childCount >= 0; childCount--) {
                    if (zVar.e0.getChildAt(childCount) instanceof y51) {
                        y51 y51Var = (y51) zVar.e0.getChildAt(childCount);
                        if (y51Var.y && (q0Var = y51Var.x) != null) {
                            hashMap.put(q0Var, y51Var);
                        }
                    }
                }
                ...
                while (i20 < pk0Var.b.getChildCount()) {
                    ...
                    if (childAt.getLeft() < 0 || childAt.getVisibility() == 8) {
                        ...
                        if (childAt instanceof nk0) {
                            ...
                            y51 y51Var2 = (y51) hashMap.get(nk0Var.e);
                            if (y51Var2 != null) {
                                ...
                                i13 = i20;
                                float x13 = ((zVar.e0.getX() + (zVar.getX() + y51Var2.getX())) - mk0Var2.getX()) - AndroidUtilities.dp(1.0f);
                                float y13 = (zVar.e0.getY() + (zVar.d0.getY() + (zVar.getY() + y51Var2.getY()))) - mk0Var2.getY();
                                float measuredWidth = y51Var2.getMeasuredWidth();
                                if (y51Var2.I) {
                                    i16 = 4;
                                } else {
                                    i16 = 4;
                                ...
                                float f35 = y51Var2.I ? 0.95f * f21 : f21;
                            ...
                            if (y51Var2 != null) {
                                if (y51Var2.I) {
                                    ...
                                    float lerp4 = AndroidUtilities.lerp(measuredWidth4, (y51Var2.getMeasuredWidth() - AndroidUtilities.dp(f13)) / f18, d0Var.j);
                ...
                if (y51Var3 != null) {
                    ...
                    if (f39 != 1.0f && !zVar.Q0 && zVar.e1) {
                        ...
                        if (f40 >= 1.0f) {
                            ...
                            o61 o61Var = zVar.E;
                            if (o61Var != null) {
                                pk0 pk0Var6 = (pk0) ((androidx.biometric.f0) o61Var).b;
                                if (y51Var3.s) {
                                    pk0Var6.l(y51Var3, y51Var3.x, true);
                                } else {
                                    long j10 = y51Var3.e.documentId;
                                    q0 q0Var2 = new q0();
                                    q0Var2.g = j10;
                                    q0Var2.h = j10;
                                    pk0Var6.l(y51Var3, q0Var2, true);
                                }
                            }
                        }
                        zVar.P0.D = zVar.R0;
                    ...
                    canvas2.save();
                    canvas2.translate(zVar.P0.getX() + m51Var.getX(), zVar.P0.getY() + m51Var.getY() + zVar.d0.getY());
    ...
    public final void invalidate() {
        ...
        d0 d0Var = this.w;
        pk0 pk0Var = d0Var.n;
        if (d0Var.y == 1 || !(pk0Var == null || pk0Var.getDelegate() == null || !pk0Var.getDelegate().s())) {
