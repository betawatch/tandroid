...
public final class m0 {
    ...
    */
    public m0(Context context, p2 p2Var, pk0 pk0Var, View view, View view2, float f10, float f11, q0 q0Var, int i10, int i11, boolean z4) {
        ...
        this.t = null;
        this.z = z4;
        boolean z11 = view instanceof s1;
        if (z11) {
        ...
        this.a = i11;
        this.v = view;
        o0 m9 = z11 ? ((s1) view).K.m(q0Var) : view instanceof v0 ? ((v0) view).z0.m(q0Var) : null;
        if (z4 && i11 == 2) {
            view3 = view2;
            o0Var = m9;
            j10 = 0;
        ...
        zn znVar3 = p2Var2 instanceof zn ? (zn) p2Var2 : null;
        if (pk0Var2 != null) {
            e1 e1Var = pk0Var2.b;
            int i19 = 0;
            while (true) {
        ...
        if (i11 == 1) {
            ...
            if (arrayList != null && znVar3 != null && znVar3.a() < j10) {
                f12 = 0.0f;
                int i20 = 0;
                    ...
                    if (this.p.equals(arrayList.get(i20).reaction) && arrayList.get(i20).unread) {
                        ...
                        if (peerId < j10) {
                            ...
                            if (chat != null) {
                                ...
                                l0Var.e = w2.c(ai.f(random, 100), 100.0f, 0.1f, 0.3f);
                                l0Var.h = w2.c(ai.f(random, 100), 100.0f, 0.4f, 0.8f);
                                l0Var.i = (Math.abs(random.nextInt() % 100) * 60) / 100.0f;
                                l0Var.b = (int) w2.c(ai.f(random, 100), 100.0f, 200.0f, 400.0f);
                                float f16 = 0.6f;
                                float f17 = 0.2f;
                                if (this.x.isEmpty()) {
                                    int i21 = 0;
                                    ...
                                    while (i21 < 10) {
                                        int i22 = i21;
                                        float d = android.support.v4.media.a.d(ai.f(random, 100), f16, 100.0f, f17);
                                        float d10 = android.support.v4.media.a.d(ai.f(random, 100), 0.4f, 100.0f, f17);
                                    ...
                                    l0Var.f = android.support.v4.media.a.d(ai.f(random, 100), 0.6f, 100.0f, 0.2f);
                                    l0Var.g = (ai.f(random, 100) * 0.4f) / 100.0f;
                                }
                                this.x.add(l0Var);
                            }
                        } else {
                            ...
                            if (user != null) {
                                ...
                                l0Var2.e = w2.c(ai.f(random, 100), 100.0f, 0.1f, 0.3f);
                                l0Var2.h = w2.c(ai.f(random, 100), 100.0f, 0.4f, 0.8f);
                                l0Var2.i = (Math.abs(random.nextInt() % 100) * 60) / 100.0f;
                                l0Var2.b = (int) w2.c(ai.f(random, 100), 100.0f, 200.0f, 400.0f);
                                float f162 = 0.6f;
                                float f172 = 0.2f;
                                if (this.x.isEmpty()) {
                                }
                ...
                if (view3 == null) {
                    ...
                    if (nk0Var == null) {
                        if (o0Var != null) {
                            ...
                            int[] iArr2 = this.j;
                            f14 = iArr2[1] + f11 + (view4 instanceof s1 ? ((s1) view4).S : 0);
                            f13 = iArr2[0] + f10;
                        } else {
                            f13 = f10;
                            f14 = f11;
                        ...
                        j0Var = new j0(this, context2, p2Var, view5, z4, messageObject4, znVar, i15, i11, z12, f28, f13, f14, q0Var);
                        this.i = j0Var;
                ...
                j0Var = new j0(this, context2, p2Var, view52, z4, messageObject42, znVar, i15, i11, z12, f282, f13, f14, q0Var);
                this.i = j0Var;
                k0Var = new k0(this, context2);
                this.b = k0Var;
                k0Var2 = new k0(this, context2);
        ...
        j0Var = new j0(this, context2, p2Var, view522, z4, messageObject422, znVar, i15, i11, z12, f2822, f13, f14, q0Var);
        this.i = j0Var;
        k0Var = new k0(this, context2);
        this.b = k0Var;
        k0Var2 = new k0(this, context2);
