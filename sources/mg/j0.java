...
public final class j0 extends FrameLayout {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        nr nrVar = nr.f;
        float interpolation = nrVar.getInterpolation(this.x.h);
        if (this.h == 2) {
            f14 = nr.h.getInterpolation(interpolation);
            f15 = nrVar.getInterpolation(interpolation);
            f13 = 2.0f;
        } else if (this.n) {
            f13 = 2.0f;
            f14 = nr.h.getInterpolation(this.x.g);
            f15 = nrVar.getInterpolation(this.x.g);
        } else {
            f13 = 2.0f;
            f14 = this.x.g;
            f15 = f14;
