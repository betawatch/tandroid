...
public final class v extends FrameLayout {
    ...
    */
    public final void c(boolean z4) {
        ...
        qj qjVar = xnVar.u0;
        int[] iArr = this.y;
        qjVar.getLocationInWindow(iArr);
        boolean z12 = true;
        float f13 = iArr[1];
        getLocationInWindow(iArr);
        float f14 = (f13 - iArr[1]) - xnVar.K9;
        boolean z13 = false;
        for (int i10 = 0; i10 < qjVar.getChildCount(); i10++) {
            View childAt = qjVar.getChildAt(i10);
            if (childAt instanceof t1) {
                ...
                if (messageObject.getId() == this.e.getId()) {
                    ...
                    int height2 = getHeight() != 0 ? getHeight() : qjVar.getHeight();
                    ...
                    if (y10 > dp4 - (f16 / 2.0f) && y10 < dp5) {
                        ...
                        if (y10 < (dp4 - f16) - AndroidUtilities.dp(92.0f) || y10 > dp5) {
                            ...
                            float interpolation = (nr.f.getInterpolation(this.n) * this.s) + y10;
                            uVar = this.b;
                            if (uVar != null) {
                                return;
                            }
                            ...
                            int c3 = a2.c(32.0f, t1Var.getBackgroundDrawableLeft(), 0);
                            int c10 = a2.c(32.0f, t1Var.getWidth() - t1Var.getBackgroundDrawableRight(), (int) t1Var.E2(true));
                    ...
                    float interpolation2 = (nr.f.getInterpolation(this.n) * this.s) + y10;
                    uVar = this.b;
                    if (uVar != null) {
                    }
                }
    ...
    */
    public void setSelectedMessages(List<MessageObject> list) {
        ...
        int i10 = xnVar.O3;
        boolean z4 = true;
        if (i10 != 1 && i10 != 5 && i10 != 6 && !xnVar.A9() && !xnVar.v() && (((chatFull = xnVar.W7) == null || !(chatFull.available_reactions instanceof TLRPC.TL_chatReactionsNone)) && !list.isEmpty())) {
            long j10 = 0;
            boolean z10 = false;
