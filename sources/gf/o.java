...
public abstract class o {
    public static SpannableStringBuilder a(String str) {
        try {
            Spanned fromHtml = Build.VERSION.SDK_INT >= 24 ? Html.fromHtml("<inject>" + str + "</inject>", 63, null, new m(new ab.a(8))) : Html.fromHtml("<inject>" + str + "</inject>", null, new m(new ab.a(8)));
            if (fromHtml == null) {
                return null;
            }
            ...
            for (int i12 = 0; i12 < arrayList3.size(); i12++) {
                ...
                hi0.c(spannableStringBuilder, fromHtml.getSpanStart(nVar3), fromHtml.getSpanEnd(nVar3), nVar3.a == 3);
            }
