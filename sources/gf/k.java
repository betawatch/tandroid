...
public final class k implements Choreographer.FrameCallback {
    ...
    public k() {
        ...
        this.e = new yd.b(true);
        this.f = new yd.b(true);
    ...
    */
    ...
    public final i e(int i10) {
        ...
        i iVar2 = new i(1000000000 / i10, 60 % i10 == 0 ? 60 / i10 : 0);
    ...
    public final void g(Runnable runnable) {
        ...
        while (true) {
            SparseArray sparseArray = this.c;
            if (i10 >= sparseArray.size() || ((i) sparseArray.valueAt(i10)).e.remove(runnable)) {
                return;
            } else {
                i10++;
            }
    ...
    public final void h(Runnable runnable) {
        ...
        while (true) {
            ...
            yd.b bVar = ((i) sparseArray.valueAt(i10)).f;
