...
public final /* synthetic */ class k0 implements Runnable {
    ...
    public /* synthetic */ k0(Object obj, int i10, Object obj2, Object obj3, Object obj4, Object obj5, int i11) {
        this.a = i11;
        this.b = obj;
        this.c = i10;
        this.d = obj2;
    ...
    public final void run() {
        ...
        switch (this.a) {
                ...
                if (tLObject instanceof TLRPC.TL_photos_photo) {
                    ...
                    if ((photo instanceof TLRPC.TL_photo) && user != null) {
                        ...
                        if (closestPhotoSizeWithSize == null || photoSize2 == null || photoSize2.location == null) {
                            ...
                            sb2.append("_");
                            String k10 = a9.p.k(photoSize2.location.local_id, "@50_50", sb2);
                            StringBuilder sb3 = new StringBuilder();
                            photoSize = closestPhotoSizeWithSize2;
                            sb3.append(closestPhotoSizeWithSize.location.volume_id);
                            sb3.append("_");
                            ImageLoader.getInstance().replaceImageInCache(k10, a9.p.k(closestPhotoSizeWithSize.location.local_id, "@50_50", sb3), ImageLocation.getForUser(i10, user, 1), false);
                        }
            ...
            case 1:
                ...
                if (tLObject2 instanceof TLRPC.ChatInvite) {
                    ...
                    if (tL_starsSubscriptionPricing == null) {
                        ...
                        u7.y(i11, false).j0(tL_messages_checkChatInvite.hash, chatInvite, new Utilities.Callback2() { // from class: hh.c9
            ...
            case 4:
                ...
                break;
            case 5:
                ((MediaDataController) this.b).lambda$removeMultipleStickerSets$111((boolean[]) this.d, (ArrayList) this.e, (Context) this.f, (n2) this.h, this.c);
                break;
            case 6:
            ...
            case 8:
                ...
                new k61(context2, chat2, user2, new w1(this.c, booleanCallback, 25), (c6) this.h).show();
                break;
            case 9:
                m9.a((m9) this.b, (Runnable[]) this.d, (Bitmap) this.e, (m50) this.f, this.c, (w5[]) this.h);
                break;
            case 10:
                cg0.m((cg0) this.d, (Integer[]) this.e, this.c, (TLObject) this.b, (ArrayList) this.f, (TLRPC.PollAnswerVoters) this.h);
                break;
            case 11:
                js.Y((js) this.d, (TLRPC.FileLocation) this.e, (TLRPC.InputFile) this.f, (TLObject) this.b, (TLRPC.FileLocation) this.h, this.c);
                break;
            case 12:
                ...
                if (tL_urlAuthResultRequest.match_codes.isEmpty() || !TextUtils.isEmpty(strArr[0])) {
                    ...
                    tk0.c(context3, this.c, tL_urlAuthResultRequest.match_codes, tL_urlAuthResultRequest.domain, new ib0(5, strArr, rk0Var), true, new l3(22), n2Var.getResourceProvider());
                    break;
                }
                break;
            case 13:
                ...
                if (gVar.a == 0) {
                    ...
                    BillingController.getInstance().addResultListener(BillingController.PREMIUM_PRODUCT_ID, new org.telegram.ui.l3(ci0Var, 4));
    ...
    public /* synthetic */ k0(Object obj, Object obj2, Object obj3, int i10, Object obj4, Object obj5, int i11) {
        this.a = i11;
        this.b = obj;
        this.d = obj2;
        this.e = obj3;
    ...
    public /* synthetic */ k0(d8 d8Var, TLObject tLObject, Object obj, ArrayList arrayList, boolean[] zArr, int i10) {
        this.a = 2;
        this.d = d8Var;
        this.b = tLObject;
        this.e = obj;
    ...
    public /* synthetic */ k0(lh.d dVar, TLObject tLObject, e3[] e3VarArr, c6 c6Var, int i10, TLRPC.TL_messages_checkChatInvite tL_messages_checkChatInvite) {
        this.a = 1;
        this.d = dVar;
        this.b = tLObject;
        this.e = e3VarArr;
    ...
    public /* synthetic */ k0(ChatObject.Call call, int i10, TLObject tLObject, ChatObject.Call.OnParticipantsLoad onParticipantsLoad, ArrayList arrayList, HashSet hashSet) {
        this.a = 3;
        this.d = call;
        this.c = i10;
        this.b = tLObject;
    ...
    public /* synthetic */ k0(MediaDataController mediaDataController, boolean[] zArr, ArrayList arrayList, Context context, n2 n2Var, int i10) {
        this.a = 5;
    ...
    public /* synthetic */ k0(m9 m9Var, Runnable[] runnableArr, Bitmap bitmap, m50 m50Var, int i10, w5[] w5VarArr) {
        this.a = 9;
        this.b = m9Var;
        this.d = runnableArr;
        this.e = bitmap;
    ...
    public /* synthetic */ k0(cg0 cg0Var, Integer[] numArr, int i10, TLObject tLObject, ArrayList arrayList, TLRPC.PollAnswerVoters pollAnswerVoters) {
        this.a = 10;
        this.d = cg0Var;
        this.e = numArr;
        this.c = i10;
    ...
    public /* synthetic */ k0(js jsVar, TLRPC.FileLocation fileLocation, TLRPC.InputFile inputFile, TLObject tLObject, TLRPC.FileLocation fileLocation2, int i10) {
        this.a = 11;
        this.d = jsVar;
        this.e = fileLocation;
        this.f = inputFile;
    ...
    public /* synthetic */ k0(d70 d70Var, k4 k4Var, TLRPC.TL_error tL_error, TLObject tLObject, int i10, g1 g1Var) {
        this.a = 6;
        this.d = d70Var;
        this.e = k4Var;
        this.f = tL_error;
    ...
    public /* synthetic */ k0(z0 z0Var, String str, TLObject tLObject, TLRPC.TL_error tL_error, int i10, w0 w0Var) {
        this.a = 14;
        this.d = z0Var;
        this.e = str;
        this.b = tLObject;
