...
public final class f {
    ...
    public f(x xVar) {
        ...
        String i9 = h.i(xVar.b().a);
        String f10 = h.f(bArr);
        Locale locale = Locale.US;
        b = String.format(locale, "%s%s%s%s", f10.substring(0, 12), f10.substring(12, 16), f10.subSequence(16, 20), i9.substring(0, 12)).toUpperCase(locale);
    }
