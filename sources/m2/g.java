...
public class g extends ViewGroup {
    ...
    */
    ...
    public final int g(int i10, int i11, float f10, int i12) {
        ...
        ArrayList arrayList = this.b;
        if (arrayList.size() > 0) {
            return Math.max(((c) arrayList.get(0)).b, Math.min(i10, ((c) i0.a.i(1, arrayList)).b));
        }
        return i10;
    }
                    ...
                    if (Math.abs(left2) >= 1.0f) {
                        ...
                        if (!p7Var.d) {
                            ...
                            if (y8Var.t0 != null) {
                                e4 e4Var = p7Var.a;
                                long j10 = p7Var.b;
                                ArrayList arrayList2 = p7Var.c;
                                e4Var.x1 = j10;
                                e4Var.v1 = arrayList2;
                                e4Var.o0(-1);
                            } else {
                                p7Var.a.U0(-1, p7Var.b);
                            }
                        }
                        p7Var.a.setOffset(left2);
        ...
        for (int i27 = 0; i27 < childCount; i27++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!dVar2.a && (k10 = k(childAt2)) != null) {
                    ...
                    if (dVar2.d) {
                        dVar2.d = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f10 * dVar2.c), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((i17 - paddingTop) - paddingBottom, TLObject.FLAG_30));
                    }
    ...
    */
    public final void t(int i10) {
        ...
        if (b10 != this.a) {
            ...
            i0.a.x(sb2, this.a, ", found: ", b10, " Pager id: ");
        ...
        if (cVar2 != null) {
            ...
            int i29 = b11 - 1;
            this.C = i27 == i29 ? (cVar2.d + f16) - 1.0f : Float.MAX_VALUE;
            int i30 = i15 - 1;
            while (i30 >= 0) {
