...
public abstract class m3 extends FrameLayout {
    ...
    public o1.j v;
    public boolean w;
    public org.telegram.ui.web.x0 x;
    public Runnable y;
    ...
    public m3(Context context) {
        ...
        this.R = true;
        this.b = new org.telegram.ui.Cells.f1(context, new sr(this, ViewConfiguration.get(context).getScaledTouchSlop(), 2));
    ...
    public final boolean b(boolean z4) {
        org.telegram.ui.web.x0 x0Var = this.x;
    ...
    public void setOffsetY(final float f10) {
        ...
        if (this.s) {
            this.f = f10;
            if (z4) {
                this.r = k7.o.a(this.r - Math.max(0.0f, f12), (-this.f) + this.e, (getHeight() - this.f) + this.e);
            }
            c();
            return;
        }
        ...
        jVar3.u = yh.n(f10, 1400.0f, 1.0f);
        jVar3.b(new o1.g() { // from class: sh.k3
            @Override // o1.g
            public final void a(o1.h hVar, float f13, float f14) {
                ...
                if (z4) {
                    m3Var.r = k7.o.a(m3Var.r - (Math.max(0.0f, f15) * f17), (-m3Var.f) + m3Var.e, (m3Var.getHeight() - m3Var.f) + m3Var.e);
                }
                o1.j jVar4 = m3Var.D;
                if (jVar4 != null) {
                    o1.k kVar = jVar4.u;
