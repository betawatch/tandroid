...
public abstract class l0 extends LinearLayout implements dh.a, xd.i {
    ...
    public l0(Context context, g6 g6Var) {
        ...
        this.x = new xd.j(this, pr.h, 320L);
        this.a = g6Var;
        setOrientation(1);
    ...
    public final void d() {
        AndroidUtilities.setScrollViewEdgeEffectColor(this.r, k6.v0(k6.He, this.a));
        int i10 = 0;
        while (true) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (navigationBarThirdButtonsFactor > 0.0f) {
            int l1 = k6.l1(navigationBarThirdButtonsFactor, k6.v0(k6.He, this.a));
            int i10 = this.w;
    ...
    */
    public void setButtons(TLRPC.TL_replyKeyboardMarkup tL_replyKeyboardMarkup) {
        ...
        while (i11 < tL_replyKeyboardMarkup.rows.size()) {
            ...
            k0Var2.addView(linearLayout, c6.k(8.0f, i11 == 0 ? 8.0f : 4.0f, 8.0f, i11 == tL_replyKeyboardMarkup.rows.size() - 1 ? 8.0f : 0.0f, -1, this.h));
            ...
            while (i12 < keyboardButtonRow.buttons.size()) {
                ...
                frameLayout.addView(j0Var, c6.c(-1.0f, -1));
                linearLayout.addView(frameLayout, c6.m(size, 0, -1, 0, i12 != keyboardButtonRow.buttons.size() - 1 ? 4 : 0, 0));
                j0Var.setOnClickListener(new org.telegram.ui.Components.voip.o(this, 14));
                e6.b(j0Var, 0.02f, 1.5f);
                arrayList.add(j0Var);
                j0Var.a();
                i12++;
            }
    ...
    public void setPanelHeight(int i10) {
        ...
        while (it.hasNext()) {
            xd.e eVar = (xd.e) it.next();
            int childCount = ((k0) eVar.a).getChildCount();
            for (int i11 = 0; i11 < childCount; i11++) {
                View childAt = ((k0) eVar.a).getChildAt(i11);
