...
public final class n3 extends ei implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final boolean J() {
        ...
        d2Var.show();
        ((TextView) d2Var.d(-1)).setTextColor(k6.v0(k6.q7, this.a));
        return false;
    }
    ...
    public final void K() {
        ...
        if ((p2Var instanceof xn) && ((xn) p2Var).U0.R() > AndroidUtilities.dp(20.0f)) {
            AndroidUtilities.hideKeyboard(miVar.c0.getFragmentView());
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 != NotificationCenter.webViewResultSent) {
            if (i10 == NotificationCenter.didSetNewTheme) {
                i3Var.n.b(k6.v0(k6.h5, this.a), 153);
                return;
            }
            return;
        }
    ...
    public final void t(int i10) {
        ...
        if (i10 == i11) {
            ...
            miVar.c0.presentFragment(new xn(bundle));
            miVar.dismiss();
            return;
        }
        int i12 = 0;
