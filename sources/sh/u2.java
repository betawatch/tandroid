...
public final /* synthetic */ class u2 implements View.OnClickListener {
    ...
    public /* synthetic */ u2(int i10, org.telegram.ui.ActionBar.h3 h3Var, g6 g6Var, LinearLayout linearLayout, long j10, Context context, TL_payments.connectedBotStarRef connectedbotstarref) {
        this.b = i10;
        this.c = h3Var;
        this.d = g6Var;
        this.n = linearLayout;
        ...
        switch (this.a) {
            ...
            default:
                ...
                while (i12 < size) {
                    ...
                    F.g(tLObject, j10 == this.e, new u6(i11, j10, this.f, this.h, h3Var, g6Var));
                    i12 = i13;
                }
                F.t = false;
                F.s = 0;
