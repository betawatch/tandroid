    ...
    public final Drawable m(Context context, int i10, boolean z4, Drawable drawable) {
        ...
        if (aVar != null) {
            if (i10 == R.drawable.abc_seekbar_track_material) {
                ...
                int c3 = c3.c(context, R.attr.colorControlNormal);
                PorterDuff.Mode mode2 = q.b;
                a9.a.A(findDrawableByLayerId, c3, mode2);
                a9.a.A(layerDrawable.findDrawableByLayerId(android.R.id.secondaryProgress), c3.c(context, R.attr.colorControlNormal), mode2);
                a9.a.A(layerDrawable.findDrawableByLayerId(android.R.id.progress), c3.c(context, R.attr.colorControlActivated), mode2);
                return drawable;
            }
            if (i10 == R.drawable.abc_ratingbar_material || i10 == R.drawable.abc_ratingbar_indicator_material || i10 == R.drawable.abc_ratingbar_small_material) {
                ...
                int b10 = c3.b(context, R.attr.colorControlNormal);
                PorterDuff.Mode mode3 = q.b;
                a9.a.A(findDrawableByLayerId2, b10, mode3);
                a9.a.A(layerDrawable2.findDrawableByLayerId(android.R.id.secondaryProgress), c3.c(context, R.attr.colorControlActivated), mode3);
                a9.a.A(layerDrawable2.findDrawableByLayerId(android.R.id.progress), c3.c(context, R.attr.colorControlActivated), mode3);
                return drawable;
            }
        }
        a9.a aVar2 = this.g;
