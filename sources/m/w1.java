...
public abstract class w1 extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (this.d == 1 && (i10 = this.e & 112) != 48) {
            if (i10 == 16) {
                i12 = l.d.d(((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom(), this.f, 2, i12);
            } else if (i10 == 80) {
    ...
    */
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.d == 1) {
            ...
            int i25 = i24 & 112;
            int i26 = 8388615 & i24;
            int paddingTop = i25 != 16 ? i25 != 80 ? getPaddingTop() : ((getPaddingTop() + i13) - i11) - this.f : l.d.d(i13 - i11, this.f, 2, getPaddingTop());
            int i27 = 0;
            while (i27 < virtualChildCount) {
                ...
                if (childAt != null && childAt.getVisibility() != i22) {
                    ...
                    int d11 = absoluteGravity != 1 ? absoluteGravity != 5 ? ((LinearLayout.LayoutParams) v1Var).leftMargin + paddingLeft : (paddingRight - measuredWidth) - ((LinearLayout.LayoutParams) v1Var).rightMargin : (l.d.d(paddingRight2, measuredWidth, 2, paddingLeft) + ((LinearLayout.LayoutParams) v1Var).leftMargin) - ((LinearLayout.LayoutParams) v1Var).rightMargin;
                    if (h(i27)) {
                        paddingTop += this.x;
                    }
        ...
        if (absoluteGravity2 != 1) {
            ...
            c3 = 1;
            d = l.d.d(i12 - i10, this.f, 2, getPaddingLeft());
        }
        if (a2) {
                ...
                if (childAt2.getVisibility() != 8) {
                    ...
                    if (z10) {
                        ...
                        if (((LinearLayout.LayoutParams) v1Var2).height != -1) {
                            ...
                            i21 = i34;
                            if (i20 != 16) {
                                d10 = (l.d.d(paddingBottom2, measuredHeight2, 2, paddingTop2) + ((LinearLayout.LayoutParams) v1Var2).topMargin) - ((LinearLayout.LayoutParams) v1Var2).bottomMargin;
                            } else if (i20 == 48) {
                                d10 = ((LinearLayout.LayoutParams) v1Var2).topMargin + paddingTop2;
                                if (i18 != -1) {
                                    d10 = (iArr[c3] - i18) + d10;
                                }
                            } else if (i20 != 80) {
                                ...
                                d10 = (paddingBottom - measuredHeight2) - ((LinearLayout.LayoutParams) v1Var2).bottomMargin;
                                if (i18 != -1) {
                            ...
                            d = measuredWidth2 + ((LinearLayout.LayoutParams) v1Var2).rightMargin + i37;
                            i34 = i21 + 1;
                            i15 = i17;
                            i14 = i16;
                        }
                    ...
                    d = measuredWidth2 + ((LinearLayout.LayoutParams) v1Var2).rightMargin + i372;
                    i34 = i21 + 1;
                    i15 = i17;
                    i14 = i16;
                }
        ...
        if (i35 == 1) {
            ...
            while (i41 < virtualChildCount) {
                ...
                if (childAt == null) {
                    ...
                    f10 += f11;
                    if (mode2 == i38 && ((LinearLayout.LayoutParams) v1Var2).height == 0 && f11 > 0.0f) {
                        int i47 = w1Var.f;
            ...
            if (z18 || (i56 != 0 && f10 > 0.0f)) {
                ...
                while (i58 < virtualChildCount) {
                    ...
                    if (childAt3.getVisibility() == 8) {
                        ...
                        boolean z23 = z20 && ((LinearLayout.LayoutParams) v1Var4).width == i26;
                        int i61 = w1Var.f;
                ...
                if (childAt6.getVisibility() == 8) {
                    ...
                    if (mode3 == 1073741824 && ((LinearLayout.LayoutParams) v1Var6).width == 0 && f15 > 0.0f) {
                        ...
                        if (z24) {
                            ...
                            boolean z30 = !z29 && ((LinearLayout.LayoutParams) v1Var).height == -1;
                        ...
                        iArr2 = iArr3;
                        i22 = i68;
                        w1Var.measureChildWithMargins(childAt6, i65, f14 == 0.0f ? w1Var.f : 0, i11, 0);
        ...
        if (z28 || (i87 != 0 && f14 > 0.0f)) {
            ...
            while (i88 < virtualChildCount2) {
                ...
                if (childAt8 == null || childAt8.getVisibility() == 8) {
                    ...
                    boolean z33 = mode4 != 1073741824 && ((LinearLayout.LayoutParams) v1Var8).height == -1;
