...
public final class x0 {
    ...
    public final void a(Drawable drawable, f3 f3Var) {
        ...
        q.d(drawable, f3Var, this.a.getDrawableState());
    }
    ...
    */
    public final void f(AttributeSet attributeSet, int i10) {
        ...
        if (resourceId3 != -1) {
            ...
            n(context, w0Var);
            if (i14 < 23) {
                colorStateList = obtainStyledAttributes3.hasValue(3) ? w0Var.s(3) : null;
                colorStateList2 = obtainStyledAttributes3.hasValue(4) ? w0Var.s(4) : null;
                if (obtainStyledAttributes3.hasValue(5)) {
                    colorStateList3 = w0Var.s(5);
                    i13 = 15;
        ...
        if (i14 < 23) {
            if (obtainStyledAttributes4.hasValue(3)) {
                colorStateList = w0Var2.s(3);
            }
            if (obtainStyledAttributes4.hasValue(4)) {
                colorStateList2 = w0Var2.s(4);
            }
            if (obtainStyledAttributes4.hasValue(5)) {
                colorStateList3 = w0Var2.s(5);
            }
        }
        ...
        if (str3 != null) {
            if (i14 < 24) {
                ...
                if (obtainStyledAttributes2.hasValue(11)) {
                    if (!obtainStyledAttributes2.hasValue(11) || (resourceId = obtainStyledAttributes2.getResourceId(11, 0)) == 0 || (colorStateList4 = r7.a(context, resourceId)) == null) {
            ...
            try {
                ...
                if (v != null) {
                    if (i11 < 28 || this.k == -1) {
                        ...
                        this.l = w0.a(Typeface.create(v, 0), this.k, (this.j & 2) != 0);
                    }
                }
                this.m = this.l == null;
