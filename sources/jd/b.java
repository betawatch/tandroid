...
public class b {
    ...
    public final h b(long j10) {
        ...
        loop0: while (true) {
            dVar.getClass();
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = md.d.a;
        ...
        h hVar3 = (h) dVar;
        loop2: for (h hVar4 = hVar3; hVar4 != null; hVar4 = (h) ((md.d) md.d.b.get(hVar4))) {
            for (int i9 = d.b - 1; -1 < i9; i9--) {
                if ((hVar4.c * d.b) + i9 < j10) {
                    break loop2;
                }
                while (true) {
                    Object l10 = hVar4.l(i9);
                    if (l10 != null && l10 != d.e) {
                        if (!(l10 instanceof j)) {
                            if (!(l10 instanceof j2)) {
                                break;
                            }
                            if (hVar4.k(i9, l10, d.l)) {
                                obj = md.a.e(obj, l10);
                                hVar4.m(i9, true);
                                break;
                            }
    ...
    public final void d() {
        ...
        loop0: while (true) {
            ...
            int i9 = (int) (andIncrement % d.b);
            Object l10 = hVar.l(i9);
            boolean z10 = l10 instanceof j2;
            AtomicLongFieldUpdater atomicLongFieldUpdater2 = c;
            if (!z10 || andIncrement < atomicLongFieldUpdater2.get(this) || !hVar.k(i9, l10, d.g)) {
                while (true) {
    ...
    public final boolean i(long j10, boolean z10) {
        ...
        if (i9 != 0 && i9 != 1) {
            ...
            if (i9 == 2) {
                ...
                if (i9 != 3) {
                    throw new IllegalStateException(r0.l(i9, "unexpected close status: ").toString());
                }
                ...
                loop0: do {
                    ...
                    while (true) {
                        ...
                        long j14 = (b10.c * d.b) + i11;
                        while (true) {
                            Object l11 = b10.l(i11);
                            if (l11 == d.i) {
                                break loop0;
                            }
                            if (l11 == d.d) {
                                ...
                                if (b10.k(i11, l11, d.l)) {
                                    b10.n(i11, null);
                                    b10.i();
                                    break;
                                }
                            } else if (l11 != d.e && l11 != null) {
                                if (!(l11 instanceof j2) && !(l11 instanceof j)) {
                                    e5.c cVar = d.g;
                                    if (l11 == cVar || l11 == d.f) {
                                        break loop0;
                                    }
                                    ...
                                    j2 j2Var = l11 instanceof j ? ((j) l11).a : (j2) l11;
                                    if (b10.k(i11, l11, d.l)) {
                                        obj = md.a.e(obj, j2Var);
                                        b10.n(i11, null);
                                        b10.i();
                                        break;
                                    }
                                }
                            } else if (b10.k(i11, l11, d.l)) {
                                b10.i();
                                break;
                            }
                        }
    ...
    */
    ...
    public final Object o(h hVar, int i9, long j10, Object obj) {
        ...
        } else if (l10 == d.d && hVar.k(i9, l10, d.i)) {
            d();
        ...
        while (true) {
            ...
            if (l10 == null) {
                ...
                if (l10 != d.e) {
                    ...
                    if (hVar.f.getAndSet((i9 * 2) + 1, cVar) != cVar) {
                        hVar.m(i9, true);
                    }
                    return 5;
                }
    ...
    */
    public final String toString() {
        ...
        sb2.append("data=[");
        List c10 = pc.h.c(g.get(this), f.get(this), h.get(this));
        ...
        loop2: do {
            ...
            while (true) {
                ...
                long j13 = (hVar.c * d.b) + i11;
                if (j13 >= g10 && j13 >= j12) {
                    break loop2;
                }
                Object l10 = hVar.l(i11);
                Object obj3 = hVar.f.get(i11 * 2);
                if (l10 instanceof l) {
                    obj = (j13 >= j12 || j13 < g10) ? (j13 >= g10 || j13 < j12) ? "cont" : "send" : "receive";
                } else if (l10 instanceof j) {
                    obj = "EB(" + l10 + ')';
                } else if (kotlin.jvm.internal.i.a(l10, d.f) ? true : kotlin.jvm.internal.i.a(l10, d.g)) {
                    obj = "resuming_sender";
                } else if (l10 == null ? true : l10.equals(d.e) ? true : kotlin.jvm.internal.i.a(l10, d.i) ? true : kotlin.jvm.internal.i.a(l10, d.h) ? true : kotlin.jvm.internal.i.a(l10, d.k) ? true : kotlin.jvm.internal.i.a(l10, d.j) ? true : kotlin.jvm.internal.i.a(l10, d.l)) {
                    i11++;
                } else {
                    obj = l10.toString();
                }
