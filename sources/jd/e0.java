...
public abstract class e0 {
    public static final fc.a a = new fc.a("RESUME_TOKEN", 2);
    public static final fc.a b = new fc.a("REMOVED_TASK", 2);
    public static final fc.a c = new fc.a("CLOSED_EMPTY", 2);
    public static final fc.a d = new fc.a("COMPLETING_ALREADY", 2);
    public static final fc.a e = new fc.a("COMPLETING_WAITING_CHILDREN", 2);
    public static final fc.a f = new fc.a("COMPLETING_RETRY", 2);
    public static final fc.a g = new fc.a("TOO_LATE_TO_CANCEL", 2);
    ...
    public static i0 c(c0 c0Var, bd.p pVar) {
        d0 d0Var = d0.a;
        sc.h i10 = i(c0Var.c(), sc.i.a, true);
        qd.e eVar = m0.a;
        if (i10 != eVar && i10.get(sc.d.a) == null) {
            i10 = i10.plus(eVar);
        }
        d0 d0Var2 = d0.a;
    ...
    public static final sc.h i(sc.h hVar, sc.h hVar2, boolean z10) {
        ...
        return hVar3.plus((sc.h) obj);
    }

    public static final j0 j(sc.h hVar) {
        sc.f fVar = hVar.get(sc.d.a);
    ...
    */
    public static final Object o(Collection collection, uc.c cVar) {
        g gVar;
        int i10;
        Iterator it;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final Object p(f1[] f1VarArr, uc.c cVar) {
        f fVar;
        int i10;
        int i11;
        f1[] f1VarArr2;
    ...
    public static final void s(m mVar, sc.c cVar, boolean z10) {
        ...
        g2 v = k9 != od.a.f ? v(cVar2, context, k9) : null;
        try {
            cVar2.resumeWith(a2);
            if (v == null || v.M()) {
                od.a.f(context, k9);
    ...
    public static final g2 v(sc.c cVar, sc.h hVar, Object obj) {
        g2 g2Var = null;
        if ((cVar instanceof uc.d) && hVar.get(h2.a) != null) {
            uc.d dVar = (uc.d) cVar;
            while (true) {
    ...
    public static final Object w(sc.h hVar, bd.p pVar, sc.c cVar) {
        ...
        sc.h plus = !((Boolean) hVar.fold(Boolean.FALSE, x.d)).booleanValue() ? context.plus(hVar) : i(context, hVar, false);
        h(plus);
        if (plus == context) {
            od.t tVar = new od.t(cVar, plus);
