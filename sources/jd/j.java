...
public abstract class j extends i {
    ...
    public static final int d(int i10, CharSequence charSequence, String string, boolean z4) {
        ...
        gd.e eVar = new gd.e(i10, length, 1);
        boolean z11 = charSequence instanceof String;
        int i11 = eVar.c;
        int i12 = eVar.b;
        if (z11 && e2.c.s(string)) {
            ...
            while (true) {
                ...
                if (z4) {
                    str = string;
                    z10 = z4;
                    regionMatches = str.regionMatches(z10, 0, str2, i13, length3);
                } else {
    ...
    public static String f(int i10, String str) {
        ...
        kotlin.jvm.internal.j.e(str, "<this>");
        if (i10 < 0) {
            throw new IllegalArgumentException(k0.k(i10, "Desired length ", " is less than zero."));
        }
        if (i10 <= str.length()) {
