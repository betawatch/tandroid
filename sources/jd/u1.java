...
public class u1 implements f1, r, y1 {
    ...
    public static q D(od.l lVar) {
        while (lVar.h()) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = od.l.b;
            od.l d = lVar.d();
            if (d == null) {
    ...
    public final void E(v1 v1Var, Throwable th2) {
        ...
        a6.b bVar = null;
        for (od.l lVar = (od.l) f9; !lVar.equals(v1Var); lVar = lVar.g()) {
            if (lVar instanceof h1) {
                ...
                try {
                    ...
                    if (bVar != null) {
                        ...
                        bVar = new a6.b("Exception in completion handler " + k1Var + " for " + this, th3);
                    }
                }
            }
        }
    ...
    public final void H(k1 k1Var) {
        ...
        v1 v1Var = new v1();
        k1Var.getClass();
        od.l.b.set(v1Var, k1Var);
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = od.l.a;
    ...
    public final void m(a1 a1Var, Object obj) {
        ...
        if (a1Var instanceof k1) {
            try {
                ...
                w(new a6.b("Exception in completion handler " + a1Var + " for " + this, th3));
                return;
            }
        }
        v1 c3 = a1Var.c();
        if (c3 != null) {
            Object f9 = c3.f();
            kotlin.jvm.internal.j.c(f9, "null cannot be cast to non-null type kotlinx.coroutines.internal.LockFreeLinkedListNode{ kotlinx.coroutines.internal.LockFreeLinkedListKt.Node }");
            for (od.l lVar = (od.l) f9; !lVar.equals(c3); lVar = lVar.g()) {
                if (lVar instanceof k1) {
                    ...
                    try {
                        ...
                        if (bVar != null) {
                            ...
                            bVar = new a6.b("Exception in completion handler " + k1Var + " for " + this, th4);
                        }
                    }
                }
            }
