...
public final class g extends b {
    ...
    public final void b(ByteBuffer byteBuffer) {
        ...
        int i10 = this.c + 4 + (this.e == 1 ? 2 : 0) + (this.f == 1 ? this.i + 1 : 0) + (this.g == 1 ? 2 : 0);
    ...
    public final int hashCode() {
        int i9 = ((((((((((this.d * 31) + this.e) * 31) + this.f) * 31) + this.g) * 31) + this.h) * 31) + this.i) * 31;
        String str = this.j;
        int hashCode = (((((i9 + (str != null ? str.hashCode() : 0)) * 961) + this.k) * 31) + this.l) * 31;
        d dVar = this.m;
        int hashCode2 = (hashCode + (dVar != null ? dVar.hashCode() : 0)) * 31;
        m mVar = this.n;
        int i10 = (hashCode2 + (mVar != null ? mVar.d : 0)) * 31;
