...
public class v1 implements g1, r, z1 {
    ...
    public static q D(md.k kVar) {
        while (kVar.h()) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = md.k.b;
            md.k d = kVar.d();
            if (d == null) {
    ...
    public final void E(w1 w1Var, Throwable th) {
        ...
        for (md.k kVar = (md.k) f10; !kVar.equals(w1Var); kVar = kVar.g()) {
            if (kVar instanceof i1) {
                ...
                try {
                    ...
                    if (jVar != null) {
                        ...
                        jVar = new androidx.car.app.j("Exception in completion handler " + l1Var + " for " + this, th2);
                    }
                }
            }
        }
    ...
    public final void H(l1 l1Var) {
        ...
        w1 w1Var = new w1();
        l1Var.getClass();
        md.k.b.set(w1Var, l1Var);
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = md.k.a;
    ...
    public final void m(b1 b1Var, Object obj) {
        ...
        if (b1Var instanceof l1) {
            try {
                ...
                w(new androidx.car.app.j("Exception in completion handler " + b1Var + " for " + this, th2));
                return;
            }
        }
        w1 c10 = b1Var.c();
        if (c10 != null) {
            Object f10 = c10.f();
            kotlin.jvm.internal.i.c(f10, "null cannot be cast to non-null type kotlinx.coroutines.internal.LockFreeLinkedListNode{ kotlinx.coroutines.internal.LockFreeLinkedListKt.Node }");
            for (md.k kVar = (md.k) f10; !kVar.equals(c10); kVar = kVar.g()) {
                if (kVar instanceof l1) {
                    ...
                    try {
                        ...
                        if (jVar != null) {
                            ...
                            jVar = new androidx.car.app.j("Exception in completion handler " + l1Var + " for " + this, th3);
                        }
                    }
                }
            }
