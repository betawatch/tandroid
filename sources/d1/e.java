...
public final class e extends b1.d {
        ...
        try {
            ...
            try {
                ...
                if (s0Var != null && s0Var.u().length > 0) {
                    jSONObject2.put("rawId", f6.b.c(s0Var.u()));
                }
                String str = uVar.n;
                if (str != null) {
    ...
    public final v d(v0.e request) {
        ...
        j.b(optString5);
        n6.e a3 = n6.e.a(optString5.length() != 0 ? optString5 : "none");
        ...
        if (jSONObject.has("authenticatorSelection")) {
            ...
            j.b(optString7);
            n6.c a11 = optString7.length() > 0 ? n6.c.a(optString7) : null;
            fVar = null;
        ...
        if (jSONObject.has("extensions")) {
            ...
            j.b(optString8);
            fVar2 = new n6.f(optString8.length() > 0 ? new s(optString8) : fVar, null, jSONObject7.optBoolean("uvm", false) ? new i0(true) : fVar, null, null, null, null, null, jSONObject7.optBoolean("thirdPartyPayment", false) ? new t(true) : fVar, null, null, null);
        } else {
            fVar2 = fVar;
        }
