...
public final class e {
    public static final za.a b;
    public static Boolean d = null;
    public static String e = null;
    public static boolean f = false;
    public static int g = -1;
    public static Boolean h;
    public static final ya.b k;
    public static j l;
    public static k m;
    public final Context a;
    public static final ThreadLocal i = new ThreadLocal();
    public static final ad.b j = new ad.b(2);
    public static final u c = new u(10);
    ...
    public static e c(Context context, d dVar, String str) {
        ...
        try {
            ...
            a8.b K = dVar.K(context, str, k);
            j10 = longValue;
            try {
                Log.i("DynamiteModule", "Considering local module " + str + ":" + K.a + " and remote module " + str + ":" + K.b);
                int i9 = K.c;
                if (i9 != 0) {
                    if (i9 == -1) {
                        if (K.a != 0) {
                    ...
                    if (i9 != 1 || K.b != 0) {
                        if (i9 == -1) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (bool.booleanValue()) {
                                        ...
                                        if (z10) {
                                            ...
                                            U02 = kVar.V0(new h6.b(applicationContext2), str, i10, new h6.b(cursor));
                                        } else {
                                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                                            U02 = kVar.U0(new h6.b(applicationContext2), str, i10, new h6.b(cursor));
                                        }
                                        ...
                                        if (readInt >= 3) {
                                            ...
                                            U0 = h10.V0(new h6.b(context), str, i10, new h6.b(iVar4.a));
                                        } else if (readInt == 2) {
                                            Log.w("DynamiteModule", "IDynamite loader version = 2");
                                            U0 = h10.W0(new h6.b(context), str, i10);
                                        } else {
                                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                                            U0 = h10.U0(new h6.b(context), str, i10);
                                        }
                                ...
                                int i11 = K.a;
                                if (i11 == 0 || dVar.K(context, str, new com.google.android.gms.internal.cast.a(i11)).c != -1) {
                ...
                throw new b("No acceptable module " + str + " found. Local version is " + K.a + " and remote version is " + K.b + ".");
            } catch (Throwable th2) {
                th = th2;
                if (j10 == 0) {
                    j.remove();
                ...
                try {
                    ...
                    try {
                        ...
                        if (readInt2 >= 3) {
                            ...
                            Cursor cursor3 = (Cursor) h6.b.K0(h10.X0(new h6.b(context), str, z10, ((Long) j.get()).longValue()));
                            if (cursor3 != null) {
                                try {
    ...
    */
    ...
    public static boolean g(Context context) {
        ...
        if (h == null) {
            ...
            if (u5.e.b.d(context, 10000000) == 0 && resolveContentProvider != null && "com.google.android.gms".equals(resolveContentProvider.packageName)) {
                z10 = true;
            }
