...
public final /* synthetic */ class b implements g, MessagesStorage.LongCallback, c2, MessagesController.ErrorDelegate, m {
    ...
    */
    public void b(Exception exc) {
        ...
        if (this.b) {
            ...
            new Thread(new af(5, cVar, countDownLatch)).start();
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (!TextUtils.isEmpty(trim2) && !TextUtils.isEmpty(AndroidUtilities.translitSafe(trim2.toString()))) {
                    ...
                    d2 d2Var2 = new d2(context2, 3, z13 ? null : new zh.b());
                    d2Var2.q(250L);
