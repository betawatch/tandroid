...
public final class e implements o {
    ...
    */
    ...
    /* JADX WARN: Type inference failed for: r27v6, types: [c3.b0, v3.g] */
                    ...
                    if (vVar4.c >= i12 + 4) {
                                ...
                                if (j17 <= 0) {
                                    ...
                                    while (true) {
                                        if (i21 < D) {
                                            ...
                                            zVar = zVar2;
                                            obj2 = new h(jArr, jArr2, j21, j15, j14, zVar.e);
                                        }
                                    }
                                }
                                pVar.q(zVar.b);
                                ...
                                for (o0 o0Var : p0Var.a) {
                                    if (o0Var instanceof m) {
                                        ...
                                        if (this.s) {
                                            ...
                                            aVar2 = new f(-9223372036854775807L);
                                            vVar = vVar2;
                                        }
                                        this.r = aVar2;
                                        this.h.X1(aVar2);
                        ...
                        if (i17 != 1483304551) {
                            ...
                            if (W2 != -9223372036854775807L) {
                                aVar = new i(position3, i28, W2, i30, z10, r36);
                                p0Var = this.l;
                ...
                if (((-128000) & j29) != (this.k & (-128000)) || c3.b.h(j29) == -1) {
                    ...
                    if (i10 == i11) {
                        ...
                        if (gVar2 instanceof b) {
                            if (gVar2.l() != ((this.n * j3) / zVar.c) + this.m) {
                                ((b) this.r).getClass();
                                throw th2;
                            }
                        }
