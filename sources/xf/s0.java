...
public final class s0 {
    ...
    public s0(int i9) {
        ...
        int i12 = 0;
        while (i12 < o) {
            i12 = j3.r0.e((int) sharedPreferences.getLong(j3.r0.l(i12, "color_"), ((Integer) m.get(i12)).intValue()), i12, 1, this.b);
        }
        while (true) {
            if (i11 >= m.a.size()) {
                ...
                hashMap.put(Integer.valueOf(i11), Integer.valueOf((int) sharedPreferences.getLong(j3.r0.l(i11, "brush_color_"), ((m) r1.get(i11)).c())));
                i11++;
            }
        }
    }
    ...
    public final int b(int i9) {
        ...
        int i11 = p;
        return i9 < i11 ? ((Integer) list.get(i9)).intValue() : ((Integer) m.get(i9 - i11)).intValue();
    }
    ...
    public final void g() {
        if (!this.d.isEmpty() || this.e) {
            ...
            if (!this.d.isEmpty()) {
                int i9 = 0;
                while (i9 < o) {
                    edit.putLong(j3.r0.l(i9, "color_"), ((Integer) (i9 < this.d.size() ? this.d : m).get(i9)).intValue());
                    i9++;
                }
    ...
    public final void h(int i9, boolean z10) {
        ...
        if (z10) {
            hashMap.put(Integer.valueOf(this.f), Integer.valueOf(i9));
            this.e = true;
        }
    }
    ...
    public final void i(int i9, boolean z10) {
        this.f = i9;
        if (z10) {
            this.a.edit().putInt("brush", i9).apply();
        }
        Integer num = (Integer) this.c.get(Integer.valueOf(i9));
        if (num != null) {
