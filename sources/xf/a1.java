    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                ll.t(this.b, new StringBuilder("eglGetDisplay failed "));
            }
            finish();
        } else {
                ...
                if (this.b.eglChooseConfig(this.c, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12326, 0, 12344}, eGLConfigArr, 1, iArr)) {
                    if (iArr[0] > 0) {
                        ...
                        if (eglCreateContext == null) {
                            if (BuildVars.LOGS_ENABLED) {
                                ll.t(this.b, new StringBuilder("eglCreateContext failed "));
                            }
                            finish();
                        } else {
                            if (baVar != null) {
                            ...
                            if (surfaceTexture != null) {
                                ...
                                if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                                    if (BuildVars.LOGS_ENABLED) {
                                        ll.t(this.b, new StringBuilder("createWindowSurface failed "));
                                    }
                                    finish();
                                    ...
                                    for (Map.Entry entry : e1.a.entrySet()) {
                                        ...
                                        if (b10.b == 0) {
                                            ...
                                            d5.p b11 = d1.b(35632, str2);
                                            int i11 = b11.a;
                                            if (b11.b == 0) {
                                                if (BuildVars.LOGS_ENABLED) {
                                                    FileLog.e("Fragment shader compilation failed");
                                                }
                                                d1.c(i10, i11, d1Var.a);
                                            } else {
                                                GLES20.glAttachShader(d1Var.a, i10);
                                                GLES20.glAttachShader(d1Var.a, i11);
                                                for (int i12 = 0; i12 < strArr.length; i12++) {
                                                    GLES20.glBindAttribLocation(d1Var.a, i12, strArr[i12]);
                                                }
                                                int i13 = d1Var.a;
                                    ...
                                    qu0 qu0Var = q0Var.g;
                                    if (c1Var.h.getWidth() != qu0Var.a || c1Var.h.getHeight() != qu0Var.b) {
                                        Bitmap createBitmap = Bitmap.createBitmap((int) qu0Var.a, (int) qu0Var.b, Bitmap.Config.ARGB_8888);
                                        new Canvas(createBitmap).drawBitmap(c1Var.h, (Rect) null, new RectF(0.0f, 0.0f, qu0Var.a, qu0Var.b), (Paint) null);
                                        c1Var.h = createBitmap;
                                        c1Var.r = true;
                                    }
                                    if (c1Var.n != null && (r5.getWidth() != qu0Var.a || c1Var.n.getHeight() != qu0Var.b)) {
                                        Bitmap createBitmap2 = Bitmap.createBitmap((int) qu0Var.a, (int) qu0Var.b, Bitmap.Config.ARGB_8888);
                                        new Canvas(createBitmap2).drawBitmap(c1Var.n, (Rect) null, new RectF(0.0f, 0.0f, qu0Var.a, qu0Var.b), (Paint) null);
                                    ...
                                    if (BuildVars.LOGS_ENABLED) {
                                        ll.t(this.b, new StringBuilder("eglMakeCurrent failed "));
                                    }
                                    finish();
                                }
                            } else {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        ll.t(this.b, new StringBuilder("eglChooseConfig failed "));
                    }
                    finish();
                }
            } else {
                if (BuildVars.LOGS_ENABLED) {
                    ll.t(this.b, new StringBuilder("eglInitialize failed "));
                }
                finish();
            }
        }
