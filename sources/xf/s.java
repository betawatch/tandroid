...
public final class s extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f11 = height;
        float a3 = g7.n.a(this.e * f11, dp2, f11 - dp2) + getPaddingTop();
        Rect rect = AndroidUtilities.rectTmp2;
        Drawable drawable = this.f;
        drawable.getPadding(rect);
        int i9 = (int) ((a2 - dp) - rect.left);
        int i10 = (int) ((a3 - dp) - rect.top);
        int i11 = rect.bottom;
        drawable.setBounds(i9, i10, (int) (a2 + dp + i11), (int) (a3 + dp + i11));
        drawable.draw(canvas);
        canvas.drawCircle(a2, a3, dp, paint);
        yf.i1.x1(a2, a3, strokeWidth, i0.a.k(this.n.f, 255), canvas);
    }

    @Override // android.view.View
    public final void onSizeChanged(int i9, int i10, int i11, int i12) {
        super.onSizeChanged(i9, i10, i11, i12);
        this.a.setShader(new LinearGradient(0.0f, getPaddingTop(), 0.0f, i10 - getPaddingBottom(), new int[]{-65536, -256, -16711936, -16711681, -16776961, -65281, -65536}, (float[]) null, Shader.TileMode.CLAMP));
        this.b.setShader(new LinearGradient(getPaddingLeft(), 0.0f, i9 - getPaddingRight(), 0.0f, new int[]{-1, 0, 0, -16777216}, new float[]{0.06f, 0.22f, 0.78f, 0.94f}, Shader.TileMode.MIRROR));
    }
