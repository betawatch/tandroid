...
public abstract class l {
    public static SpannableStringBuilder a(String str) {
        try {
            Spanned fromHtml = Build.VERSION.SDK_INT >= 24 ? Html.fromHtml("<inject>" + str + "</inject>", 63, null, new j(new qb.b(26))) : Html.fromHtml("<inject>" + str + "</inject>", null, new j(new qb.b(26)));
            if (fromHtml == null) {
                return null;
            }
