            ...
            if (optJSONObject != null) {
                ...
                if (matcher.matches()) {
                    if (!TextUtils.isEmpty(matcher.group(1))) {
                        aVar2.g = i5.s("statisticChartLine_" + matcher.group(1).toLowerCase());
                    }
    ...
    public void e() {
        ...
        if (length == 1) {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                this.b[i10] = (this.a[i10] - j10) / (j11 - j10);
            }
        }
        ...
        while (true) {
            ...
            if (i12 >= strArr.length) {
                ...
                if (this.k == 1) {
                    ...
                    strArr[i12] = simpleDateFormat.format(new Date((i12 * this.k) + j10));
                }
                i12++;
            }
        }
