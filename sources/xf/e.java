...
public final class e {
    ...
    public e(File file, c cVar, n1 n1Var, int i10, int i11, boolean z10, int i12) {
        ...
        File file3 = new File(file2, a4.a.s(sb2, i12 != 0 ? hc.b.j(i12, "_fitz") : "", ".pcache2"));
        this.m = file3;
    ...
    /* JADX WARN: Type inference failed for: r0v16, types: [android.graphics.drawable.BitmapDrawable, xf.c] */
    /* JADX WARN: Type inference failed for: r0v23, types: [android.graphics.drawable.BitmapDrawable, xf.c] */
    /* JADX WARN: Type inference failed for: r0v29, types: [android.graphics.drawable.BitmapDrawable, xf.c] */
    /* JADX WARN: Type inference failed for: r0v3, types: [android.graphics.drawable.BitmapDrawable, xf.c] */
    /* JADX WARN: Type inference failed for: r2v0, types: [android.graphics.drawable.BitmapDrawable, xf.c] */
    /*
    ...
    public final void b() {
        ...
        while (true) {
            ...
            if (this.a.a(bitmapArr[i11]) == 1) {
                ...
                Collections.sort(arrayList2, Comparator$-CC.comparingInt(new j6(10)));
                a0VarArr2[0].b();
                ...
                z.execute(new yf(this, atomicBoolean2, bitmapArr, i11, a0VarArr2, i12, randomAccessFile22, arrayList2, countDownLatchArr));
                i11++;
                i12++;
                if (i11 >= y) {
                    i11 = 0;
