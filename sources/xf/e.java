...
public class e extends FrameLayout {
    ...
    public void b() {
        ...
        this.F = j6.i0(dp, dp, dp, dp, j6.v0(j6.h5, f6Var), j6.v0(j6.i6, f6Var), -16777216);
        mq mqVar = new mq(this.E, this.F, AndroidUtilities.dp(3.0f), AndroidUtilities.dp(3.0f));
        mqVar.w = true;
        setBackground(mqVar);
    }
    ...
    */
            ...
            if (z12) {
                ...
                if (i11 == i17) {
                    if (i21 == 0) {
                        ...
                        charSequence = me.f0("TON " + this.I.format(j12 / 1.0E9d), t5Var.getPaint(), 0.82f, 0.0f, false);
                    } else {
                    ...
                    f6 f6Var = this.G;
                    if (i13 >= 0 || !j6.c1(i13)) {
                        t5Var.setTextColor(!j6.A0().q() ? aVar.i : aVar.h);
                    } else {
                        t5Var.setTextColor(j6.v0(aVar.g, f6Var));
                    }
                    int i25 = j6.j5;
                    ...
                    charSequence = ja.X0(false, k0.l(j12, ' ', new StringBuilder("XTR ")), 0.7f, null);
                } else {
                    charSequence = "≈" + BillingController.getInstance().formatCurrency((long) (j12 / f10), "USD");
                }
                i12 = 1;
    ...
    public final void d(boolean z4, boolean z10) {
        sl0 sl0Var = this.H;
        if (z4) {
            AndroidUtilities.runOnUIThread(sl0Var, 300L);
            return;
        }
