    ...
    */
    public final void c(int i10, long j10, ArrayList arrayList, boolean z4, int i11, float f10) {
        ...
        while (i20 < length) {
            ...
            wf.a aVar = fVar.a;
            if (z12) {
                LinearLayout linearLayout = (LinearLayout) rVar.e;
                t5 t5Var = (t5) rVar.b;
                TextView textView2 = (TextView) rVar.d;
                TextView textView3 = (TextView) rVar.c;
                ...
                if (i11 == i17) {
                    ...
                    charSequence = ja.X0(false, a2.l(j12, ' ', new StringBuilder("XTR ")), 0.7f, null);
                } else {
                    charSequence = "≈" + BillingController.getInstance().formatCurrency((long) (j12 / f10), "USD");
                }
                i12 = 1;
                ...
                ((LinearLayout) rVar.e).setVisibility(8);
                i14 = i20;
            }
            i20 = i14 + 1;
            i16 = 2;
