...
public class c1 extends TextureView {
    ...
    public final void d(Canvas canvas) {
        ...
        if (this.x instanceof l) {
            ...
            if (f1Var != null && f1Var.h != 0.0f) {
                canvas.save();
                canvas.rotate((float) (((-r1.h) / 3.141592653589793d) * 180.0d), (p1Var.h.b / qu0Var.a) * canvas.getWidth(), (p1Var.h.c / qu0Var.b) * canvas.getHeight());
            }
            f1 f1Var2 = p1Var.h;
            if (f1Var2 == null || f1Var2.a.o() != 4) {
                ...
                canvas2 = canvas;
                canvas2.drawLine(canvas.getWidth() * (p1Var.h.b / qu0Var.a), canvas.getHeight() * (p1Var.h.c / qu0Var.b), canvas.getWidth() * (p1Var.h.i / qu0Var.a), canvas.getHeight() * (p1Var.h.j / qu0Var.b), paint);
                canvas2.drawLine(canvas2.getWidth() * (p1Var.h.d / qu0Var.a), canvas2.getHeight() * (p1Var.h.e / qu0Var.b), canvas2.getWidth() * (p1Var.h.i / qu0Var.a), canvas2.getHeight() * (p1Var.h.j / qu0Var.b), paint);
            }
    ...
    */
    public final void e(MotionEvent motionEvent) {
        ...
        if (this.x instanceof l) {
            ...
            if (actionMasked != 0) {
                ...
                if (o1Var2 == null) {
                    ...
                    if (l1Var != null) {
                        if (l1Var.b) {
                            p1Var.c(f15, f16, false);
                        }
                        float f17 = fArr[0] + p1Var.i;
                        l1 l1Var2 = p1Var.l;
                        float f18 = f17 - l1Var2.d;
                        float f19 = (fArr[1] + p1Var.j) - l1Var2.e;
                        for (int i11 = 0; i11 < arrayList.size(); i11++) {
                            o1 o1Var3 = (o1) arrayList.get(i11);
                            o1Var3.b(o1Var3.d + f18, o1Var3.e + f19);
                        }
                    }
                } else {
                    if (o1Var2.b) {
            ...
            while (i12 < arrayList2.size()) {
                o1 o1Var4 = (o1) arrayList2.get(i12);
                if (o1Var4.c) {
                    fArr[r92] = f15;
                    fArr[c10] = f16;
                    if (o1Var4.b) {
                    ...
                    double a2 = g7.w.a(o1Var4.d, o1Var4.e, fArr[r92], fArr[1]);
            ...
            if (o1Var == null) {
                ...
                if (f1Var != null) {
                    if (f1Var.a.o() == 0 || p1Var.h.a.o() == 2) {
                        f12 = f16;
                        f13 = f15;
                        double sqrt2 = Math.sqrt(Math.pow(f12 - p1Var.h.c, 2.0d) + Math.pow(f13 - p1Var.h.b, 2.0d));
                        f1 f1Var2 = p1Var.h;
                    } else if (p1Var.h.a.o() == 1 || p1Var.h.a.o() == 3) {
                        f1 f1Var3 = p1Var.h;
                        float f20 = f1Var3.b;
                        float f21 = f1Var3.d;
                        float f22 = f1Var3.f / 2.0f;
                        ...
                        if (f16 > f26 && f16 < f28) {
                            ...
                            double d11 = f15 - f27;
                            double d12 = f16 - f28;
                            sqrt = (float) Math.sqrt(Math.min(Math.min(Math.pow(d10, 2.0d) + Math.pow(d9, 2.0d), Math.pow(d10, 2.0d) + Math.pow(d11, 2.0d)), Math.min(Math.pow(d12, 2.0d) + Math.pow(d9, 2.0d), Math.pow(d12, 2.0d) + Math.pow(d11, 2.0d))));
                            if (p1Var.h.a.o() == 3) {
                                f1 f1Var4 = p1Var.h;
                                float a3 = p1.a(f15, f16, f1Var4.b, f1Var4.c, f1Var4.i, f1Var4.j);
                                f13 = f15;
                                f12 = f16;
                        ...
                        qu0 qu0Var = c1Var.getPainting().g;
                        f1 f1Var5 = p1Var.h;
                        float a10 = p1.a(f15, f16, f1Var5.b, f1Var5.c, f1Var5.i, f1Var5.j);
                        f1 f1Var6 = p1Var.h;
                        if (Math.min(a10, p1.a(f15, f16, f1Var6.d, f1Var6.e, f1Var6.i, f1Var6.j)) - (p1Var.h.f / 2.0f) < Math.min(qu0Var.a, qu0Var.b) * 0.1f) {
                            f13 = f15;
                            f12 = f16;
                        }
                    }
        ...
        d0Var.w = g7.n.a(d0Var.w - (currentTimeMillis / 125.0f), 0.6f, 1.0f);
        ...
        if (motionEvent.getToolType(motionEvent.getActionIndex()) == 2) {
            ...
            if ((motionEvent.getButtonState() & 32) == 32) {
                ...
                if (d0Var.a.getCurrentBrush() != null) {
                    f29 = (AndroidUtilities.lerp(d0Var.a.getCurrentBrush().j(), 1.0f, g7.n.a(d0Var.o / 16.0f, 0.0f, 1.0f)) * (f29 - 1.0f)) + 1.0f;
                }
                float[] fArr3 = d0Var.u;
                double d13 = fArr3[0];
                double d14 = fArr3[1];
                double d15 = f29;
                u0 u0Var = new u0(d13, d14, d15);
                if (actionMasked2 != 0) {
                    if (actionMasked2 == 1) {
                        if (d0Var.z) {
                            d0Var.z = false;
                        ...
                        if (painting.d == null || !painting.H || painting.q == 0) {
                            if (!d0Var.e) {
                                ...
                                if (d0Var.a.getCurrentBrush() instanceof a) {
                                    ...
                                    u0 u0Var3 = d0Var.h;
                                    double d16 = u0Var3 == null ? d15 : u0Var3.c;
                                    final float currentWeight = d0Var.a.getCurrentWeight() * ((float) d16) * 12.0f;
                                    ...
                                    ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: xf.y
                                        ...
                                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                            ...
                                            double d18 = f30;
                                            double cos = Math.cos(d18 - 2.5918139392115793d);
                                            double sin = Math.sin(d18 - 2.748893571891069d);
                                            u0 u0Var4 = u0Var2;
                                            double d19 = u0Var4.a;
                                            double d20 = currentWeight;
                                            double d21 = cos * d20;
                                            float[] fArr5 = fArr4;
                                            double d22 = fArr5[0];
                                            double d23 = (d21 * d22) + d19;
                                            double d24 = u0Var4.b;
                                            double d25 = sin * d20;
                                            double d26 = (d22 * d25) + d24;
                                            double d27 = d17;
                                            double d28 = floatValue;
                                            d0Var2.b(new r0(new u0[]{new u0(d23, d26, d27), new u0((d21 * d28) + d19, (d25 * d28) + d24, d27, 0)}));
                                            double cos2 = Math.cos(d18 + 2.5918139392115793d);
                                            double sin2 = Math.sin(d18 + 2.748893571891069d);
                                            double d29 = u0Var4.a;
                                            double d30 = cos2 * d20;
                                            double d31 = fArr5[0];
                                            double d32 = sin2 * d20;
                                            d0Var2.b(new r0(new u0[]{new u0((d30 * d31) + d29, (d31 * d32) + d24, d27), new u0((d30 * d28) + d29, (d32 * d28) + d24, d27, 0)}));
                                            boolean[] zArr2 = zArr;
                                    ...
                                    d0Var.r.addListener(new te1(d0Var, 9));
                                    d0Var.r.setDuration(240L);
                                    d0Var.r.setInterpolator(gr.h);
                                    d0Var.r.start();
                                }
                            }
                            r72 = 0;
                        ...
                        painting.L = ofFloat2;
                        int i13 = 1;
                        ofFloat2.addUpdateListener(new k0(painting, i13));
                        painting.L.addListener(new p0(painting, i13));
                        painting.L.setInterpolator(gr.h);
                        ...
                        if (painting2.L != null) {
                            ...
                            i10 = 1;
                            painting2.f.f(new l0(painting2, objArr2 == true ? 1 : 0, i10));
                        }
                        AndroidUtilities.cancelRunOnUIThread(d0Var.y);
                        q0 painting3 = d0Var.a.getPainting();
                        painting3.f.f(new m0(painting3, i10));
                        d0Var.n = 0;
                        d0Var.o = 0;
                        d0Var.j = false;
                        d0Var.b = false;
                                ...
                                if (!k1Var.j.get()) {
                                    ...
                                    if (!atomicBoolean.get()) {
                                        ...
                                        if (i9 != 3) {
                                            ...
                                            float atan2 = (float) Math.atan2(d18 - u0Var5.b, u0Var4.a - u0Var5.a);
                                            if (d0Var.j) {
                                                float a12 = g7.n.a(f10 / (AndroidUtilities.dp(16.0f) / scaleX), 0.0f, 1.0f);
                                                if (a12 > 0.4f) {
                                                    double d19 = 1.0f - a12;
                                                    double d20 = d0Var.k;
                                                    double d21 = a12;
                                                    double d22 = atan2;
                                                    f11 = scaleX;
                                                    d0Var.k = (float) Math.atan2((Math.sin(d22) * d21) + (Math.sin(d20) * d19), j3.r0.b(d22, d21, Math.cos(d20) * d19));
                                        ...
                                        d0Var.w = g7.n.a((currentTimeMillis / 75.0f) + d0Var.w, 0.6f, 1.0f);
                                        return;
                                    }
                                }
                            }
        ...
        double d132 = fArr32[0];
        double d142 = fArr32[1];
        double d152 = f29;
        u0 u0Var6 = new u0(d132, d142, d152);
        if (actionMasked2 != 0) {
        }
        if (d0Var.z) {
        }
    ...
    public final void i() {
        ...
        qu0 qu0Var = getPainting().g;
        matrix.preTranslate(getWidth() / 2.0f, getHeight() / 2.0f);
        matrix.preScale(f10, -f10);
        matrix.preTranslate((-qu0Var.a) / 2.0f, (-qu0Var.b) / 2.0f);
        if (this.x instanceof l) {
            p1 p1Var = this.f;
            p1Var.getClass();
        ...
        a1 a1Var = this.d;
        q0Var.y = h8.c(h8.b(a1Var.n, a1Var.r), h8.a(matrix));
    }
