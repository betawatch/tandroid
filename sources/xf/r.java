...
public final class r extends View {
    ...
    public final void b(float f10) {
        ...
        float a2 = g7.n.a(((f10 - dp) + (AndroidUtilities.dp(13.0f) - (this.b.getStrokeWidth() / 2.0f))) / (getWidth() - (dp * 2.0f)), 0.0f, 1.0f);
        int i9 = this.c;
        x xVar = this.e;
        xVar.m(i0.a.k(i9 != 1 ? i9 != 2 ? Color.argb(255, (int) (a2 * 255.0f), Color.green(xVar.f), Color.blue(xVar.f)) : Color.argb(255, Color.red(xVar.f), Color.green(xVar.f), (int) (a2 * 255.0f)) : Color.argb(255, Color.red(xVar.f), (int) (a2 * 255.0f), Color.blue(xVar.f)), Color.alpha(xVar.f)), 4);
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i9 = this.c;
        x xVar = this.e;
        float red = (i9 != 1 ? i9 != 2 ? Color.red(xVar.f) : Color.blue(xVar.f) : Color.green(xVar.f)) / 255.0f;
