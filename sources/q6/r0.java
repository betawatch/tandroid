        ...
        switch (this.a) {
            ...
            case 3:
                ...
                while (parcel.dataPosition() < z11) {
                    ...
                    if (c11 == 2) {
                        bArr = f5.b(parcel, readInt3);
                    } else if (c11 == 3) {
                        str5 = f5.h(parcel, readInt3);
                    } else if (c11 == 4) {
                        str6 = f5.h(parcel, readInt3);
                    } else if (c11 != 5) {
                        f5.y(parcel, readInt3);
                    } else {
                        str7 = f5.h(parcel, readInt3);
                    }
                }
                f5.m(parcel, z11);
            ...
            case 7:
                ...
                while (parcel.dataPosition() < z13) {
                    ...
                    if (c12 == 2) {
                        str9 = f5.h(parcel, readInt5);
                    } else if (c12 != 3) {
                        f5.y(parcel, readInt5);
                    } else {
                        str10 = f5.h(parcel, readInt5);
                    }
                }
                f5.m(parcel, z13);
            ...
            case 11:
                ...
                while (parcel.dataPosition() < z16) {
                    ...
                    if (((char) readInt7) != 1) {
                        ...
                        arrayList = f5.l(parcel, readInt7, l0.CREATOR);
                    }
                }
                f5.m(parcel, z16);
            ...
            case 12:
                ...
                while (parcel.dataPosition() < z17) {
                    ...
                    if (c13 == 1) {
                        i10 = f5.u(parcel, readInt8);
                    } else if (c13 == 2) {
                        f5.B(parcel, readInt8, 4);
            ...
            case 13:
                ...
                while (parcel.dataPosition() < z18) {
                    ...
                    if (c14 == 1) {
                        k0Var = (k0) f5.g(parcel, readInt9, k0.CREATOR);
                    } else if (c14 == 2) {
                        u0Var = (u0) f5.g(parcel, readInt9, u0.CREATOR);
                    } else if (c14 == 3) {
                        hVar = (h) f5.g(parcel, readInt9, h.CREATOR);
                    } else if (c14 == 4) {
                        v0Var = (v0) f5.g(parcel, readInt9, v0.CREATOR);
                    } else if (c14 != 5) {
                        f5.y(parcel, readInt9);
                    } else {
                        str11 = f5.h(parcel, readInt9);
                    }
                }
                f5.m(parcel, z18);
            ...
            case 14:
                ...
                while (parcel.dataPosition() < z19) {
                    ...
                    switch ((char) readInt10) {
                        case 2:
                            sVar = (s) f5.g(parcel, readInt10, s.CREATOR);
                            break;
                        case 3:
                            x0Var = (x0) f5.g(parcel, readInt10, x0.CREATOR);
                            break;
                        case 4:
                            i0Var = (i0) f5.g(parcel, readInt10, i0.CREATOR);
                            break;
                        case 5:
                            z0Var = (z0) f5.g(parcel, readInt10, z0.CREATOR);
                            break;
                        case 6:
                            m0Var = (m0) f5.g(parcel, readInt10, m0.CREATOR);
                            break;
                        case 7:
                            n0Var = (n0) f5.g(parcel, readInt10, n0.CREATOR);
                            break;
                        case '\b':
                            y0Var = (y0) f5.g(parcel, readInt10, y0.CREATOR);
                            break;
                        case '\t':
                            o0Var = (o0) f5.g(parcel, readInt10, o0.CREATOR);
                            break;
                        case '\n':
                            tVar = (t) f5.g(parcel, readInt10, t.CREATOR);
                            break;
                        case 11:
                            q0Var = (q0) f5.g(parcel, readInt10, q0.CREATOR);
                            break;
                        case '\f':
                            s0Var = (s0) f5.g(parcel, readInt10, s0.CREATOR);
                            break;
                        case '\r':
                            p0Var = (p0) f5.g(parcel, readInt10, p0.CREATOR);
                            break;
                        default:
            ...
            case 16:
                ...
                while (parcel.dataPosition() < z22) {
                    ...
                    if (c15 == 1) {
                        bArr2 = f5.b(parcel, readInt12);
                    } else if (c15 != 2) {
                        f5.y(parcel, readInt12);
                    } else {
                        bArr3 = f5.b(parcel, readInt12);
                    }
                }
                f5.m(parcel, z22);
            ...
            case 17:
                ...
                while (parcel.dataPosition() < z23) {
                    ...
                    if (c16 == 1) {
                        z24 = f5.n(parcel, readInt13);
                    } else if (c16 != 2) {
                        f5.y(parcel, readInt13);
                    } else {
                        bArr4 = f5.b(parcel, readInt13);
                    }
                }
                f5.m(parcel, z23);
            ...
            case 18:
                ...
                while (parcel.dataPosition() < z25) {
                    ...
                    if (c17 == 2) {
                        bArr5 = f5.b(parcel, readInt14);
                    } else if (c17 == 3) {
                        bArr6 = f5.b(parcel, readInt14);
                    } else if (c17 == 4) {
                        bArr7 = f5.b(parcel, readInt14);
                    } else if (c17 == 5) {
                        bArr8 = f5.b(parcel, readInt14);
                    } else if (c17 != 6) {
                        f5.y(parcel, readInt14);
                    } else {
                        bArr9 = f5.b(parcel, readInt14);
                    }
                }
                f5.m(parcel, z25);
            ...
            case 19:
                ...
                while (parcel.dataPosition() < z26) {
                    ...
                    if (c18 == 2) {
                        bArr10 = f5.b(parcel, readInt15);
                    } else if (c18 == 3) {
                        bArr11 = f5.b(parcel, readInt15);
                    } else if (c18 == 4) {
                        bArr12 = f5.b(parcel, readInt15);
                    } else if (c18 != 5) {
                        f5.y(parcel, readInt15);
                    } else {
                        strArr = f5.i(parcel, readInt15);
                    }
                }
                f5.m(parcel, z26);
            ...
            case 20:
                ...
                while (parcel.dataPosition() < z27) {
                    ...
                    if (c19 == 2) {
                        i11 = f5.u(parcel, readInt16);
                    } else if (c19 == 3) {
                        str12 = f5.h(parcel, readInt16);
                    } else if (c19 != 4) {
                        f5.y(parcel, readInt16);
                    } else {
                        i12 = f5.u(parcel, readInt16);
                    }
                }
                f5.m(parcel, z27);
            ...
            case 21:
                ...
                while (parcel.dataPosition() < z28) {
                    ...
                    if (c20 == 2) {
                        str13 = f5.h(parcel, readInt17);
                    } else if (c20 == 3) {
                        bool = f5.o(parcel, readInt17);
                    } else if (c20 == 4) {
                        str14 = f5.h(parcel, readInt17);
                    } else if (c20 != 5) {
                        f5.y(parcel, readInt17);
                    } else {
                        str15 = f5.h(parcel, readInt17);
                    }
                }
                f5.m(parcel, z28);
            ...
            case 23:
                ...
                while (parcel.dataPosition() < z29) {
                    ...
                    if (c21 == 1) {
                        j10 = f5.w(parcel, readInt18);
                    } else if (c21 == 2) {
                        bArr13 = f5.b(parcel, readInt18);
                    } else if (c21 == 3) {
                        bArr14 = f5.b(parcel, readInt18);
                    } else if (c21 != 4) {
                        f5.y(parcel, readInt18);
                    } else {
                        bArr15 = f5.b(parcel, readInt18);
                    }
                }
                f5.m(parcel, z29);
            ...
            case 24:
                ...
                while (parcel.dataPosition() < z30) {
                    ...
                    if (((char) readInt19) != 1) {
                        ...
                        arrayList2 = f5.l(parcel, readInt19, w0.CREATOR);
                    }
                }
                f5.m(parcel, z30);
