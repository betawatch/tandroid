...
public final class e implements cf.c, cf.b {
    ...
    public final void g() {
        ...
        final int i10 = 0;
        this.d = new g(measuredWidth, measuredHeight, new Utilities.Callback() { // from class: df.d
        ...
        final int i11 = 1;
        this.e = new g(measuredWidth, measuredHeight, new Utilities.Callback() { // from class: df.d
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                switch (i11) {
                    case 0:
        ...
        bf.g gVar = new bf.g((LaunchActivity) fVar.a.d, this);
        this.f = gVar;
        gVar.addView(this.g);
