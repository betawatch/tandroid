...
public final class a extends LinearLayout {
    public a(Context context) {
        ...
        int i10 = i6.G6;
        g10.setTextColor(i6.w0(null, i10, false));
        ...
        org.telegram.messenger.y0.m(R.string.AboutPremiumDescription, textView);
        addView(textView, x5.p(-1, -2, 0.0f, 0, 0, 0, 0, 0));
        TextView textView2 = new TextView(context);
        textView2.setTextSize(1, 14.0f);
        textView2.setTextColor(i6.w0(null, i10, false));
        org.telegram.messenger.y0.m(R.string.AboutPremiumDescription2, textView2);
