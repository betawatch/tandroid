...
public final /* synthetic */ class u implements Runnable {
    ...
    public /* synthetic */ u(o0 o0Var, k kVar, int i10) {
        this.a = i10;
        this.b = o0Var;
        this.c = kVar;
    }
    ...
    public final void run() {
        switch (this.a) {
            ...
            default:
                ...
                final int i11 = 0;
                final k kVar = this.c;
                textView.setOnClickListener(new View.OnClickListener() { // from class: rg.q
                ...
                if (kVar instanceof q2) {
                    ...
                    final int i12 = 1;
                    textView3.setOnClickListener(new View.OnClickListener() { // from class: rg.q
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            switch (i12) {
                                case 0:
