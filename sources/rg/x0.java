...
public final class x0 extends g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.N = w7Var;
        w7Var.setBackgroundColor(getThemedColor(j6.h5));
        ...
        this.N.setActionBarMenuOnItemClick(new x81(this, 10));
    ...
    public final ViewGroup z(Context context, int i10) {
        ...
        return new z1(context, this.x, this.currentAccount, mx0Var.a, this.resourcesProvider);
    }
    ...
    */
    public x0(o2 o2Var, Context context, int i10, boolean z10, int i11, boolean z11, nx0 nx0Var) {
        this(o2Var, context, i10, z10, i11, z11, nx0Var, r0);
        f6 f6Var;
        if (o2Var == null) {
            f6Var = null;
        } else if (o2Var.getLastStoryViewer() != null && !o2Var.getLastStoryViewer().H0) {
            f6Var = o2Var.getLastStoryViewer().y;
        } else {
            f6Var = o2Var.getResourceProvider();
        }
    }

    public x0(o2 o2Var, Context context, int i10, boolean z10, int i11, boolean z11, nx0 nx0Var, f6 f6Var) {
        ...
        u0Var.setAdapter(new e80(this, 2));
        this.G = i12;
        ...
        this.c = p0Var;
        p0Var.r.setOnClickListener(new m5(this, o2Var, z11, mx0Var2, 5));
        final int i16 = 1;
