...
public final class m1 extends View {
    ...
    */
    public final void draw(Canvas canvas) {
        ...
        if (n1Var.s) {
            imageReceiver2.setImage(ImageLocation.getForDocument(n1Var.r), null, DocumentObject.getSvgThumb(n1Var.r, h6.a7, 0.5f), "webp", null, 1);
            if (MessageObject.isPremiumSticker(n1Var.r)) {
                ...
                if (!n1Var.e) {
                    ...
                    if (imageReceiver.getLottieAnimation() != null && imageReceiver.getLottieAnimation().A() && s0Var.n3) {
                        AndroidUtilities.cancelRunOnUIThread(s0Var.e3);
                        AndroidUtilities.runOnUIThread(s0Var.e3, 0L);
                    }
                ...
                if (z10) {
                    ...
                    if (f7 != 1.0f) {
                        ...
                        if (z11) {
                            float f10 = n1Var.h;
                            if (f10 != 1.0f) {
                                n1Var.h = f10 + 0.10666667f;
                                invalidate();
                                n1Var.h = Utilities.clamp(n1Var.h, 1.0f, 0.0f);
                                float f11 = s0Var.k3 * 0.45f;
                        ...
                        if (!z11) {
                            float f14 = n1Var.h;
                            if (f14 != 0.0f) {
                                n1Var.h = f14 - 0.10666667f;
                                invalidate();
                            }
                        }
                        n1Var.h = Utilities.clamp(n1Var.h, 1.0f, 0.0f);
                        float f112 = s0Var.k3 * 0.45f;
