        ...
        if (rectF.isEmpty() || !rectF.contains(this.h, this.i)) {
            ...
            if (v1Var.I) {
                ...
                if (j10 < 200) {
                    ...
                    f11 = this.o;
                    if (f11 >= 1.0f || xd.b != 1.0f) {
                        float interpolation = AndroidUtilities.overshootInterpolator.getInterpolation(f11) * xd.b;
            ...
            float interpolation2 = AndroidUtilities.overshootInterpolator.getInterpolation(f11) * xd.b;
