            ...
            if (i12 >= 0) {
                ...
                for (int i13 = 0; i13 < document.thumbs.size(); i13++) {
                    if (document.thumbs.get(i13) instanceof TLRPC.TL_photoStrippedSize) {
                        ...
                        y1Var = new y1(this, this.K, this.L);
                        y1Var.w = true;
                    }
                }
                ...
                if (aVar3 != null) {
                    ...
                    if (width == 0 || height == 0) {
                        ...
                        for (int i16 = 0; i16 <= width; i16++) {
                            ...
                            k0 k0Var = new k0();
                            k0Var.a = q3.c(Utilities.fastRandom, height);
                        ...
                        while (i18 <= width) {
                            ...
                            while (i19 <= height) {
                                ...
                                h1Var2.getClass();
                                h1Var2.a = q3.c(Utilities.fastRandom, i17);
                                h1Var2.b = q3.c(Utilities.fastRandom, i17);
                                h1Var2.c = q3.c(Utilities.fastRandom, 300) + currentTimeMillis + 150;
                                i19++;
                                i17 = 16;
                            }
                            i18++;
                            ...
                            while (i21 < arrayList2.size()) {
                                ...
                                while (max < min) {
                                    ...
                                    if (((RectF) aVar3.c).contains(f14, f15)) {
                                        ...
                                        i10 = i20;
                                        i11 = height;
                                        float clamp = Utilities.clamp(((f13 - ((k0Var2.a - max) / (k0Var2.b - 1))) * 0.8f) + f12, 1.0f, 0.0f);
                                        ...
                                        if (j3 < 150) {
                                            ...
                                            if (clamp2 >= 1.0f) {
                                                h1Var3.a = h1Var3.b;
                                                h1Var3.b = q3.c(Utilities.fastRandom, 16);
                                                h1Var3.c = q3.c(Utilities.fastRandom, 300) + currentTimeMillis + 150;
                                            }
                                        } else {
                                            i13 = width;
                                            ((Paint) aVar4.h).setAlpha((int) (clamp * 255.0f));
                                            canvas.drawBitmap(((Bitmap[]) aVar4.d)[h1Var3.a], f14, f15, (Paint) aVar4.h);
                                        }
                                        max = i12 + 1;
                                        i20 = i10;
                                        height = i11;
