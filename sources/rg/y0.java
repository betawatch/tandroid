...
public abstract class y0 extends FrameLayout {
    ...
    private iv0 getPaintingSize() {
        ...
        if (floor > f7) {
            iv0Var2.b = f7;
            iv0Var2.a = (float) Math.floor((f7 * r1) / r0);
        }
        this.x = iv0Var2;
        return iv0Var2;
    }
    ...
    public void setEraser(boolean z10) {
        ...
        this.y = z10;
        this.e.setBrush(z10 ? new qg.d() : new qg.f());
    }
}
