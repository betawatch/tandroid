...
public final class c1 extends f3 {
    public c1(n2 n2Var) {
        ...
        int i10 = i6.j5;
        org.telegram.messenger.y0.q(textView, i6.w0(null, i10, false), 1, 20.0f);
        ...
        org.telegram.messenger.y0.q(textView3, i6.w0(null, i6.Sh, false), 1, 14.0f);
        ...
        frameLayout.setBackgroundColor(getThemedColor(i6.h5));
        f7.addView(frameLayout, x5.q(-1, 68, 80));
        org.telegram.messenger.y0.m(R.string.SubscribeToPremiumOfficialAppNeeded, textView);
