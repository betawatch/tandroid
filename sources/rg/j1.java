...
public final class j1 extends ll0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i10 >= i11 && i10 < k1Var.k0) {
            ((nw0) view).a((dx0) k1Var.X.get(i10 - i11), i10 != k1Var.k0 - 1);
        } else {
            if (i10 < k1Var.h0 || i10 >= k1Var.i0) {
                return;
            }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            View view2 = k1Var.B0;
            if (view2 == null) {
                k1Var.r0 = new zf0(context, 1, 0, 2);
                Bitmap createBitmap = Bitmap.createBitmap(50, 50, Bitmap.Config.ARGB_8888);
                Canvas canvas = new Canvas(createBitmap);
                int i11 = h6.Mj;
                canvas.drawColor(i0.a.d(0.5f, k1Var.getThemedColor(i11), k1Var.getThemedColor(h6.h5)));
                k1Var.r0.setBackgroundBitmap(createBitmap);
                sg.a aVar = k1Var.r0.b;
                aVar.w = i11;
                aVar.x = h6.Lj;
                aVar.b();
                ub1Var.addView(k1Var.r0, x5.q(160, 160, 1));
            } else {
            ...
            if (k1Var.N0 == null) {
                ...
                while (i12 < 2) {
                    ...
                    d90VarArr[i12] = new xb(context, 4, d6Var2);
                    ...
                    k1Var.O0[i12].setTextColor(k1Var.getThemedColor(h6.G6));
                    k1Var.O0[i12].setLinkTextColor(k1Var.getThemedColor(h6.J6));
                    k1Var.N0.addView(k1Var.O0[i12], x5.c(-2.0f, -1));
                    i12++;
                }
            }
            ...
            view = f0Var;
            if (zf0Var != null) {
                zf0Var.setStarParticlesView(k1Var.q0);
                view = f0Var;
            }
        } else if (i10 == 2) {
            view = new a7(context, k1Var.getThemedColor(h6.a7), 0);
        } else if (i10 == 3) {
            ...
            view = new uw0(this, context, d6Var4);
        } else {
