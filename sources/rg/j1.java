...
public final class j1 extends kl0 {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            View view2 = k1Var.B0;
            if (view2 == null) {
                k1Var.r0 = new eg0(context, 1, 0, 2);
                Bitmap createBitmap = Bitmap.createBitmap(50, 50, Bitmap.Config.ARGB_8888);
                Canvas canvas = new Canvas(createBitmap);
                int i11 = i6.Mj;
                canvas.drawColor(i0.a.d(0.5f, k1Var.getThemedColor(i11), k1Var.getThemedColor(i6.h5)));
                k1Var.r0.setBackgroundBitmap(createBitmap);
                sg.a aVar = k1Var.r0.b;
                aVar.w = i11;
                aVar.x = i6.Lj;
                aVar.b();
                cc1Var.addView(k1Var.r0, x5.q(160, 160, 1));
            } else {
            ...
            if (k1Var.N0 == null) {
                ...
                new PorterDuffColorFilter(num == null ? k1Var.getThemedColor(i6.v6) : num.intValue(), PorterDuff.Mode.SRC_IN);
                k1Var.O0 = new c90[2];
                int i12 = 0;
                while (i12 < 2) {
                    c90[] c90VarArr = k1Var.O0;
                    e6Var2 = ((f3) k1Var).resourcesProvider;
                    c90VarArr[i12] = new vb(context, 4, e6Var2);
                    ...
                    k1Var.O0[i12].setTextColor(k1Var.getThemedColor(i6.G6));
                    k1Var.O0[i12].setLinkTextColor(k1Var.getThemedColor(i6.J6));
            ...
            view = f0Var;
            if (eg0Var != null) {
                eg0Var.setStarParticlesView(k1Var.q0);
                view = f0Var;
            }
        } else if (i10 == 2) {
            view = new a7(context, k1Var.getThemedColor(i6.a7), 0);
        } else if (i10 == 3) {
