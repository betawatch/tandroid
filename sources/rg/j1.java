...
public final class j1 extends vl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i10 >= i11 && i10 < k1Var.k0) {
            ((lw0) view).a((bx0) k1Var.X.get(i10 - i11), i10 != k1Var.k0 - 1);
        } else {
            if (i10 < k1Var.h0 || i10 >= k1Var.i0) {
                return;
            }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            View view2 = k1Var.B0;
            if (view2 == null) {
                k1Var.r0 = new yf0(context, 1, 0, 2);
                ...
                aVar.x = h6.Lj;
                aVar.b();
                ub1Var.addView(k1Var.r0, y5.q(160, 160, 1));
            } else {
            ...
            view = f0Var;
            if (yf0Var != null) {
                yf0Var.setStarParticlesView(k1Var.q0);
                view = f0Var;
            }
        } else if (i10 == 2) {
            view = new b7(context, k1Var.getThemedColor(h6.a7), 0);
        } else if (i10 == 3) {
            ...
            view = new sw0(this, context, d6Var4);
        } else {
