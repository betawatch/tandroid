    ...
    */
    ...
    public final void d(int i10, final String str) {
        ...
        if (isEmpty) {
            ...
            final int i11 = 0;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) { // from class: rg.t0
                ...
                public final void run(Object obj) {
                    switch (i11) {
                        case 0:
                            ...
                            u0Var.v = b10;
                            u0Var.r.setImage(ImageLocation.getForDocument(b10), "80_80", u0.c(str2), null, null, 0);
                            u0Var.s.setImage(ImageLocation.getForDocument(u0Var.w), "80_80", ImageLocation.getForDocument(u0Var.v), "80_80", null, null, u0.c(str2), 0L, null, null, 0);
                            break;
                        default:
                            u0 u0Var2 = this.b;
                            u0Var2.getClass();
                            ...
                            u0Var2.w = b11;
                            if (b11 != null) {
                                u0Var2.s.setImage(ImageLocation.getForDocument(b11), "80_80", ImageLocation.getForDocument(u0Var2.v), "80_80", null, null, u0.c(str3), 0L, null, null, 0);
                                break;
                            }
                            break;
                    }
            ...
            final int i12 = 1;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName2, 0, false, new Utilities.Callback(this) { // from class: rg.t0
                public final /* synthetic */ u0 b;
