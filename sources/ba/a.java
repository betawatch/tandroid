...
public final class a {
    ...
    public void c() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ((za.c) this.f).j((f2.a) arrayList.get(i10));
        }
        m(arrayList);
        this.b = 0;
    }
    ...
    public void d() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (i11 == 1) {
                ...
                cVar.j(aVar);
                cVar.q(aVar.b, aVar.d, aVar.c);
            } else if (i11 == 8) {
                cVar.j(aVar);
                cVar.x(aVar.b, aVar.d);
            }
        }
        m(arrayList);
        this.b = 0;
        ...
        while (i41 < size2) {
            ...
            if (i42 == 1) {
                ...
                while (i47 < i48) {
                    ...
                    n1 L2 = recyclerView2.L(i47, true);
                    if (L2 != null) {
                    }
                    L2 = null;
                    if (L2 != null || b(i47)) {
    ...
    */
    public String n() {
        ...
        if (i) {
            ...
            if (o1Var == null) {
                try {
                    o1 o1Var2 = new o1(4, false);
                    o1Var2.b = new SoftReference(new String[3]);
                    this.f = o1Var2;
                } catch (Throwable unused) {
                    i = false;
                }
            } else {
                String[] strArr = (String[]) ((SoftReference) o1Var.b).get();
                if (strArr != null) {
                    str = strArr[0];
                    if (str == null) {
                        ...
                        if (bVar.b) {
                            ...
                            stringBuffer.append(be.b.a(cls.getName(), cls, bVar.a));
                        }
                        if (bVar.b) {
                            stringBuffer.append(" ");
                        }
                        ...
                        stringBuffer.append(be.b.a((String) this.d, cls2, bVar.d));
                        stringBuffer.append(".");
                        ...
                        if (bVar.b) {
                            ...
                            for (int i11 = 0; i11 < clsArr.length; i11++) {
                                ...
                                stringBuffer.append(be.b.a(cls3.getName(), cls3, bVar.a));
                            }
                            stringBuffer.append(")");
                    ...
                    if (i) {
                        o1 o1Var3 = (o1) this.f;
                        String[] strArr2 = (String[]) ((SoftReference) o1Var3.b).get();
                        if (strArr2 == null) {
                            strArr2 = new String[3];
                            o1Var3.b = new SoftReference(strArr2);
                        }
                        strArr2[0] = str;
                    }
                    return str;
