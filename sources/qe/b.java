    ...
    public b() {
        ...
        try {
            ...
            for (int i12 = 0; i12 < f9; i12++) {
                ...
                this.i.put(g11, g10);
                this.f.put(g10, Integer.valueOf(f10));
    ...
    public final a a(String str) {
        ...
        while (i14 < e12) {
            ...
            while (i15 < e13) {
                ...
                short e14 = bVar.e(i13 + 14);
                i13 += 16;
                String g12 = bVar.g(i12 + e11 + e14);
                cVar.e = g12;
                int indexOf = g12.indexOf("[[");
                if (indexOf != -1) {
                    cVar.e = u3.c.k(cVar.e.substring(0, indexOf), cVar.e.substring(cVar.e.indexOf("]]") + 2));
                }
                arrayList4.add(cVar);
                i15++;
                bVar = this;
