...
public class c1 extends TextureView {
    ...
    public final void d(Canvas canvas) {
        ...
        if (this.x instanceof l) {
            ...
            kv0 kv0Var = c1Var.getPainting().g;
            ...
            if (f1Var != null && f1Var.h != 0.0f) {
                canvas.save();
                canvas.rotate((float) (((-r1.h) / 3.141592653589793d) * 180.0d), (p1Var.h.b / kv0Var.a) * canvas.getWidth(), (p1Var.h.c / kv0Var.b) * canvas.getHeight());
            }
            f1 f1Var2 = p1Var.h;
            if (f1Var2 == null || f1Var2.a.o() != 4) {
                ...
                canvas2 = canvas;
                canvas2.drawLine(canvas.getWidth() * (p1Var.h.b / kv0Var.a), canvas.getHeight() * (p1Var.h.c / kv0Var.b), canvas.getWidth() * (p1Var.h.i / kv0Var.a), canvas.getHeight() * (p1Var.h.j / kv0Var.b), paint);
                canvas2.drawLine(canvas2.getWidth() * (p1Var.h.d / kv0Var.a), canvas2.getHeight() * (p1Var.h.e / kv0Var.b), canvas2.getWidth() * (p1Var.h.i / kv0Var.a), canvas2.getHeight() * (p1Var.h.j / kv0Var.b), paint);
            }
    ...
    */
            ...
            if (o1Var == null) {
                ...
                if (f1Var != null) {
                    if (f1Var.a.o() == 0 || p1Var.h.a.o() == 2) {
                        ...
                        f1 f1Var6 = p1Var.h;
                        if (Math.min(a11, p1.a(f14, f15, f1Var6.d, f1Var6.e, f1Var6.i, f1Var6.j)) - (p1Var.h.f / 2.0f) < Math.min(kv0Var.a, kv0Var.b) * 0.1f) {
                            f12 = f14;
                            f11 = f15;
                        }
                    }
                        ...
                        if (painting.d == null || !painting.H || painting.q == 0) {
                            if (!d0Var.e) {
                                ...
                                if (d0Var.a.getCurrentBrush() instanceof a) {
                                    ...
                                    d0Var.r.addListener(new er0(d0Var, 29));
                                    d0Var.r.setDuration(240L);
                                    d0Var.r.setInterpolator(qr.h);
                                    d0Var.r.start();
                                }
                            }
                            r72 = 0;
                                        ...
                                        if (i10 != 3) {
                                            ...
                                            if (d0Var.j) {
                                                ...
                                                if (a13 > 0.4f) {
                                                    ...
                                                    double d23 = atan2;
                                                    f10 = scaleX;
                                                    d0Var.k = (float) Math.atan2((Math.sin(d23) * d22) + (Math.sin(d21) * d20), hg.k0.e(d23, d22, Math.cos(d21) * d20));
    ...
    public final void i() {
        ...
        a1 a1Var = this.d;
        q0Var.y = k6.c(k6.b(a1Var.n, a1Var.r), k6.a(matrix));
    }
