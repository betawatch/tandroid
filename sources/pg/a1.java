    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                vl.t(this.b, new StringBuilder("eglGetDisplay failed "));
            }
            finish();
        } else {
                ...
                if (this.b.eglChooseConfig(this.c, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12326, 0, 12344}, eGLConfigArr, 1, iArr)) {
                    if (iArr[0] > 0) {
                        ...
                        if (eglCreateContext == null) {
                            if (BuildVars.LOGS_ENABLED) {
                                vl.t(this.b, new StringBuilder("eglCreateContext failed "));
                            }
                            finish();
                        } else {
                            if (haVar != null) {
                            ...
                            if (surfaceTexture != null) {
                                ...
                                if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                                    if (BuildVars.LOGS_ENABLED) {
                                        vl.t(this.b, new StringBuilder("createWindowSurface failed "));
                                    }
                                    finish();
                                    ...
                                    jv0 jv0Var = q0Var.g;
                                    if (c1Var.h.getWidth() != jv0Var.a || c1Var.h.getHeight() != jv0Var.b) {
                                        Bitmap createBitmap = Bitmap.createBitmap((int) jv0Var.a, (int) jv0Var.b, Bitmap.Config.ARGB_8888);
                                        new Canvas(createBitmap).drawBitmap(c1Var.h, (Rect) null, new RectF(0.0f, 0.0f, jv0Var.a, jv0Var.b), (Paint) null);
                                        c1Var.h = createBitmap;
                                        c1Var.r = true;
                                    }
                                    if (c1Var.n != null && (r5.getWidth() != jv0Var.a || c1Var.n.getHeight() != jv0Var.b)) {
                                        Bitmap createBitmap2 = Bitmap.createBitmap((int) jv0Var.a, (int) jv0Var.b, Bitmap.Config.ARGB_8888);
                                        new Canvas(createBitmap2).drawBitmap(c1Var.n, (Rect) null, new RectF(0.0f, 0.0f, jv0Var.a, jv0Var.b), (Paint) null);
                                    ...
                                    if (BuildVars.LOGS_ENABLED) {
                                        vl.t(this.b, new StringBuilder("eglMakeCurrent failed "));
                                    }
                                    finish();
                                }
                            } else {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        vl.t(this.b, new StringBuilder("eglChooseConfig failed "));
                    }
                    finish();
                }
            } else {
                if (BuildVars.LOGS_ENABLED) {
                    vl.t(this.b, new StringBuilder("eglInitialize failed "));
                }
                finish();
            }
        }
