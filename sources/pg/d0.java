...
public final class d0 {
    ...
    /* JADX WARN: Type inference failed for: r2v6, types: [pg.g1] */
    public d0(c1 c1Var) {
        this.a = c1Var;
        ...
        final int i10 = 0;
        k1Var.l = new Runnable() { // from class: pg.g1
                            ...
                            try {
                                if (k1Var2.b.size() < 8) {
                                    ...
                                    if (i23 >= 0 && i23 < l.b.size() && arrayList.size() >= 1) {
                                        ...
                                        if (i23 == 4) {
                                            int e7 = k1.e(0, arrayList);
                                            if (e7 > 0) {
                                                if (e7 > 10) {
                                                    e7 -= 2;
                                                }
                                                h1 h1Var9 = (h1) arrayList.get(e7);
                                                h1 h1Var10 = (h1) arrayList.get(e7 / 2);
                                            ...
                                            if (i23 == 2 && (e = k1.e(1, arrayList)) > 0) {
                                                h1 h1Var12 = (h1) arrayList.get(e);
                                        ...
                                        AndroidUtilities.runOnUIThread(new t11(k1Var3, f1Var, i21, f10, 14));
                                        k1Var3.j.set(false);
                                    }
                                    f1Var = null;
                                    if (BuildVars.LOGS_ENABLED) {
        ...
        final int i11 = 1;
        k1.m.postRunnable(new Runnable() { // from class: pg.g1
            /* JADX WARN: Removed duplicated region for block: B:136:0x0465  */
            @Override // java.lang.Runnable
            /*
                Code decompiled incorrectly, please refer to instructions dump.
    ...
    public final void a(d dVar, boolean z10, w0 w0Var) {
        ...
        if (this.l) {
            ...
            u0 u0Var2 = this.g;
            float max = Math.max(a2, z6.a((float) u0Var2.a, (float) u0Var2.b, kv0Var.a, 0.0f));
            u0 u0Var3 = this.g;
            float a10 = z6.a((float) u0Var3.a, (float) u0Var3.b, 0.0f, kv0Var.b);
            u0 u0Var4 = this.g;
            final float max2 = Math.max(max, Math.max(a10, z6.a((float) u0Var4.a, (float) u0Var4.b, kv0Var.a, kv0Var.b))) / 0.84f;
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: pg.a0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                    ...
                    boolean z11 = true;
                    painting2.f.f(new z7(painting2, r0Var, z11, z11, null, 4));
                }
            });
    ...
    public final void b(r0 r0Var) {
        ...
        boolean z11 = false;
        if (painting.L == null) {
            painting.f.f(new z7(painting, r0Var, z10, z11, b0Var, 4));
        }
        this.f = false;
    }
