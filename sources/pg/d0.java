...
public final class d0 {
                            ...
                            try {
                                if (k1Var2.b.size() < 8) {
                                    ...
                                    if (i23 >= 0 && i23 < l.b.size() && arrayList.size() >= 1) {
                                        ...
                                        AndroidUtilities.runOnUIThread(new s11(k1Var3, f1Var, i21, f10, 14));
                                        k1Var3.j.set(false);
                                    }
                                    f1Var = null;
                                    if (BuildVars.LOGS_ENABLED) {
    ...
    public final void a(d dVar, boolean z10, w0 w0Var) {
        ...
        if (this.l) {
            ...
            jv0 jv0Var = c1Var.getPainting().g;
            u0 u0Var = this.g;
            float a2 = z6.a((float) u0Var.a, (float) u0Var.b, 0.0f, 0.0f);
            u0 u0Var2 = this.g;
            float max = Math.max(a2, z6.a((float) u0Var2.a, (float) u0Var2.b, jv0Var.a, 0.0f));
            u0 u0Var3 = this.g;
            float a10 = z6.a((float) u0Var3.a, (float) u0Var3.b, 0.0f, jv0Var.b);
            u0 u0Var4 = this.g;
            final float max2 = Math.max(max, Math.max(a10, z6.a((float) u0Var4.a, (float) u0Var4.b, jv0Var.a, jv0Var.b))) / 0.84f;
