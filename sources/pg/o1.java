...
public final class o1 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public o1(Context context) {
        ...
        this.e = view;
        final int i10 = 0;
        view.setOnClickListener(new View.OnClickListener(this) { // from class: pg.k1
        ...
        final int i11 = 1;
        kj0Var.setOnClickListener(new View.OnClickListener(this) { // from class: pg.k1
            public final /* synthetic */ o1 b;
        ...
        addView(kj0Var, a6.d(28, 28.0f, 16, 0.0f, 0.0f, 16.0f, 0.0f));
        ImageView imageView = new ImageView(context);
        this.c = imageView;
        imageView.setImageResource(R.drawable.msg_text_outlined);
        imageView.setPadding(AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f));
        final int i12 = 2;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: pg.k1
            public final /* synthetic */ o1 b;
        ...
        addView(imageView, a6.d(28, 28.0f, 16, 0.0f, 0.0f, 16.0f, 0.0f));
        ...
        final int i13 = 3;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: pg.k1
            public final /* synthetic */ o1 b;
        ...
        final int i14 = 4;
        n1Var.setOnClickListener(new View.OnClickListener(this) { // from class: pg.k1
            public final /* synthetic */ o1 b;
    ...
    public void setTypeface(String str) {
        ...
        for (og.m0 m0Var : og.m0.c()) {
            if (m0Var.a.equals(str)) {
                ...
                String str2 = m0Var.c;
                if (str2 == null) {
                    str2 = LocaleController.getString(m0Var.b);
                }
                n1Var.setText(str2);
                return;
            }
