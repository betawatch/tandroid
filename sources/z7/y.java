...
public final class y implements ia.e {
    ...
    public static final ia.c g = new ia.c("key", hg.k0.n(v7.j0.l(w.class, new s(1))));
    public static final ia.c h = new ia.c("value", hg.k0.n(v7.j0.l(w.class, new s(2))));
    public static final x i = x.b;
    public OutputStream a;
    public final HashMap b;
    public final HashMap c;
    public final ia.d d;
    public final la.h e = new la.h(this, 4);
