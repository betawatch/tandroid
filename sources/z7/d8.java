...
public final class d8 implements ia.d {
    ...
    public static final ia.c b = new ia.c("errorCode", hg.k0.o(w.f.k(w.class, new s(1))));
    public static final ia.c c = new ia.c("durationMs", hg.k0.o(w.f.k(w.class, new s(2))));
