...
public class e extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    /* JADX WARN: Type inference failed for: r2v3, types: [sg.b] */
    /* JADX WARN: Type inference failed for: r2v4, types: [sg.b] */
    /* JADX WARN: Type inference failed for: r2v5, types: [sg.b] */
    public e(Context context, int i10, int i11) {
        ...
        final int i13 = 0;
        this.U = new c(this, 0);
        this.V = new ValueAnimator.AnimatorUpdateListener(this) { // from class: sg.b
        ...
        final int i14 = 1;
        this.W = new ValueAnimator.AnimatorUpdateListener(this) { // from class: sg.b
            public final /* synthetic */ e b;
        ...
        final int i15 = 2;
        this.a0 = new ValueAnimator.AnimatorUpdateListener(this) { // from class: sg.b
            public final /* synthetic */ e b;
