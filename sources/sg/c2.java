...
public final class c2 extends FrameLayout implements m0, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public c2(Context context, SvgHelper.SvgDrawable svgDrawable, int i10, int i11, f6 f6Var) {
        super(context);
        boolean[] zArr;
            ...
            if (i12 >= 0) {
                ...
                for (int i13 = 0; i13 < document.thumbs.size(); i13++) {
                    if (document.thumbs.get(i13) instanceof TLRPC.TL_photoStrippedSize) {
                        ...
                        b2Var = new b2(this, this.K, this.L);
                        b2Var.w = true;
                    }
                }
                this.h = FileLoader.getAttachFileName(document);
                zArr = null;
                this.n.setImage(null, null, b2Var, null, premiumPromo, 1);
                ...
                if (i11 != 1) {
                    ...
                    w1 w1Var = new w1();
                    this.O = w1Var;
                    ArrayList arrayList = w1Var.e;
                    if (arrayList.isEmpty()) {
                        for (int i17 = 0; i17 < w1Var.g; i17++) {
                    ...
                    y1 y1Var2 = new y1(SharedConfig.getDevicePerformanceClass() == 2 ? 800 : SharedConfig.getDevicePerformanceClass() == 1 ? 400 : 100);
                    this.N = y1Var2;
                    y1Var2.O = f6Var;
                    y1Var2.P = j6.Zj;
                    y1Var2.r = 4;
                ...
                this.I = a2Var;
                a2Var.setResizeMode(0);
                TextureView textureView = new TextureView(context);
                this.J = textureView;
                a2Var.addView(textureView);
        ...
        this.d = true;
        a2 a2Var2 = new a2(this, context);
        this.I = a2Var2;
        a2Var2.setResizeMode(0);
        TextureView textureView2 = new TextureView(context);
        this.J = textureView2;
        a2Var2.addView(textureView2);
        setWillNotDraw(false);
        addView(a2Var2);
    }
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        int i14 = 0;
        y1 y1Var = this.N;
        if (y1Var != null || w1Var != null || this.P != null || aVar3 != null) {
            if (this.G < 0.5f) {
                ...
                if (aVar3 != null) {
                    ...
                    if (y1Var != null) {
                        ...
                        w1Var.f = (((1.0f - Utilities.clamp(this.G / 0.1f, 1.0f, 0.0f)) * 0.9f) + 0.1f) * 150.0f * f11;
                        ArrayList arrayList3 = w1Var.e;
                        long currentTimeMillis2 = System.currentTimeMillis();
                        for (int i26 = 0; i26 < arrayList3.size(); i26++) {
                            v1 v1Var = (v1) arrayList3.get(i26);
                            w1 w1Var2 = v1Var.g;
                            float[] fArr2 = w1Var2.d;
                            int i27 = i26 * 4;
                            float f17 = v1Var.a;
                            fArr2[i27] = f17;
                            fArr2[i27 + 1] = v1Var.b;
                            fArr2[i27 + 2] = (AndroidUtilities.dp(30.0f) * v1Var.c) + f17;
                            fArr2[i27 + 3] = (AndroidUtilities.dp(30.0f) * v1Var.d) + v1Var.b;
                            float dp = AndroidUtilities.dp(4.0f);
                            float f18 = w1Var2.j;
                            float f19 = (f18 / 660.0f) * dp * w1Var2.f;
                            float f20 = (v1Var.c * f19) + v1Var.a;
                            v1Var.a = f20;
                            float f21 = (v1Var.d * f19) + v1Var.b;
                            v1Var.b = f21;
                            float f22 = v1Var.f;
                            if (f22 != 1.0f) {
                            ...
                            if (currentTimeMillis2 > v1Var.e || !w1Var.b.contains(f20, f21)) {
                                v1Var.a(currentTimeMillis2, false);
                            }
                        }
                        canvas.drawLines(w1Var.d, w1Var.c);
                    } else {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.S != measuredWidth) {
            ...
            y1 y1Var = this.N;
            if (y1Var != null) {
                RectF rectF2 = y1Var.c;
                RectF rectF3 = y1Var.a;
                int i14 = this.v;
                if (i14 == 6 || i14 == 9 || i14 == 3 || i14 == 7 || i14 == 24 || i14 == 43 || i14 == 11 || i14 == 4) {
                    ...
                    y1Var.b.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                }
                y1Var.f();
