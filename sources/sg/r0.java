...
public class r0 extends FrameLayout implements g90 {
    ...
    public final void d(boolean z10) {
        ...
        this.s.addListener(new oj1(this, 6));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (vqVar != null) {
            ...
            if (uqVar.h == 0) {
                ...
                dp = AndroidUtilities.dp(uqVar.C - 0.5f) + uqVar.s;
            }
            e6 e6Var = this.J;
    ...
    public final void e() {
        ...
        q0 q0Var = this.e;
        q0Var.setAlpha(f7);
        q0Var.setTranslationY((1.0f - this.n) * AndroidUtilities.dp(12.0f));
        float f10 = 1.0f - this.n;
        ah.y yVar = this.r;
        yVar.setAlpha(f10);
        yVar.setTranslationY((-AndroidUtilities.dp(12.0f)) * this.n);
        yVar.setVisibility(this.n == 1.0f ? 4 : 0);
        q0Var.setVisibility(this.n == 0.0f ? 4 : 0);
        invalidate();
    }
    ...
    public void setLoading(boolean z10) {
        if (this.N != z10) {
            ...
            this.O = ofFloat;
            int i10 = 17;
            ofFloat.addUpdateListener(new ki.a(this, i10));
            this.O.addListener(new e50(i10, this, z10));
