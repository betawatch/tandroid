...
public final class d extends View implements ViewTreeObserver.OnPreDrawListener, ViewTreeObserver.OnScrollChangedListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final void a() {
        ...
        ConnectionsManager.getInstance(this.e).sendRequestTyped(tL_messages_reportReadMetrics, null, new ur(2));
        arrayList.clear();
    }
                        ...
                        if (dialogId != j15 && id2 > 0) {
                            ...
                            if (cVar == null) {
                                ...
                                if (BuildVars.LOGS_ENABLED) {
                                    f5.a.n("ViewMetrics", id2 + " " + j11 + " in screen");
                                }
                            } else {
                                rectF2 = rectF3;
                                j11 = groupId;
            ...
            if (j22 == uptimeMillis || rectF7 != null) {
                if (RectF.intersects(rectF8, rectF7 != null ? rectF7 : rectF6)) {
                    ...
                    if (z10) {
                        ...
                        j10 = uptimeMillis;
                        float f9 = rectF8.top - rectF6.top;
                        float f10 = height - (rectF6.bottom - rectF8.bottom);
                        cVar3.l = Math.min(cVar3.l, w.a(f9, 0.0f, height));
                        cVar3.m = Math.max(cVar3.m, w.a(f10, 0.0f, height));
                        ...
                        if (cVar3.i || cVar3.g <= 300) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                str2 = str3;
                                f5.a.n(str2, j21 + " " + j19 + " in viewport");
                            } else {
                                str2 = str3;
                            }
                            cVar3.i = true;
                    ...
                    if (!z11 && cVar3.g > j17) {
                        ...
                        if (j10 - 300 <= cVar3.f) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                str2 = str4;
                                f5.a.n(str2, j21 + " " + j19 + " out of viewport: " + cVar3.g);
                            } else {
                                str2 = str4;
                            }
                            size4--;
                    ...
                    if (!z12 && cVar3.g > 300000) {
                        ...
                        longSparseArray.removeAt(size4);
                        if (BuildVars.LOGS_ENABLED) {
                            f5.a.n(str2, j21 + " " + j19 + " out of time");
                        }
                    } else if (!z12 && cVar3.e != j10 && (j19 == j17 || rectF7 == null)) {
                        longSparseArray.removeAt(size4);
                        if (!BuildVars.LOGS_ENABLED) {
                            f5.a.n(str2, j21 + " " + j19 + " out of screen");
                        }
                    }
                    size4--;
                    str = str2;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.a) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                float f9 = cVar.k;
                sb2.append(f9 == 0.0f ? MediaDataController.MAX_STYLE_RUNS_COUNT : Math.round((cVar.j / f9) * 1000.0f));
