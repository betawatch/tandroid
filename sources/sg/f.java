...
public final class f extends FrameLayout {
    ...
    public f(Context context) {
        ...
        this.b = new op0(this, context, 11);
    }
    ...
    public final void c() {
        m1 m1Var = ((ah.i) this.a).r;
        int i10 = m1Var != null ? m1Var.a.f(2).d : 0;
        float b10 = ((ah.i) this.a).b();
        z51 z51Var = this.d;
        int childCount = z51Var.getChildCount();
        for (int i11 = 0; i11 < childCount; i11++) {
            KeyEvent.Callback childAt = z51Var.getChildAt(i11);
    ...
    public final void d() {
        ...
        this.s = ((ah.i) this.a).c();
        this.v = ((ah.i) this.a).b();
        int i11 = 0;
        this.w = ((ah.i) this.a).s != 1;
        z51 z51Var = this.d;
        boolean z10 = z51Var.getVisibility() == 0;
        boolean z11 = this.w;
        if (z10 != z11) {
            z51Var.setVisibility(z11 ? 0 : 8);
        }
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) z51Var.getLayoutParams();
        int i12 = layoutParams.height;
        int i13 = ((ah.i) this.a).w;
        if (i12 != i13) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            ng.d dVar2 = this.f;
            this.H = (dVar2 != null && dVar2.j == 255 && dVar2.getBounds().contains(x4, y8)) || ((dVar = this.h) != null && dVar.getBounds().contains(x4, y8));
        }
