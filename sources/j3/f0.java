...
public final class f0 extends cb.e implements q {
    ...
    public f0(p pVar, i2 i2Var) {
        ...
        try {
            ...
            this.K = new o4.o0();
            this.b = new f5.y(new g2[b10.length], new f5.c[b10.length], q2.b, null);
            this.n = new m2();
    ...
    public final void K(int i10, int i11, long j10) {
        ...
        if (o2Var.p() || i10 < o2Var.o()) {
            ...
            if (f()) {
                ...
                ye.f fVar2 = new ye.f(this.f0);
                fVar2.a(1);
                f0 f0Var = this.j.a;
                f0Var.i.c(new gf.c(16, f0Var, fVar2));
                return;
            }
            u1 u1Var = this.f0;
            int i12 = u1Var.e;
    ...
    public final u1 R(u1 u1Var, o2 o2Var, Pair pair) {
        ...
        if (!equals || longValue < G2) {
            ...
            u1 b11 = h.c(vVar3, longValue, longValue, longValue, 0L, t0Var, yVar, list).b(vVar3);
            b11.p = longValue;
            return b11;
        }
        if (longValue != G2) {
    ...
    public final void f0() {
        ...
        iVar.a(5, z10 && !f10);
        iVar.a(6, z12 && !f10);
        iVar.a(7, !p10 && (z12 || !z16 || z10) && !f10);
        iVar.a(8, z14 && !f10);
        iVar.a(9, !p10 && (z14 || (z16 && z18)) && !f10);
        iVar.a(10, z19);
        iVar.a(11, z10 && !f10);
        iVar.a(12, z10 && !f10);
    ...
    public final void h0(final u1 u1Var, final int i10, final int i11, boolean z4, int i12, long j10, int i13) {
        ...
        if (z10) {
            this.l.c(1, new hg.m2(c1Var, intValue, 1));
        }
        if (u1Var2.f != u1Var.f) {
            final int i22 = 6;
    ...
    public final void j0() {
        ...
        if (currentThread != looper.getThread()) {
            ...
            h5.a.L("ExoPlayerImpl", l10, this.b0 ? null : new IllegalStateException());
            this.b0 = true;
        }
    }
    ...
    public final void l() {
        ...
        if (o2Var.p() || e2Var.p()) {
            ...
            if (e2Var.b(obj) != -1) {
                ...
                i10 = 1;
                Object I = k0.I((n2) this.a, this.n, this.D, this.E, obj, o2Var, e2Var);
                if (I != null) {
                    m2 m2Var = this.n;
                    e2Var.g(I, m2Var);
                    int i15 = m2Var.c;
