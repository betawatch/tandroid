...
public final class f0 {
    ...
    public final AudioTrack a(boolean z10, e eVar, int i10) {
        ...
        try {
            ...
            throw new q(0, this.e, this.f, this.h, this.a, i11 == 1, e9);
        }
    }
    ...
    public final AudioTrack b(boolean z10, e eVar, int i10) {
        ...
        int i14 = this.e;
        if (i11 >= 29) {
            return new AudioTrack.Builder().setAudioAttributes(c(eVar, z10)).setAudioFormat(j0.f(i14, i13, i12)).setTransferMode(1).setBufferSizeInBytes(this.h).setSessionId(i10).setOffloadedPlayback(this.c == 1).build();
        }
        if (i11 >= 21) {
            return new AudioTrack(c(eVar, z10), j0.f(i14, i13, i12), this.h, 1, i10);
        }
        int y10 = d5.g0.y(eVar.c);
        if (i10 == 0) {
            return new AudioTrack(y10, this.e, this.f, this.g, this.h, 1);
        }
        return new AudioTrack(y10, this.e, this.f, this.g, this.h, 1, i10);
    }
}
