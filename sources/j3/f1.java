...
public final class f1 {
    ...
    public final long a(f5.x xVar, long j10, boolean z4, boolean[] zArr) {
        ...
        this.n = xVar;
        c();
        long v = this.a.v(xVar.c, this.h, this.c, zArr, j10);
    ...
    public final f5.x g(float f10, o2 o2Var) {
        ...
        int i26 = 2;
        Pair j12 = f5.p.j(2, sVar2, iArr4, new c1.b(10, hVar, iArr5), new e5.f(6));
        if (j12 != null) {
        ...
        Pair j13 = f5.p.j(1, sVar2, iArr4, new com.google.firebase.messaging.i(pVar, hVar, z4, 1), new e5.f(7));
        if (j13 != null) {
        ...
        int i28 = 3;
        Pair j14 = f5.p.j(3, sVar2, iArr4, new c1.b(11, hVar, str), new e5.f(8));
        if (j14 != null) {
