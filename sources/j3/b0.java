...
public abstract class b0 extends h3.e implements d5.o {
    ...
    public b0(Handler handler, o oVar, t tVar) {
        ...
        this.audioSink = tVar;
        ((j0) tVar).r = new ae.b((FfmpegAudioRenderer) this, 20);
    ...
    public final boolean a() {
        ...
        if (this.audioTrackNeedsConfigure) {
            ...
            ((j0) this.audioSink).b(new h3.t0(a2), null);
            this.audioTrackNeedsConfigure = false;
        }
        t tVar = this.audioSink;
        SimpleDecoderOutputBuffer simpleDecoderOutputBuffer2 = this.outputBuffer;
        if (((j0) tVar).l(simpleDecoderOutputBuffer2.timeUs, 1, simpleDecoderOutputBuffer2.data)) {
    ...
    public final void c() {
        ...
        try {
            ...
            if (handler != null) {
                handler.post(new e5.w(nVar, name, elapsedRealtime2, j10, 2));
            }
            this.decoderCounters.a++;
        } catch (OutOfMemoryError e9) {
            throw createRendererException(e9, this.inputFormat, 4001);
        } catch (k3.g e10) {
            d5.a.p(TAG, "Audio codec error", e10);
    ...
    public final void g() {
        long g10 = ((j0) this.audioSink).g(isEnded());
    ...
    public void onEnabled(boolean z10, boolean z11) {
        ...
        ((j0) this.audioSink).q = getPlayerId();
    }
        ...
        if (this.experimentalKeepAudioTrackOnSeek) {
            ...
            if (d5.g0.a < 25) {
                ...
                if (j0Var.o()) {
                    ...
                    wVar.f = null;
                    w wVar2 = j0Var.i;
                    AudioTrack audioTrack2 = j0Var.u;
                    f0 f0Var = j0Var.t;
    ...
    public void render(long j10, long j11) {
        ...
        if (this.decoder != null) {
            try {
                ...
                throw createRendererException(e11, e11.a, 5001);
            } catch (q e12) {
                throw createRendererException(e12, e12.c, e12.b, 5001);
            } catch (s e13) {
                throw createRendererException(e13, e13.c, e13.b, 5002);
            } catch (k3.g e14) {
                d5.a.p(TAG, "Audio codec error", e14);
                n nVar = this.eventDispatcher;
                Handler handler = nVar.a;
                if (handler != null) {
    ...
    public final int supportsFormat(h3.t0 t0Var) {
        ...
        return com.google.android.recaptcha.internal.a.b(supportsFormatInternal, 8, d5.g0.a >= 21 ? 32 : 0);
    }
