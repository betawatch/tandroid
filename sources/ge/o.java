    ...
    */
    public final void a(CharSequence charSequence) {
        ...
        while (i11 < charSequence.length()) {
            ...
            if (b11 == 0) {
                int c10 = j8.c(i11, charSequence.length(), charSequence);
                ...
                if (b10 != -1) {
                    ...
                    if (b10 >= charSequence.length()) {
                        ...
                        String replaceAll = ie.a.c.matcher(sb3.trim().toLowerCase(Locale.ROOT)).replaceAll(" ");
                        if (!replaceAll.isEmpty()) {
                            kVar.e = replaceAll;
                            kVar.a = 3;
                            i11 = j8.c(b10 + 2, charSequence.length(), charSequence);
                        }
                    }
                }
                i11 = -1;
            } else if (b11 == 2) {
                int c11 = j8.c(i11, charSequence.length(), charSequence);
                int a2 = i8.a(c11, charSequence);
                if (a2 != -1) {
                    kVar.f = charSequence.charAt(c11) == '<' ? charSequence.subSequence(c11 + 1, a2 - 1).toString() : charSequence.subSequence(c11, a2).toString();
                    i11 = j8.c(a2, charSequence.length(), charSequence);
                    if (i11 >= charSequence.length()) {
                        kVar.i = true;
                        sb2.setLength(0);
                    }
                ...
                i11 = j8.c(i11, charSequence.length(), charSequence);
                if (i11 >= charSequence.length()) {
                    kVar.a = 1;
                } else {
                    kVar.g = (char) 0;
                ...
                b10 = i8.d(charSequence, i11, kVar.g);
                if (b10 != -1) {
                    ...
                    if (b10 >= charSequence.length()) {
                        ...
                        i11 = j8.c(b10 + 1, charSequence.length(), charSequence);
                        if (i11 == charSequence.length()) {
                            kVar.i = true;
                            kVar.a();
                            sb2.setLength(0);
