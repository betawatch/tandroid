    ...
    public static void Q(v2 v2Var, int i10, f6 f6Var, int i11, View view) {
        ...
        if (view instanceof kg.n) {
            ...
            if (i10 == 0 || i10 == 2) {
                ...
                kh.h2 h2Var = new kh.h2(v2Var.getContext(), i11, j10, p0.c(p0.b(1, v2Var.o0)), new h2(v2Var, true ? 1 : 0));
            ...
            if (i10 == 4 && hashSet.isEmpty()) {
                ...
                if (callback2 != null) {
                    lp lpVar = v2Var.Z;
                    callback2.run(Boolean.valueOf(lpVar != null && lpVar.a.q), hashSet);
                    v2Var.A0 = null;
                }
                v2Var.dismiss();
                return;
            ...
            if (z4 != z10) {
                ...
                aVar.animate().alpha(z10 ? 1.0f : 0.0f).translationY(z10 ? 0.0f : AndroidUtilities.dp(12.0f)).setInterpolator(nr.h).setDuration(320L).withEndAction(!z10 ? new g2(v2Var, true ? 1 : 0) : null).start();
                hg.h hVar = v2Var.m0;
                boolean z11 = !z10;
                if (hVar.x != z11) {
                    hVar.x = z11;
        ...
        if (hashSet.size() != 0) {
            ...
            if (!isEmpty || i10 == 0 || i10 == 2 || i10 == 4) {
                ...
                if (arrayList2.size() == 1) {
                    ...
                    kh.h2 h2Var = new kh.h2(getContext(), this.currentAccount, j10, c3, new h2(this, r5 ? 1 : 0));
    ...
    */
    public final void h0(boolean z4, boolean z10) {
        ...
        if (isEmpty) {
            if (this.B0 && i14 == 3) {
                if (this.v0 == null) {
                    nq nqVar = new nq(j6.K(AndroidUtilities.dp(46.0f), j6.v0(j6.Oh, this.resourcesProvider)), getContext().getResources().getDrawable(R.drawable.mini_gram_72).mutate());
