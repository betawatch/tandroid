...
public final class b1 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void P(b1 b1Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j10, org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        for (int i25 = 0; i25 < b11.size(); i25++) {
            ...
            if (tL_premiumGiftCodeOption3.months == b1Var.i0) {
                ...
                JSONObject p11 = rh.q2.p(p2Var.getResourceProvider(), false);
                if (p11 != null) {
    ...
    public static void Q(b1 b1Var, org.telegram.ui.ActionBar.p2 p2Var, View view) {
        ...
        p pVar = new p(context, x4Var2, wc0Var, nVar, oVar);
        ...
        linearLayout.addView(wc0Var, b6.l(0.5f, 0, 270));
        wc0Var.setMinValue(0);
        wc0Var.setMaxValue(i18 - 1);
        wc0Var.setWrapSelectorWheel(false);
        wc0Var.setTag("DAY");
        wc0Var.setFormatter(new c(currentTimeMillis, calendar, i17, 0));
        d dVar2 = new d(pVar, nVar, oVar, i19, i20, wc0Var);
        wc0Var.setOnValueChangedListener(dVar2);
        nVar.setMinValue(0);
        nVar.setMaxValue(23);
        ...
        if (j10 > 0) {
            ...
            wc0Var.getValue();
            dVar2.q(wc0Var, wc0Var.getValue());
            nVar.getValue();
        ...
        qVar.setOnClickListener(new e(calendar, wc0Var, nVar, oVar, r0Var, b3Var, 0));
        b3Var.b(pVar);
        g3 g3Var = b3Var.a;
        g3Var.show();
        int i21 = x4Var.b;
