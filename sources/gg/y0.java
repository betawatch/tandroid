    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                break;
            case 1:
                this.c.presentFragment(new ProfileActivity(kh.a2.g(this.b, "user_id"), null));
                break;
            case 2:
            ...
            default:
                xn xnVar4 = this.c;
                ic v = qc.v(xnVar4.getParentActivity(), xnVar4, null, 1, this.b, 1, xnVar4.getThemedColor(j6.Fi), xnVar4.getThemedColor(j6.Hi), 5000, true, null);
                v.k = true;
                v.k(true);
                break;
        }
