...
public final class y0 extends p2 {
    ...
    public static void W(final y0 y0Var, v51 v51Var, final View view) {
        if (v51Var.g && !y0Var.v.h(v51Var)) {
            int i10 = v51Var.d;
            if (i10 == U) {
                e0 e0Var = y0Var.v;
                y0Var.I = true;
            ...
            if (v51Var.a == 13) {
                TLRPC.User user = (TLRPC.User) y0Var.N.get(v51Var.x);
                if (user == null) {
                    return;
                }
                if (user.bot_business) {
                    y0Var.M = user;
                    AndroidUtilities.hideKeyboard(y0Var.f);
                    y0Var.c.Y2.N(true);
                    y0Var.Y(true);
                    return;
                }
                ...
                y0Var.showDialog(alertDialog$Builder.a);
                return;
            }
            if (i10 == X) {
                boolean z10 = !y0Var.P;
            ...
            if (i10 == h0) {
                final int i12 = 5;
                y0Var.X(i10, !y0Var.J.edit_username, new Runnable(y0Var) { // from class: gg.q0
            ...
            if (i10 == j0) {
                final int i13 = 0;
                y0Var.X(i10, !y0Var.J.view_gifts, new Runnable(y0Var) { // from class: gg.q0
                    public final /* synthetic */ y0 b;
            ...
            if (i10 == k0) {
                final int i14 = 1;
                y0Var.X(i10, !y0Var.J.sell_gifts, new Runnable(y0Var) { // from class: gg.q0
                    public final /* synthetic */ y0 b;
            ...
            if (i10 == l0) {
                final int i15 = 2;
                y0Var.X(i10, !y0Var.J.change_gift_settings, new Runnable(y0Var) { // from class: gg.q0
                    public final /* synthetic */ y0 b;
            ...
            if (i10 == m0) {
                final int i16 = 3;
                y0Var.X(i10, !y0Var.J.transfer_and_upgrade_gifts, new Runnable(y0Var) { // from class: gg.q0
                    public final /* synthetic */ y0 b;
                ...
                final int i17 = 4;
                y0Var.X(i10, !y0Var.J.transfer_stars, new Runnable(y0Var) { // from class: gg.q0
                    public final /* synthetic */ y0 b;
    ...
    public final void X(int i10, boolean z10, final Runnable runnable) {
        ...
        if (!this.K && i10 == h0 && z10) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Allow), new org.telegram.ui.ActionBar.c2(this) { // from class: gg.w0
                public final /* synthetic */ y0 b;
        ...
        alertDialog$Builder2.k(LocaleController.getString(R.string.Allow), new org.telegram.ui.ActionBar.c2(this) { // from class: gg.w0
            public final /* synthetic */ y0 b;
    ...
    public final boolean Z() {
        ...
        if (this.T) {
            ...
            if (z10 == (tL_connectedBot != null)) {
                if ((user == null ? 0L : user.id) == (tL_connectedBot != null ? tL_connectedBot.bot_id : 0L) && (user == null || (this.J.equals(tL_connectedBot.rights) && ((e0Var = this.v) == null || !e0Var.g())))) {
                }
            }
            return true;
        }
    ...
    public final void b0() {
        ...
        if (z10 != (e || this.x || longSparseArray.size() > 0)) {
            ...
            this.s.animate().alpha(z11 ? 1.0f : 0.0f).translationY(z11 ? 0.0f : AndroidUtilities.dp(8.0f)).setDuration(320L).setInterpolator(wrVar).start();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f.setOnEditorActionListener(new x0(this, 0));
        this.f.addTextChangedListener(new u2(this, 2));
        ...
        frameLayout4.addView(view2, a6.d(-1, f7, 87, z10 ? 0 : 21, 0.0f, z10 ? 21 : 0, 0.0f));
        l4 l4Var = new l4(context, 2);
        this.n = l4Var;
        l4Var.setBackgroundColor(getThemedColor(i12));
        ...
        this.n.addView(this.r, a6.e(-2, -2, 17));
        this.s = new ImageView(context);
        x9 x9Var = new x9(getThemedColor(i13));
        this.s.setScaleType(ImageView.ScaleType.CENTER);
        this.s.setImageDrawable(x9Var);
        this.n.addView(this.s, a6.e(-2, -2, 17));
        this.s.setAlpha(0.0f);
        this.s.setTranslationY(AndroidUtilities.dp(8.0f));
        fg.d2 d2Var = new fg.d2(true);
        this.d = d2Var;
        d2Var.a = new xa.c(this, 21);
        e0 e0Var = new e0(this, new r0(this, 3));
        this.v = e0Var;
        TL_account.TL_connectedBot tL_connectedBot = this.H;
        e0Var.i(tL_connectedBot == null ? null : tL_connectedBot.recipients);
