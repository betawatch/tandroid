    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.a) {
            ...
            case 2:
                ...
                break;
            case 3:
                AndroidUtilities.runOnUIThread(new cg.v1((e9) this.c, tLObject, this.b, (TLRPC.User) this.d, 10));
                break;
            case 4:
            ...
            case 5:
                ...
                break;
            case 6:
                AndroidUtilities.runOnUIThread(new cg.v1((g40) this.c, this.b, tLObject, (String) this.d, 19));
                break;
            case 7:
                AndroidUtilities.runOnUIThread(new cg.v1((qq0) this.c, this.b, tLObject, (String) this.d, 21));
                break;
            case 8:
                AndroidUtilities.runOnUIThread(new rx0((ProfileActivity) this.c, tL_error, tLObject, (TLRPC.TL_channels_getParticipants) this.d, 0), this.b);
                break;
            case 9:
                AndroidUtilities.runOnUIThread(new f3((org.telegram.ui.web.a1) this.c, tLObject, this.b, (org.telegram.ui.web.w0) this.d, tL_error, 25));
                break;
            default:
                tf.z zVar = (tf.z) this.c;
                String str2 = (String) this.d;
                zVar.getClass();
                AndroidUtilities.runOnUIThread(new ct(zVar, this.b, tLObject, str2, 15));
                break;
        }
    }
