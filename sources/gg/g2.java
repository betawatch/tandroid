...
public final class g2 extends FrameLayout {
    ...
    public g2(Context context, f6 f6Var, boolean z10) {
        ...
        addView(oVar, a6.d(-1, -2.0f, 7, z11 ? i10 : 64.0f, 7.0f, z11 ? 64.0f : i10, 0.0f));
        if (z10) {
            ...
            addView(imageView, a6.e(50, 50, (LocaleController.isRTL ? 3 : 5) | 112));
        } else {
            this.e = null;
        }
    ...
    public final void a(j2 j2Var, String str, boolean z10) {
        ...
        TLRPC.Photo photo2;
        String str3 = str;
        this.h = j2Var != null ? j2Var.g : false;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        if (str3 != null && str3.length() > 0 && !str3.startsWith("/")) {
            str3 = "/".concat(str3);
        }
        spannableStringBuilder.append((CharSequence) "/").append((CharSequence) j2Var.b);
        ...
        if (j2Var.a() > 1) {
            ...
            f2 f2Var = new f2(a2);
            int dp2 = (int) (((t01) f2Var.c).c + AndroidUtilities.dp(10.0f));
            this.n[0] = dp2;
        ...
        if (media != null && (photo2 = media.photo) != null) {
            ...
            imageReceiver.setImage(ImageLocation.getForObject(closestPhotoSizeWithSize3, media.webpage.photo), "36_36", j2Var.e.strippedThumb, closestPhotoSizeWithSize3 != null ? closestPhotoSizeWithSize3.size : 0L, (String) null, media.webpage, 0);
            imageReceiver.setRoundRadius(AndroidUtilities.dp(4.0f));
        }
        this.r = z10;
        invalidate();
