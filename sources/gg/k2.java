...
public final class k2 {
    public static volatile k2[] g = new k2[4];
    ...
    public final void a(String str) {
        ...
        while (true) {
            ...
            i10++;
            j2Var = (j2) obj;
            if (TextUtils.equals(str, j2Var.b)) {
                break;
            }
        }
        if (j2Var != null) {
    ...
    */
    public final void i(Runnable runnable, boolean z10) {
        ...
        if (z10) {
            ...
            messagesStorage.getStorageQueue().postRunnable(new ua(this, messagesStorage, UserConfig.getInstance(i12).getClientUserId(), runnable, 1));
            return;
        }
        ...
        loop0: while (true) {
            ...
            if (i14 >= arrayList.size()) {
                ConnectionsManager.getInstance(i12).sendRequest(tL_messages_getQuickReplies, new bi.c2(this, 12));
                return;
            }
            j2 j2Var = (j2) arrayList.get(i14);
            long calcHash = MediaDataController.calcHash(tL_messages_getQuickReplies.hash, j2Var.a);
            ...
            long calcHash3 = MediaDataController.calcHash(calcHash2, j2Var.e == null ? j3 : r6.getId());
    ...
    public final boolean j(final TLRPC.Update update, String str, int i10) {
        ...
        if (update instanceof TL_update.TL_updateQuickReplies) {
            final int i11 = 0;
            b(new Runnable(this) { // from class: gg.i2
                ...
                public final void run() {
                    ...
                    switch (i11) {
                        case 0:
                            ...
                            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                                ...
                                while (true) {
                                    if (i13 >= arrayList3.size()) {
                                        j2Var = null;
                                    } else if (((j2) arrayList3.get(i13)).a == tL_quickReply.shortcut_id) {
                                ...
                                j2Var.a = tL_quickReply.shortcut_id;
                                j2Var.b = tL_quickReply.shortcut;
                                j2Var.f = tL_quickReply.count;
                                j2Var.c = i12;
                            ...
                            k2Var.l();
                            NotificationCenter.getInstance(k2Var.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.quickRepliesUpdated, new Object[0]);
                            break;
                        case 1:
                            k2 k2Var2 = this.b;
                            ...
                            if (c10 != null) {
                                ...
                                j2 j2Var2 = new j2();
                                j2Var2.a = tL_quickReply2.shortcut_id;
                                j2Var2.b = tL_quickReply2.shortcut;
                                j2Var2.f = tL_quickReply2.count;
                                j2Var2.d = tL_quickReply2.top_message;
                                for (int i15 = 0; i15 < arrayList4.size(); i15++) {
                                    ((j2) arrayList4.get(i15)).c = i15;
                                }
                            ...
                            for (int i122 = 0; i122 < arrayList.size(); i122++) {
                                ...
                                while (true) {
                                    if (i132 >= arrayList3.size()) {
                                        j2Var = null;
                                    } else if (((j2) arrayList3.get(i132)).a == tL_quickReply.shortcut_id) {
                                        j2Var = (j2) arrayList3.get(i132);
                                    } else {
                                        i132++;
                                    }
                                }
