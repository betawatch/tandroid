...
public final class m1 extends eg.e2 {
    ...
    @Override // eg.e2
    public final void W(hb1 hb1Var) {
        View view = this.y0;
        ArrayList arrayList = this.N0;
        hb1Var.addView(view, b6.k(0.0f, arrayList.size() == 1 ? 28.0f : 34.0f, 0.0f, arrayList.size() == 1 ? 9.0f : 14.0f, -1, arrayList.size() == 1 ? 94 : 83));
    }
    ...
    public final void a0(boolean z4) {
        ...
        e90 e90Var = this.L0[0];
        ArrayList arrayList = this.N0;
        e90Var.setText(LocaleController.getPluralString("GiftPremiumGiftsSent", arrayList.size()));
