...
public final class m1 extends p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void U(m1 m1Var, TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        if (!(tLObject instanceof TLRPC.TL_boolFalse)) {
            if (m1Var.isFinished || m1Var.finishing) {
                return;
            }
    ...
    public static void V(m1 m1Var, ArrayList arrayList) {
        ...
        while (true) {
            ...
            if (i12 >= arrayListArr.length) {
                ...
                arrayList.add(v51.f(LocaleController.getString(R.string.BusinessHoursTimezone), o2.b(m1Var.currentAccount).d(m1Var.r, false), -2));
    ...
    public static /* synthetic */ void W(m1 m1Var, View view, String str) {
    ...
    public static ArrayList[] Z(ArrayList arrayList) {
        ...
        while (i15 < 7) {
            ...
            if (i19 >= i18) {
                int i21 = (i15 + 6) % 7;
                if (!arrayListArr[i21].isEmpty() && ((l1) hc.b.i(1, arrayListArr[i21])).b >= 1440) {
                    ((l1) hc.b.i(1, arrayListArr[i21])).b = 1439;
                }
                int min = Math.min((i19 - i16) - 1, 2879);
                ArrayList arrayList2 = arrayListArr[(i15 + 8) % 7];
                if (min >= 1440 && !arrayList2.isEmpty() && ((l1) arrayList2.get(0)).a < min - 1440) {
                    min = ((l1) arrayList2.get(0)).a + 1439;
                }
    ...
    public static String a0(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            u10.append(l1.a(l1Var.a));
            u10.append(" - ");
            u10.append(l1.a(l1Var.b));
            str = u10.toString();
        }
        return str;
    }
    ...
    public static String f0(int i10, TLRPC.User user, TL_account.TL_businessWorkHours tL_businessWorkHours) {
        ...
        for (int i11 = 0; i11 < 7; i11++) {
            ...
            if (c0(arrayList)) {
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    ...
                    sb2.append(l1.a(l1Var.a));
                    sb2.append(" - ");
                    sb2.append(l1.a(l1Var.b));
                }
            }
            sb2.append("\n");
        }
        ...
        if (((Calendar.getInstance().getTimeZone().getRawOffset() / MediaDataController.MAX_STYLE_RUNS_COUNT) - (a2 == null ? 0 : a2.utc_offset)) / 60 != 0 && a2 != null) {
            ...
            o2.b(i10);
            sb2.append(LocaleController.formatString(i13, o2.e(a2, true)));
        }
        return sb2.toString();
    }

    public final void X(int i10) {
        if ((this.h[i10].isEmpty() ? null : (l1) hc.b.i(1, this.h[i10])) == null) {
            return;
        }
        int i11 = (i10 + 6) % 7;
        l1 l1Var = this.h[i11].isEmpty() ? null : (l1) hc.b.i(1, this.h[i11]);
        if (l1Var == null || l1Var.b <= 1439) {
            return;
        }
        l1Var.b = 1439;
        if (l1Var.a >= 1439) {
            this.h[i11].remove(l1Var);
        }
    ...
    */
        ...
        if (this.f != null && this.e) {
            ...
            loop0: while (true) {
                ...
                for (int i11 = 0; i11 < this.h[i10].size(); i11++) {
                    l1 l1Var = (l1) this.f[i10].get(i11);
                    l1 l1Var2 = (l1) this.h[i10].get(i11);
                    if (l1Var.a != l1Var2.a || l1Var.b != l1Var2.b) {
                        break loop0;
                    }
                }
                i10++;
            ...
            for (int i10 = 0; i10 < arrayListArr.length; i10++) {
                if (arrayListArr[i10] != null) {
                    for (int i11 = 0; i11 < arrayListArr[i10].size(); i11++) {
                        ...
                        int i12 = i10 * 1440;
                        tL_businessWeeklyOpen.start_minute = l1Var.a + i12;
                        tL_businessWeeklyOpen.end_minute = i12 + l1Var.b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.timezonesUpdated) {
            if (this.f == null) {
                this.r = o2.b(this.currentAccount).c();
            }
            r61 r61Var = this.a;
