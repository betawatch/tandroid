    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 3:
                ...
                break;
            case 4:
                AndroidUtilities.runOnUIThread(new kh.e1((zn) obj5, (ze.c) obj4, (org.telegram.ui.Cells.s1) obj3, (String) obj2, tLObject, (CharacterStyle) obj));
                break;
            case 5:
                ...
                break;
            case 6:
                AndroidUtilities.runOnUIThread(new g0((ln) obj5, (org.telegram.ui.ActionBar.d2) obj4, tLObject, (HashSet) obj3, (TLRPC.TL_inputGroupCallInviteMessage) obj2, (MessageObject) obj, tL_error));
                break;
            case 7:
            ...
            case 10:
                ...
                if (!(tLObject instanceof TLRPC.Updates)) {
                    if (tL_error != null) {
                        AndroidUtilities.runOnUIThread(new d10(c30Var, 25));
                        break;
                    }
                } else {
                    ...
                    while (true) {
                        int i12 = 3;
                        if (i11 >= size) {
                            yf0Var.v.getMessagesController().processUpdates(updates, false);
                            BillingController.getInstance().consumeGiftPurchase(purchase, tL_payments_canPurchaseStore.purpose, null);
                            AndroidUtilities.runOnUIThread(new vf0(yf0Var, i12));
                            break;
                        } else {
                            Object obj6 = findUpdatesAndRemove.get(i11);
                            i11++;
                            AndroidUtilities.runOnUIThread(new jf0((Object) yf0Var, (Object) tL_inputStorePaymentAuthCode, obj6, i12));
                        }
                    }
                }
                break;
            ...
            case 12:
                ...
                break;
            case 13:
                AndroidUtilities.runOnUIThread(new kh.e1((i71) obj5, tL_error, (TLRPC.InputCheckPasswordSRP) obj4, (TLRPC.User) obj3, (TwoStepVerificationActivity) obj2, (TLRPC.TL_channels_editCreator) obj));
                break;
            default:
                AndroidUtilities.runOnUIThread(new kh.e1((int[]) obj5, tLObject, (MessagesController) obj4, (TLRPC.User[]) obj3, (xa) obj2, (kl) obj, 20, false));
                break;
        }
    }
}
