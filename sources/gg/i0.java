...
public final /* synthetic */ class i0 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            case 2:
                AndroidUtilities.runOnUIThread(new k0(tLObject, (p2.n) this.e, (p2.h) this.c, (Utilities.Callback2) this.f, (Activity) this.d, (TLRPC.InputStorePaymentPurpose) this.g, (List) this.b, tL_error, 2));
                break;
            case 3:
                AndroidUtilities.runOnUIThread(new k0(tLObject, (p2.n) this.e, (p2.h) this.c, (Utilities.Callback2) this.f, (Activity) this.d, (TLRPC.InputStorePaymentPurpose) this.g, (List) this.b, tL_error, 3));
                break;
            default:
    ...
    public /* synthetic */ i0(p2.n nVar, p2.h hVar, Utilities.Callback2 callback2, Activity activity, TLRPC.InputStorePaymentPurpose inputStorePaymentPurpose, List list, int i10) {
        this.a = i10;
        this.e = nVar;
        this.c = hVar;
        this.f = callback2;
