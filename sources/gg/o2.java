...
public final class o2 {
    public static volatile o2[] e = new o2[4];
    ...
    public static String f(TLRPC.TL_timezone tL_timezone) {
        ...
        u10.append(i11 < 10 ? "0" : "");
        u10.append(i11);
        StringBuilder u11 = a4.a.u(r6.t(u10.toString(), ":"));
        u11.append(i12 < 10 ? "0" : "");
        u11.append(i12);
        return u11.toString();
    }
    ...
    */
    ...
    public final void g() {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_help_getTimezonesList, new bi.o2(10, this, mainSettings));
    }
}
