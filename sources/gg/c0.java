...
public final /* synthetic */ class c0 implements RequestDelegate {
        ...
        switch (i10) {
            case 0:
                ...
                if (tLObject instanceof TLRPC.TL_contacts_found) {
                    ...
                    AndroidUtilities.runOnUIThread(new gf.c(3, b2Var, arrayList));
                    break;
                }
                break;
            case 1:
                AndroidUtilities.runOnUIThread(new lh.c2((t7) obj2, (Object) tLObject, this.b, obj, 4));
                break;
            case 2:
                s7 s7Var = (s7) obj;
                s7Var.getClass();
                AndroidUtilities.runOnUIThread(new kh.g1(s7Var, tLObject, (MessagesController) obj2, tL_error, this.b, 6));
                break;
            case 3:
            ...
            case 5:
                ...
                if (tLObject instanceof Vector) {
                    ...
                    final i80 i80Var = new i80(11, oj0Var, arrayList7);
                    if (ChatObject.isChannel(chat2)) {
                        ...
                        final int i18 = 0;
                        ConnectionsManager.getInstance(i15).sendRequest(tL_channels_getParticipants, new RequestDelegate() { // from class: org.telegram.ui.Components.lj0
                            @Override // org.telegram.tgnet.RequestDelegate
                                                    ...
                                                    case 0:
                                                        ...
                                                        if (tLObject3 != null) {
                                                            ...
                                                            for (int i20 = 0; i20 < tL_channels_channelParticipants.users.size(); i20++) {
                                                                ...
                                                                MessagesController.getInstance(oj0Var2.f).putUser(user, false);
                                                    ...
                                                    default:
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            for (int i21 = 0; i21 < tL_messages_chatFull.users.size(); i21++) {
                                                                ...
                                                                MessagesController.getInstance(oj0Var2.f).putUser(user2, false);
                                                ...
                                                switch (i20) {
                                                    case 0:
                                                        ...
                                                        if (tLObject3 != null) {
                                                            ...
                                                            for (int i202 = 0; i202 < tL_channels_channelParticipants.users.size(); i202++) {
                                                                ...
                                                                MessagesController.getInstance(oj0Var3.f).putUser(user, false);
                                                    ...
                                                    default:
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            for (int i21 = 0; i21 < tL_messages_chatFull.users.size(); i21++) {
                                                                TLRPC.User user2 = tL_messages_chatFull.users.get(i21);
                                                                MessagesController.getInstance(oj0Var3.f).putUser(user2, false);
                        ...
                        final int i19 = 1;
                        ConnectionsManager.getInstance(i15).sendRequest(tL_messages_getFullChat, new RequestDelegate() { // from class: org.telegram.ui.Components.lj0
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(final TLObject tLObject2, TLRPC.TL_error tL_error2) {
                                switch (i19) {
                                    case 0:
            ...
            default:
                ...
                AndroidUtilities.runOnUIThread(new ci(tLObject, (MessagesController) obj2, this.b, (rq) obj, 8));
                break;
        }
    }
    ...
    public /* synthetic */ c0(nh.e1 e1Var, int[] iArr, long j10) {
        this.a = 3;
        this.c = e1Var;
        this.d = iArr;
        this.b = j10;
