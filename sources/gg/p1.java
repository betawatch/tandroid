    ...
    public p1(Context context, f6 f6Var) {
        ...
        for (int i11 = 7; i10 < i11; i11 = 7) {
            if (i10 == 0) {
                ...
                l4Var.addView(this.h[i10], a6.i(-2.0f, -2.0f, 8388659, 0.0f, 33.0f, 0.0f, 10.0f));
                ...
                for (int i12 = 0; i12 < 2; i12++) {
                    ...
                    this.s.addView(this.n[i10][i12], a6.i(-1.0f, -1.0f, 119, 0.0f, 0.0f, 20.0f, 0.0f));
                }
                for (int i13 = 0; i13 < 2; i13++) {
                    ...
                    this.s.addView(this.c[i13], a6.i(-1.0f, -1.0f, 119, 0.0f, 0.0f, 20.0f, 0.0f));
                }
                ...
                this.s.addView(imageView, a6.h(20.0f, 20.0f, 8388629));
                this.v.addView(this.s, new LinearLayout.LayoutParams(a6.z(-1.0f), a6.z(-1.0f), Gravity.getAbsoluteGravity(119, LocaleController.isRTL ? 1 : 0)));
                ...
                jqVar.setGravity(LocaleController.isRTL ? 3 : 5);
                ...
                for (int i15 = 0; i15 < 2; i15++) {
                    ...
                    frameLayout2.addView(this.n[i10][i15], a6.e(-1, -1, 119));
                }
                if (LocaleController.isRTL) {
                    f7.addView(frameLayout2, a6.q(-2, -1, 51));
                    f7.addView(this.h[i10], a6.q(-1, -1, 53));
                } else {
                    f7.addView(this.h[i10], a6.q(-2, -1, 51));
                    f7.addView(frameLayout2, a6.q(-1, -1, 53));
                }
                this.f[i10] = f7;
                addView(f7, a6.u(-1.0f, -2.0f, 51, 18.0f, i10 == 1 ? 1.0f : 11.66f, 28.0f, i10 == 6 ? 16.66f : 0.0f));
            }
            i10++;
        }
    ...
    */
    public final void b(TL_account.TL_businessWorkHours tL_businessWorkHours, boolean z10, boolean z11, boolean z12) {
        ...
        if (!tL_businessWorkHours.weekly_open.isEmpty()) {
            ...
            TLRPC.TL_timezone a2 = o2.b(UserConfig.selectedAccount).a(tL_businessWorkHours.timezone_id);
            ...
            if (z14) {
                ...
                textViewArr3[1].animate().alpha((z18 || !z19) ? 0.0f : 1.0f).setDuration(320L).setInterpolator(wrVar).start();
                textViewArr[0][0].animate().alpha(z18 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(wrVar).start();
                textViewArr[0][1].animate().alpha(z18 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(wrVar).start();
                imageView.animate().rotation(z18 ? 180.0f : 0.0f).setDuration(320L).setInterpolator(wrVar).start();
            } else {
                    ...
                    if (i26 < textViewArr4.length) {
                        if (i11 != 0 || z18) {
                            if ((i26 == i22) == z19) {
                                f10 = 1.0f;
                                if (this.y) {
                                    textViewArr4[i26].animate().alpha(f10).setDuration(320L).setInterpolator(wr.h).start();
                                } else {
            ...
            jqVar.c(LocaleController.getString(!z19 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
            this.y = false;
            ArrayList[] Z = m1.Z(new ArrayList(tL_businessWorkHours.weekly_open));
            ...
            Collections.sort(arrayList2, new a4.e(8));
                        ...
                        if (i41 < (i39 == 0 ? 2 : 1)) {
                            ...
                            if (i39 == 0 && !z16 && i41 == 1) {
                                ...
                                if (z22) {
                                    ...
                                    textView2.setText(LocaleController.getString(R.string.BusinessHoursProfileClose));
                                } else if (m1.c0(arrayListArr4[i40])) {
            ...
            f7 = 6.0f;
            layoutParams.topMargin = AndroidUtilities.dp((this.w <= 2 || jqVar.getVisibility() == 0) ? 6.0f : 12.0f);
            if (this.w <= 2 && jqVar.getVisibility() != 0) {
                f7 = 12.0f;
            }
            layoutParams.bottomMargin = AndroidUtilities.dp(f7);
            layoutParams.gravity = ((this.w <= 2 || jqVar.getVisibility() == 0) ? 16 : 80) | (!LocaleController.isRTL ? 3 : 5);
        ...
        this.v.setTranslationX(!z13 ? AndroidUtilities.dp(11.0f) : 0.0f);
        TLRPC.TL_timezone a22 = o2.b(UserConfig.selectedAccount).a(tL_businessWorkHours.timezone_id);
        ...
        jqVar2.c(LocaleController.getString(!z19 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
        this.y = false;
        ArrayList[] Z3 = m1.Z(new ArrayList(tL_businessWorkHours.weekly_open));
        ...
        f7 = 6.0f;
        layoutParams2.topMargin = AndroidUtilities.dp((this.w <= 2 || jqVar2.getVisibility() == 0) ? 6.0f : 12.0f);
        if (this.w <= 2) {
            f7 = 12.0f;
        }
        layoutParams2.bottomMargin = AndroidUtilities.dp(f7);
        layoutParams2.gravity = ((this.w <= 2 || jqVar2.getVisibility() == 0) ? 16 : 80) | (!LocaleController.isRTL ? 3 : 5);
        if (i14 == this.w) {
        }
        requestLayout();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!this.F) {
            ...
            if (i12 > 2 || jqVar.getVisibility() == 0) {
                dp = AndroidUtilities.dp(jqVar.getVisibility() == 0 ? 21.0f : 0.0f) + AndroidUtilities.dp(15.0f) + this.x;
            } else {
                dp = 0;
            }
