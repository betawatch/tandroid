...
public final class e2 implements Runnable {
    ...
    */
    public final void run() {
        ...
        fq progressDrawable = g51Var.b.h.getProgressDrawable();
        ...
        if (allStickers == null || allStickers.isEmpty() || g2Var.R.length() <= 1) {
            ...
            if (!Arrays.equals(g51Var.a.b(), currentKeyboardLanguage)) {
                MediaDataController.getInstance(i10).fetchNewEmojiKeywords(currentKeyboardLanguage);
            }
            g51Var.a.i(currentKeyboardLanguage);
            i11 = 0;
            MediaDataController.getInstance(i10).getEmojiSuggestions(g51Var.a.b(), g2Var.R, false, new d2(this, i14, allStickers, i11), false);
        }
