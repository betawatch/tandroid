...
public final /* synthetic */ class v0 implements Runnable {
    ...
    public final void run() {
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            default:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.q(h6.k1((a6) this.e, (File) this.f, this.c, this.b, (TLRPC.Document) this.h, this.d), 15));
                break;
        }
    }
    ...
    public /* synthetic */ v0(a6 a6Var, File file, int i10, boolean z10, TLRPC.Document document, boolean z11) {
        this.e = a6Var;
        this.f = file;
        this.c = i10;
        this.b = z10;
