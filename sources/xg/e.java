...
public class e extends FrameLayout implements xd.b {
    ...
    public e(Context context, og.a aVar, g6 g6Var, rg.a aVar2) {
        ...
        this.w = new xd.a(100, this, prVar, 320L, false);
        this.C = new Paint(1);
        this.D = 0;
        this.n = aVar;
        this.r = aVar2;
    ...
    public final void a() {
        ...
        if (oVar2 != null) {
            ...
            ((wg.a) oVar2.b).setTranslationX(AndroidUtilities.dp(1.0f) + this.y);
            this.y += dp;
        }
        int i10 = 0;
        while (true) {
        ...
        if (i10 >= 0) {
            ...
            if (i10 < oVarArr.length && ((oVar = oVarArr[i10]) != null || z4)) {
                if (oVar == null) {
                    ...
                    wg.a d = wg.a.d(getContext(), this.n, this.r, this.h, E[i10], 48);
                    if (i10 == 1) {
