...
public abstract class y7 {
    ...
    public static void a(LaunchActivity launchActivity, boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            ((GestureDetector) oVar.b).setIsLongpressEnabled(false);
            ...
            a = iVar2;
            launchActivity.s0.addView(iVar2, new FrameLayout.LayoutParams(-1, -1));
            vf.i iVar3 = a;
            iVar3.a.setVisibility(0);
            o1.j jVar = new o1.j(new hb.a(0.0f));
            jVar.u = org.telegram.ui.Cells.pa.k(1000.0f, 750.0f, 0.75f);
