...
public abstract class l6 {
    public static NinePatchDrawable a(Bitmap bitmap, Rect rect, int i10, int i11) {
        ...
        StringBuilder p6 = com.google.android.recaptcha.internal.a.p("center pixel is outside bitmap: (", i10, ", ", i11, ") for ");
        p6.append(bitmap.getWidth());
        p6.append("x");
        p6.append(bitmap.getHeight());
    ...
    */
    public static NinePatchDrawable b(Bitmap[] bitmapArr, float[] fArr, float f10, float f11, int i10, pg.e eVar) {
        ...
        if (z10) {
            ...
            if (bitmap != null && !bitmap.isRecycled() && bitmap.isMutable() && bitmap.getWidth() == i12 && bitmap.getHeight() == i13) {
                ...
                if (bitmap.getConfig() == Bitmap.Config.ARGB_8888) {
                    ...
                    int b10 = n.b(((int) Math.ceil(max11)) + ceil2, 1, i12 - 2);
                    int b11 = n.b((i12 - ceil3) - ((int) Math.ceil(max12)), b10 + 1, i12 - 1);
                    int b12 = n.b(((int) Math.ceil(max13)) + ceil4, 1, i14 - 2);
                    return new NinePatchDrawable(ApplicationLoader.applicationContext.getResources(), bitmap, c(b10, b11, b12, n.b((i14 - ceil5) - ((int) Math.ceil(max14)), b12 + 1, i14 - 1), ceil2, ceil4, ceil3, ceil5, i10).array(), new Rect(ceil2, ceil4, ceil3, ceil5), null);
                }
            } else {
                f12 = max5;
            }
        ...
        int b102 = n.b(((int) Math.ceil(max112)) + ceil2, 1, i12 - 2);
        int b112 = n.b((i12 - ceil3) - ((int) Math.ceil(max122)), b102 + 1, i12 - 1);
        int b122 = n.b(((int) Math.ceil(max132)) + ceil4, 1, i142 - 2);
        return new NinePatchDrawable(ApplicationLoader.applicationContext.getResources(), bitmap, c(b102, b112, b122, n.b((i142 - ceil5) - ((int) Math.ceil(max142)), b122 + 1, i142 - 1), ceil2, ceil4, ceil3, ceil5, i10).array(), new Rect(ceil2, ceil4, ceil3, ceil5), null);
    }
