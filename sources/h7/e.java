...
public class e extends AbstractCollection implements List {
    ...
    public void i() {
        ...
        if (eVar != null) {
            ...
            ((o8.h0) this.f).d.put(this.b, this.c);
        }
    }
    ...
    public void n() {
        ...
        if (eVar != null) {
            ...
            if (!this.c.isEmpty() || (collection = (Collection) ((o8.h0) this.f).d.get(this.b)) == null) {
                return;
            }
            this.c = collection;
        }
    ...
    public final List subList(int i9, int i10) {
        switch (this.a) {
            case 0:
                zzb();
                h hVar = (h) this.h;
                List subList = ((List) this.c).subList(i9, i10);
                e eVar = (e) this.e;
                if (eVar == null) {
                    eVar = this;
                }
            ...
            case 1:
                zzb();
                List subList2 = ((List) this.c).subList(i9, i10);
                e eVar2 = (e) this.e;
                if (eVar2 == null) {
                    eVar2 = this;
                }
            ...
            default:
                ...
                List subList3 = ((List) this.c).subList(i9, i10);
                e eVar3 = (e) this.e;
                if (eVar3 == null) {
                    eVar3 = this;
                }
                ...
                Object obj3 = this.b;
                return z12 ? new o8.f(h0Var, obj3, subList3, eVar3) : new e(h0Var, obj3, subList3, eVar3);
        }
    }
    ...
    public final Object remove(int i9) {
        switch (this.a) {
            case 0:
                zzb();
                Object remove = ((List) this.c).remove(i9);
                h hVar = (h) this.h;
                hVar.d--;
                q();
                return remove;
            case 1:
                zzb();
                Object remove2 = ((List) this.c).remove(i9);
                q();
                return remove2;
            default:
                n();
                Object remove3 = ((List) this.c).remove(i9);
                o8.h0 h0Var = (o8.h0) this.h;
                h0Var.e--;
                o();
                return remove3;
    ...
    public final boolean addAll(int i9, Collection collection) {
        switch (this.a) {
            case 0:
                ...
                int size = size();
                boolean addAll = ((List) this.c).addAll(i9, collection);
                if (!addAll) {
                    return addAll;
                }
                int size2 = this.c.size();
            ...
            case 1:
                ...
                int size3 = size();
                boolean addAll2 = ((List) this.c).addAll(i9, collection);
                if (!addAll2) {
                    return addAll2;
                }
                this.c.size();
            ...
            default:
                ...
                int size4 = size();
                boolean addAll3 = ((List) this.c).addAll(i9, collection);
                if (!addAll3) {
                    return addAll3;
                }
                int size5 = this.c.size();
                ((o8.h0) this.h).e += size5 - size4;
                if (size4 != 0) {
                    return addAll3;
                }
                i();
