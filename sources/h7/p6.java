...
public abstract class p6 {
    public static int a(byte[] bArr, int i10, cg.w0 w0Var) {
        ...
        if (i11 == 0) {
            w0Var.d = com.google.android.gms.internal.play_billing.k1.c;
            return f9;
        }
    ...
    public static int e(int i10, byte[] bArr, int i11, int i12, com.google.android.gms.internal.play_billing.w2 w2Var, cg.w0 w0Var) {
        ...
        int i13 = i10 & 7;
        if (i13 == 0) {
            int i14 = i(bArr, i11, w0Var);
            w2Var.c(i10, Long.valueOf(w0Var.b));
            return i14;
        }
        if (i13 == 1) {
        ...
        if (i13 == 2) {
            ...
            if (i15 > bArr.length - f9) {
                throw new com.google.android.gms.internal.play_billing.b2("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
            }
            if (i15 == 0) {
                w2Var.c(i10, com.google.android.gms.internal.play_billing.k1.c);
            } else {
                w2Var.c(i10, com.google.android.gms.internal.play_billing.k1.q(f9, i15, bArr));
            }
            return f9 + i15;
        }
        if (i13 != 3) {
        ...
        while (true) {
            ...
            i11 = e(i19, bArr, f10, i12, b10, w0Var);
            i18 = i19;
        }
        w0Var.c--;
        if (i11 > i12 || i18 != i16) {
