...
public final class h {
    ...
    public h(Context context, n5.b bVar, p pVar) {
        ...
        this.h = hVar;
        hVar.e = new o0.b(this, 11);
        af.h hVar2 = new af.h(context);
        this.i = hVar2;
        hVar2.e = new n1.d(this, 14);
        this.k = new t0(Looper.getMainLooper(), 1);
        r5.b bVar3 = f.u;
        o5.a aVar3 = bVar.f;
        if (aVar3 != null && (fVar = aVar3.d) != null) {
            ...
            if (oVar != null) {
                ...
                if (a2 == null || a2.isEmpty()) {
                    Log.e(bVar3.a, bVar3.d(o5.e.class.getSimpleName().concat(" doesn't provide any action."), new Object[0]));
                } else if (a2.size() > 5) {
                    Log.e(bVar3.a, bVar3.d(o5.e.class.getSimpleName().concat(" provides more than 5 actions."), new Object[0]));
                } else if (b10 == null || (b10.length) == 0) {
                    Log.e(bVar3.a, bVar3.d(o5.e.class.getSimpleName().concat(" doesn't provide any actions for compact view."), new Object[0]));
                } else {
                    for (int i10 : b10) {
                        if (i10 < 0 || i10 >= size) {
                            Log.e(bVar3.a, bVar3.d(o5.e.class.getSimpleName().concat("provides a compact view action whose index is out of bounds."), new Object[0]));
                            break;
                        }
                    }
                }
    ...
    */
                ...
                if (castDevice != null && hVar2 != null && d0Var != null && (d = hVar2.d()) != null && (lVar = d.d) != null) {
                    ...
                    if (e9 != null) {
                        ...
                        if (i10 == 1 || i10 == 2 || i10 == 3) {
                            ...
                            Integer num = (Integer) e9.J.get(e9.c);
                            if (num != null) {
                                boolean z12 = num.intValue() > 0;
                                if (num.intValue() < e9.C.size() - 1) {
                                    z11 = z12;
                                    z10 = true;
                                } else {
                                    z11 = z12;
                        ...
                        ge.b bVar2 = new ge.b(z13, i11, string, str, d0Var.a.b, z10, z11);
                        boolean z14 = z13;
                        boolean z15 = z10;
                        boolean z16 = z11;
                        bVar = fVar.k;
                        if (bVar != null || z14 != bVar.a || i11 != bVar.b || !r5.a.d(string, (String) bVar.f) || !r5.a.d(str, (String) bVar.g) || z15 != bVar.c || z16 != bVar.d) {
                            fVar.k = bVar2;
                            fVar.b();
                        }
                        i6 i6Var2 = new i6((list != null || list.isEmpty()) ? null : (x5.a) list.get(0));
                        uri = (Uri) i6Var2.b;
                        i6Var = fVar.l;
                        if (i6Var != null || !r5.a.d(uri, (Uri) i6Var.b)) {
                            af.h hVar3 = fVar.i;
                            hVar3.e = new i6(15, fVar, i6Var2);
                            hVar3.C(uri);
                        }
                    }
                    z10 = false;
                    ...
                    ge.b bVar22 = new ge.b(z13, i112, string2, str2, d0Var.a.b, z10, z11);
                    boolean z142 = z13;
                    boolean z152 = z10;
                    boolean z162 = z11;
                    bVar = fVar.k;
                    ...
                    fVar.k = bVar22;
                    fVar.b();
                    i6 i6Var22 = new i6((list != null || list.isEmpty()) ? null : (x5.a) list.get(0));
                    uri = (Uri) i6Var22.b;
                    i6Var = fVar.l;
                    if (i6Var != null) {
                    }
                    af.h hVar32 = fVar.i;
                    hVar32.e = new i6(15, fVar, i6Var22);
                    hVar32.C(uri);
                }
            }
            if (hVar.k()) {
    ...
    public final long c(String str, int i10, Bundle bundle) {
        ...
        if (hashCode != -945151566) {
            ...
            if (hVar2 != null && hVar2.h()) {
                r e10 = hVar2.e();
                l.h(e10);
                if ((64 & e10.n) != 0 || e10.B != 0) {
                    return 32L;
                }
                Integer num2 = (Integer) e10.J.get(e10.c);
                if (num2 != null && num2.intValue() < e10.C.size() - 1) {
                    return 32L;
                }
            }
    ...
    public final Uri d(m5.l lVar) {
        ...
        List list = lVar.a;
        x5.a aVar2 = (list == null || list.isEmpty()) ? null : (x5.a) lVar.a.get(0);
        if (aVar2 == null) {
            return null;
        }
        return aVar2.b;
    ...
    public final void e(Bitmap bitmap, int i10) {
        ...
        android.support.v4.media.c cVar = a2 == null ? new android.support.v4.media.c() : new android.support.v4.media.c(a2);
    ...
    */
    ...
    public final void j(int i10, MediaInfo mediaInfo) {
        ...
        android.support.v4.media.c cVar = a3 == null ? new android.support.v4.media.c() : new android.support.v4.media.c(a3);
        cVar.d(j11, "android.media.metadata.DURATION");
        if (string != null) {
