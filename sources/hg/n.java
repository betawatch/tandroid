...
public final class n extends q {
    ...
    public final void N(float f7, float f10, boolean z10) {
        ...
        int length = ((ig.e) this.h0).b.length;
        ...
        while (i12 <= i11) {
            for (int i15 = 0; i15 < size; i15++) {
                float[] fArr = this.I1;
                fArr[i15] = fArr[i15] + ((ig.a) ((ig.e) this.h0).d.get(i15)).a[i12];
                this.K1 += ((ig.a) ((ig.e) this.h0).d.get(i15)).a[i12];
                if (this.L1 && ((o) arrayList.get(i15)).n && ((ig.a) ((ig.e) this.h0).d.get(i15)).a[i12] > 0) {
                    this.L1 = false;
                }
            }
            i12++;
        ...
        while (i10 < size) {
            ...
            float f12 = this.K1;
            ValueAnimator e = g.e(oVar.r, f12 == 0.0f ? 0.0f : this.I1[i10] / f12, new t1(3, this, oVar));
            oVar.s = e;
            e.start();
            i10++;
        }
    ...
    */
    ...
    public final void n(Canvas canvas) {
        ...
        ig.b bVar = nVar.h0;
        if (bVar != null) {
            int length = ((ig.e) bVar).b.length;
            ArrayList arrayList = nVar.d;
            int size = arrayList.size();
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ((jg.f) arrayList.get(i11)).j = 0;
            }
            float length2 = (1.0f / ((ig.e) nVar.h0).b.length) * nVar.C0;
            int i12 = 0;
            while (i12 < length) {
                float z10 = e2.z(nVar.C0, length2, ((ig.e) nVar.h0).b[i12], length2 / 2.0f);
                int i13 = 1;
                int i14 = 0;
                float f12 = 0.0f;
                int i15 = 0;
    ...
    @Override // hg.q, hg.g, android.view.View
