...
public final class v0 extends m2 {
        ...
        if (v51Var.g && !v0Var.v.h(v51Var)) {
            ...
            if (v51Var.a == 13) {
                ...
                if (user.bot_business) {
                    v0Var.M = user;
                    AndroidUtilities.hideKeyboard(v0Var.f);
                    v0Var.c.Y2.N(true);
                    v0Var.Y(true);
                    return;
                }
            ...
            if (i10 == h0) {
                final int i12 = 5;
                v0Var.X(i10, !v0Var.J.edit_username, new Runnable(v0Var) { // from class: hg.n0
            ...
            if (i10 == j0) {
                final int i13 = 0;
                v0Var.X(i10, !v0Var.J.view_gifts, new Runnable(v0Var) { // from class: hg.n0
                    public final /* synthetic */ v0 b;
            ...
            if (i10 == k0) {
                final int i14 = 1;
                v0Var.X(i10, !v0Var.J.sell_gifts, new Runnable(v0Var) { // from class: hg.n0
                    public final /* synthetic */ v0 b;
            ...
            if (i10 == l0) {
                final int i15 = 2;
                v0Var.X(i10, !v0Var.J.change_gift_settings, new Runnable(v0Var) { // from class: hg.n0
                    public final /* synthetic */ v0 b;
            ...
            if (i10 == m0) {
                final int i16 = 3;
                v0Var.X(i10, !v0Var.J.transfer_and_upgrade_gifts, new Runnable(v0Var) { // from class: hg.n0
                    public final /* synthetic */ v0 b;
                ...
                final int i17 = 4;
                v0Var.X(i10, !v0Var.J.transfer_stars, new Runnable(v0Var) { // from class: hg.n0
                    public final /* synthetic */ v0 b;
    ...
    public final void X(int i10, boolean z10, final Runnable runnable) {
        ...
        if (!this.K && i10 == h0 && z10) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Allow), new org.telegram.ui.ActionBar.z1(this) { // from class: hg.t0
                public final /* synthetic */ v0 b;
        ...
        alertDialog$Builder2.k(LocaleController.getString(R.string.Allow), new org.telegram.ui.ActionBar.z1(this) { // from class: hg.t0
            public final /* synthetic */ v0 b;
            ...
            @Override // org.telegram.ui.ActionBar.z1
            public final void f(org.telegram.ui.ActionBar.a2 a2Var22, int i13) {
                switch (i11) {
                    case 0:
                        this.b.K = true;
                        runnable.run();
    ...
    public final boolean Z() {
        ...
        if (this.T) {
            ...
            if (z10 == (tL_connectedBot != null)) {
                if ((user == null ? 0L : user.id) == (tL_connectedBot != null ? tL_connectedBot.bot_id : 0L) && (user == null || (this.J.equals(tL_connectedBot.rights) && ((c0Var = this.v) == null || !c0Var.g())))) {
                }
            }
            return true;
        }
