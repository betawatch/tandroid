...
public final /* synthetic */ class s0 implements Runnable {
        ...
        switch (i10) {
            ...
            default:
                ...
                if (m2Var2 != null && m2Var2.getParentActivity() != null) {
                    if (tL_error != null) {
                        e5.f0(i11, tL_error, m2Var2, tL_messages_hideChatJoinRequest, new Object[0]);
                        break;
                    } else {
    ...
    public /* synthetic */ s0(File file, ArrayList arrayList, m2 m2Var, wn wnVar, TLRPC.Document document, boolean z10, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        this.f = file;
        this.e = arrayList;
        this.b = m2Var;
        this.c = wnVar;
    ...
    public /* synthetic */ s0(zg1 zg1Var, TLRPC.TL_error tL_error, boolean z10, TLObject tLObject, byte[] bArr, String str, TL_account.passwordInputSettings passwordinputsettings) {
        this.f = zg1Var;
        this.b = tL_error;
        this.d = z10;
        this.c = tLObject;
