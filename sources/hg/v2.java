...
public class v2 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public v2(Context context, int i10, BirthdayController.BirthdayState birthdayState, int i11, g6 g6Var) {
        ...
        int i12 = k6.h5;
        fixNavigationBar(k6.v0(i12, g6Var));
        ...
        p2 p2Var = new p2(getContext(), g6Var);
        this.Y = p2Var;
        ...
        viewGroup.addView(p2Var, 0, c6.f(-2.0f, 55, i13, 0, i13, 0));
        ViewGroup viewGroup2 = this.containerView;
        int i14 = this.backgroundPaddingLeft;
        viewGroup2.addView(q2Var, c6.f(-2.0f, 55, i14, 0, i14, 0));
        ...
        aVar.setBackgroundColor(k6.v0(i12, g6Var));
        if (i11 == 4) {
            ...
            linearLayout.setBackground(k6.Y(getThemedColor(k6.i6), 6, 6));
            np npVar = new np(context, 24, g6Var);
            this.Z = npVar;
            npVar.b(k6.Oh, k6.j7, k6.k7);
            npVar.setDrawUnchecked(true);
            npVar.a(false, false);
            npVar.setDrawBackgroundAsArc(10);
            linearLayout.addView(npVar, c6.t(26, 26, 16, 0, 0, 0, 0));
            TextView textView = new TextView(context);
            textView.setTextColor(getThemedColor(k6.j5));
            ...
            final int i16 = 0;
            linearLayout.setOnClickListener(new View.OnClickListener(this) { // from class: hg.k2
        ...
        final int i17 = 1;
        s2Var.setOnClickListener(new View.OnClickListener(this) { // from class: hg.k2
            public final /* synthetic */ v2 b;
        ...
        if (i11 == 4) {
            ...
            viewGroup4.addView(aVar, c6.f(-2.0f, 87, i18, 0, i18, 0));
        }
        ...
        if (view instanceof lg.n) {
            ...
            if (i10 == 0 || i10 == 2) {
                if (UserObject.areGiftsDisabled(j10)) {
                    new qc(v2Var.container, g6Var).Q(R.raw.error, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserDisallowedGifts, DialogObject.getShortName(j10)))).j();
                    return;
                }
                lh.g2 g2Var = new lh.g2(v2Var.getContext(), i11, j10, p0.c(p0.b(1, v2Var.o0)), new h2(v2Var, true ? 1 : 0));
            ...
            if (i10 == 4 && hashSet.isEmpty()) {
                ...
                if (callback2 != null) {
                    np npVar = v2Var.Z;
                    callback2.run(Boolean.valueOf(npVar != null && npVar.a.q), hashSet);
                    v2Var.A0 = null;
                }
                v2Var.dismiss();
                return;
            ...
            if (z4 != z10) {
                ...
                aVar.animate().alpha(z10 ? 1.0f : 0.0f).translationY(z10 ? 0.0f : AndroidUtilities.dp(12.0f)).setInterpolator(pr.h).setDuration(320L).withEndAction(!z10 ? new g2(v2Var, true ? 1 : 0) : null).start();
                ig.h hVar = v2Var.m0;
                boolean z11 = !z10;
                if (hVar.x != z11) {
                    hVar.x = z11;
                    AndroidUtilities.forEachViews((RecyclerView) hVar.f, (h5.d) new ig.f(z11));
                }
            }
            v2Var.W();
    ...
    public static void S(final v2 v2Var, final TLRPC.User user, View view) {
        ...
        final int i10 = 0;
        F.c(R.drawable.profile_discuss, LocaleController.getString(R.string.SendMessage), new Runnable(v2Var) { // from class: hg.j2
            public final /* synthetic */ v2 b;
                        ...
                        if (user2 != null) {
                            ...
                            if (p2Var != null) {
                                ...
                                if (U != null) {
                                    ...
                                    U.showAsSheet(new xn(bundle2), n2Var);
                                    break;
                                }
                            }
                        }
        ...
        final int i11 = 1;
        F.c(R.drawable.msg_openprofile, LocaleController.getString(R.string.OpenProfile), new Runnable(v2Var) { // from class: hg.j2
            public final /* synthetic */ v2 b;
    ...
    public static void U(v2 v2Var, String str) {
        ...
        v2Var.u0 = ConnectionsManager.getInstance(v2Var.currentAccount).sendRequest(tL_contacts_search, new gf.a(v2Var, 4));
    }
        ...
        while (i11 < size) {
            ...
            if (user != null && !user.bot && !UserObject.isService(user.id)) {
                ...
                if (j10 != 0 && !this.z0.contains(Long.valueOf(j10))) {
                    ...
                    ig.g c3 = ig.g.c(user, hashSet.contains(Long.valueOf(user.id)));
                    Y(c3);
                    arrayList3.add(c3);
                }
            }
    ...
    /* JADX WARN: Type inference failed for: r2v2, types: [hg.i2] */
    /* JADX WARN: Type inference failed for: r3v1, types: [hg.i2] */
    public final ig.g Y(ig.g gVar) {
        int i10 = this.U;
        if (i10 != 4) {
            gVar.n = i10 == 3 ? null : new dg.n(6, this, gVar.c);
            return gVar;
        }
        ...
        final int i11 = 0;
        ?? r22 = new View.OnClickListener(this) { // from class: hg.i2
            public final /* synthetic */ v2 b;
        ...
        final int i12 = 1;
        ?? r32 = new View.OnClickListener(this) { // from class: hg.i2
            public final /* synthetic */ v2 b;
        ...
        if (hashSet.size() != 0) {
            ...
            if (!isEmpty || i10 == 0 || i10 == 2 || i10 == 4) {
                ...
                if (arrayList2.size() == 1) {
                    ...
                    lh.g2 g2Var = new lh.g2(getContext(), this.currentAccount, j10, c3, new h2(this, r5 ? 1 : 0));
    ...
    */
    public final void h0(boolean z4, boolean z10) {
        ...
        if (isEmpty) {
            if (this.B0 && i14 == 3) {
                if (this.v0 == null) {
                    pq pqVar = new pq(k6.K(AndroidUtilities.dp(46.0f), k6.v0(k6.Oh, this.resourcesProvider)), getContext().getResources().getDrawable(R.drawable.mini_gram_72).mutate());
            ...
            if ((i14 == 0 || i14 == 2) && (currentUser = UserConfig.getInstance(this.currentAccount).getCurrentUser()) != null) {
                arrayList2.add(ig.g.b(LocaleController.getString(R.string.Gift2MyselfSection)));
                ig.g c3 = ig.g.c(currentUser, hashSet3.contains(Long.valueOf(currentUser.id)));
            ...
            if (arrayList4.isEmpty()) {
                    ...
                    if (user != null) {
                        ...
                        if (j11 != 0 && !user.self && !user.bot && !UserObject.isService(j11) && !UserObject.isDeleted(user) && (birthdayState2 == null || !birthdayState2.contains(user.id))) {
                            if (!hashSet2.contains(Long.valueOf(user.id))) {
                                ...
                                ig.g c10 = ig.g.c(user, hashSet3.contains(Long.valueOf(user.id)));
                                Y(c10);
                                arrayList5.add(c10);
                            }
                        }
                ...
                if (!arrayList5.isEmpty()) {
                    ...
                    gVar = ig.g.b(LocaleController.getString(R.string.GiftPremiumFrequentContacts));
                    arrayList2.add(gVar);
                            ...
                            if (j12 == clientUserId || j12 == j10 || ((birthdayState2 != null && birthdayState2.contains(j12)) || hashSet2.contains(Long.valueOf(tL_contact.user_id)))) {
                                ...
                                if (user2 != null && !user2.bot) {
                                    ...
                                    if (!UserObject.isService(user2.id)) {
                                        ...
                                        ig.g c11 = ig.g.c(user2, hashSet3.contains(Long.valueOf(user2.id)));
                                        Y(c11);
                                        arrayList7.add(c11);
                                    }
                                    size = i20;
                    ...
                    if (gVar != null && arrayList3.size() > 0 && !hashSet3.isEmpty()) {
                        ...
                        dg.n nVar = new dg.n(5, this, arrayList3);
                        gVar.h = string4;
                        gVar.m = nVar;
                    }
                }
            ...
            if (gVar != null) {
                ...
                dg.n nVar2 = new dg.n(5, this, arrayList3);
                gVar.h = string42;
                gVar.m = nVar2;
            }
        } else {
                ...
                if (tLObject instanceof TLRPC.User) {
                    ...
                    if (!user3.bot && !UserObject.isService(user3.id)) {
                        ...
                        if (!hashSet2.contains(Long.valueOf(user3.id))) {
                            ig.g c12 = ig.g.c(user3, hashSet3.contains(Long.valueOf(j13)));
                            Y(c12);
                            arrayList2.add(c12);
                            size3 = i12;
                            i13 = 3;
    ...
    public final void i0(boolean r10, boolean r11) {
        ...
        L68:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: hg.v2.i0(boolean, boolean):void");
    }
