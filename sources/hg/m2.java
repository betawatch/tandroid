...
public final /* synthetic */ class m2 implements ll0, h5.j, MessagesStorage.BooleanCallback, uc0, ImageReceiver.ImageReceiverDelegate, y4, kl0, jl0, org.telegram.ui.ActionBar.c2, wc0, fl0 {
    ...
    public void I(int i10, int i11, boolean z4) {
        switch (this.a) {
            case 6:
                AndroidUtilities.runOnUIThread(new j3.v(i10, this.b, (mo) this.c, 7), 16L);
                break;
            default:
                AndroidUtilities.runOnUIThread(new j3.v(i10, this.b, (io) this.c, 8), 16L);
                break;
        }
    }
        ...
        switch (this.a) {
            case 10:
                ...
                if (!arrayList.isEmpty()) {
                    MessagesController.getInstance(this.b).openByUserName("spambot", (org.telegram.ui.ActionBar.p2) l.d.i(1, arrayList), 1);
                    break;
                }
                break;
            case 11:
