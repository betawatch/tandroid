...
public abstract class p0 {
    ...
    public static void k(ArrayList arrayList, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, org.telegram.ui.ActionBar.p2 p2Var, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        if (h()) {
            ...
            b6.h hVar = new b6.h();
            hVar.c = "inapp";
            hVar.b = tL_premiumGiftCodeOption.store_product;
            BillingController.getInstance().queryProductDetails(Arrays.asList(hVar.a()), new d0(tL_inputStorePaymentPremiumGiftCode, tL_premiumGiftCodeOption, connectionsManager, callback2, callback, p2Var, 0));
            return;
        }
        ...
        connectionsManager2.sendRequest(tL_payments_getPaymentForm, new e0(callback2, messagesController2, tL_inputInvoicePremiumGiftCode, p2Var, callback, 1));
    }
