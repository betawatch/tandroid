...
public class q extends g {
    ...
    public void k(Canvas canvas) {
        ...
        if (this.h0 != null) {
            ...
            while (true) {
                ...
                ((jg.i) arrayList.get(i21)).f.reset();
                ((jg.i) arrayList.get(i21)).g.reset();
                i21++;
            }
            canvas.save();
            boolean[] zArr = this.G1;
            if (zArr == null || zArr.length < ((ig.e) this.h0).d.size()) {
                this.G1 = new boolean[((ig.e) this.h0).d.size()];
                this.H1 = new float[((ig.e) this.h0).d.size()];
            }
            int i22 = this.y0;
            if (i22 == 2) {
                f11 = this.z0.f / 0.6f;
            ...
            float[] fArr = ((ig.e) this.h0).b;
            int i23 = ((int) (f33 / (fArr.length < 2 ? 1.0f : fArr[1] * f32))) + 1;
            int max = Math.max(0, (this.F - i23) - 1);
            int min = Math.min(((ig.e) this.h0).b.length - 1, this.G + i23 + 1);
            int i24 = max;
            float f35 = 0.0f;
            boolean z12 = false;
            float f36 = 0.0f;
            while (true) {
                ...
                while (i27 < arrayList.size()) {
                    jg.f fVar = (jg.f) arrayList.get(i27);
                    int i28 = i27;
                ...
                while (i30 < arrayList.size()) {
                    jg.f fVar2 = (jg.f) arrayList.get(i30);
                    float f42 = f35;
                    boolean z14 = fVar2.n;
                    Path path2 = fVar2.f;
                    if (z14) {
            ...
            for (int size = arrayList3.size() - 1; size >= 0; size--) {
                jg.f fVar3 = (jg.f) arrayList3.get(size);
                Paint paint = fVar3.c;
                paint.setAlpha(i32);
    ...
    public void n(Canvas canvas) {
        ...
        if (this.h0 != null) {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                ((jg.i) arrayList.get(i11)).g.reset();
            }
            ig.b bVar2 = this.h0;
            int i12 = ((ig.e) bVar2).n;
            boolean[] zArr = this.G1;
            if (zArr == null || zArr.length < ((ig.e) bVar2).d.size()) {
                this.G1 = new boolean[((ig.e) this.h0).d.size()];
            }
            boolean z12 = false;
            for (int i13 = 0; i13 < i12; i13++) {
                ...
                for (int i16 = 0; i16 < arrayList.size(); i16++) {
                    ...
                    if (fVar.n || fVar.o != 0.0f) {
                        if (((ig.e) this.h0).m[i16][i13] > 0) {
                            f10 += ((ig.e) r12).m[i16][i13] * fVar.o;
                            i14++;
                        }
                        i15 = i16;
                    }
                ...
                while (i18 < arrayList.size()) {
                    jg.f fVar2 = (jg.f) arrayList.get(i18);
                    boolean z13 = fVar2.n;
                    Path path = fVar2.g;
                    if (!z13 && fVar2.o == 0.0f) {
                        i10 = i12;
                    } else if (i14 == 1) {
                        if (((ig.e) this.h0).m[i18][i13] != 0) {
                            f7 = fVar2.o;
                            i10 = i12;
                            z10 = z12;
                            ...
                            bVar = this.h0;
                            if (((ig.e) bVar).m[i18][i13] == 0 || i13 <= 0 || ((ig.e) bVar).m[i18][i13 - 1] != 0 || i13 >= i17 || ((ig.e) bVar).m[i18][i13 + 1] != 0) {
                                if (this.G1[i18]) {
                                    path.lineTo(f11, i19);
                                }
                                path.lineTo(f11, f14);
                        ...
                        if (f10 != 0.0f) {
                            i10 = i12;
                            z10 = z12;
                            f7 = (((ig.e) this.h0).m[i18][i13] * fVar2.o) / f10;
                            if (f7 == 0.0f) {
                            }
                            int i1922 = this.B0;
            ...
            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                jg.f fVar3 = (jg.f) arrayList.get(size2);
    ...
    */
    public void q(jg.j jVar) {
        ...
        int i11 = 2;
        int i12 = 1;
        int i13 = ((int) (f14 / (((ig.e) bVar).b.length < 2 ? 1.0f : ((ig.e) bVar).b[1] * f13))) + 1;
        int max = Math.max(0, (this.F - i13) - 1);
        int min = Math.min(((ig.e) this.h0).b.length - 1, this.G + i13 + 1);
        this.z0.g = new float[((ig.e) this.h0).d.size()];
        this.z0.h = new float[((ig.e) this.h0).d.size()];
        this.z0.i = new float[((ig.e) this.h0).d.size()];
        this.z0.j = new float[((ig.e) this.h0).d.size()];
        this.z0.k = new float[((ig.e) this.h0).d.size()];
        int i14 = 0;
        while (i14 < i11) {
                ...
                if (fVar2.n || fVar2.o != 0.0f) {
                    ...
                    if (i17 == i12) {
                        if (jArr[i15] != 0) {
                            f7 = fVar2.o;
                            i10 = i14;
                            float f17 = (((ig.e) this.h0).b[i15] * f13) - f15;
                        ...
                        i10 = i14;
                        f7 = 0.0f;
                        float f172 = (((ig.e) this.h0).b[i15] * f13) - f15;
                        ...
                        if (f16 != 0.0f) {
                            ...
                            float f1722 = (((ig.e) this.h0).b[i15] * f13) - f15;
                        ...
                        i10 = i14;
                        f7 = 0.0f;
                        float f17222 = (((ig.e) this.h0).b[i15] * f13) - f15;
