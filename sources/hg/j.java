...
public final class j extends FrameLayout {
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.a) {
            case 0:
                ...
                c6 c6Var = (c6) this.d;
                m mVar = (m) this.e;
                float d = c6Var.d(mVar.r.getWidth(), false);
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.a) {
            case 0:
                m mVar = (m) this.e;
                mVar.r.measure(i10, i11);
                invalidate();
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(Math.max(this.b, AndroidUtilities.dp(36.0f) + mVar.r.getMeasuredHeight()), TLObject.FLAG_30));
                if (this.b < 0) {
