...
public final /* synthetic */ class r0 implements Runnable {
    ...
    public /* synthetic */ r0(u0 u0Var, TLRPC.TL_error tL_error, TLObject tLObject, int[] iArr, ArrayList arrayList, boolean z10, TLRPC.User user) {
        this.f = u0Var;
        this.b = tL_error;
        this.c = tLObject;
        this.h = iArr;
    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                PhotoViewer.t1().f2(arrayList2, 0, 11, false, new mx0(), (bo) obj3);
            ...
            default:
                ...
                if (o2Var2 != null && o2Var2.getParentActivity() != null) {
                    if (tL_error != null) {
                        c5.f0(i11, tL_error, o2Var2, tL_messages_hideChatJoinRequest, new Object[0]);
                        break;
                    } else {
    ...
    public /* synthetic */ r0(File file, ArrayList arrayList, o2 o2Var, bo boVar, TLRPC.Document document, boolean z10, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        this.f = file;
        this.e = arrayList;
        this.b = o2Var;
        this.c = boVar;
    ...
    public /* synthetic */ r0(SendMessagesHelper sendMessagesHelper, TLRPC.TL_error tL_error, TLObject tLObject, boolean z10, ArrayList arrayList, ArrayList arrayList2, TLObject tLObject2) {
