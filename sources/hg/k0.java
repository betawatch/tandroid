    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                xs xsVar = (xs) this.d;
                zsVar.d(xsVar.a);
                zsVar.y.remove(xsVar.a);
                zsVar.A();
                zsVar.d(xsVar.b);
                zsVar.y.remove(xsVar.b);
                zsVar.A();
                break;
            case 3:
                ((xu0) this.e).H1 = false;
            ...
            case 4:
                ...
                n2Var.f = false;
                CharSequence charSequence = n2Var.e;
                if (charSequence != null) {
                    if (charSequence.equals("timer")) {
                        n2Var.e(true);
                    } else {
                        textViewArr[1].setText(n2Var.e);
