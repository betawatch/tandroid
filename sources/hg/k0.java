...
public final /* synthetic */ class k0 implements Runnable {
    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                if (tL_error == null) {
                    if (tLObject != null) {
                        BillingController.getInstance().addResultListener(((p2.m) list.get(0)).c, new m0(1, hVar, t0Var2));
            ...
            case 1:
                ...
                if (tL_error2 == null) {
                    if (tLObject2 != null) {
                        BillingController.getInstance().addResultListener(((p2.m) list2.get(0)).c, new m0(0, hVar2, callback2));
            ...
            case 2:
                ...
                if (!(tLObject3 instanceof TLRPC.TL_boolTrue)) {
                    if (!(tLObject3 instanceof TLRPC.TL_boolFalse)) {
                        wVar.run(Boolean.FALSE, tL_error3 != null ? tL_error3.text : "SERVER_ERROR");
                        break;
                    } else {
                    ...
                    BillingController.getInstance().addResultListener(mVar.c, new m0(3, hVar3, wVar));
            ...
            case 3:
                ...
                if (!(tLObject4 instanceof TLRPC.TL_boolTrue)) {
                    ...
                    BillingController.getInstance().addResultListener(mVar2.c, new m0(2, hVar4, i5Var));
                    ...
                    d4Var.run(str, new Utilities.Callback2() { // from class: wh.c
                        ...
                        public final void run(Object obj, Object obj2) {
                            ...
                            if (TextUtils.equals(str, strArr[0])) {
                                ...
                                g6 g6Var2 = g6Var;
                                if (booleanValue) {
                                    imageView2.setColorFilter(new PorterDuffColorFilter(k6.v0(k6.q7, g6Var2), PorterDuff.Mode.SRC_IN));
                                    if (!z4) {
                                        int[] iArr2 = iArr;
                                        int i10 = -iArr2[0];
                                        iArr2[0] = i10;
    ...
    public /* synthetic */ k0(TLObject tLObject, p2.m mVar, p2.h hVar, Utilities.Callback2 callback2, Activity activity, TLRPC.InputStorePaymentPurpose inputStorePaymentPurpose, List list, TLRPC.TL_error tL_error, int i10) {
        this.a = i10;
        this.c = tLObject;
        this.h = mVar;
        this.e = hVar;
