    ...
    public j1(Context context, e6 e6Var) {
        ...
        for (int i11 = 7; i10 < i11; i11 = 7) {
            if (i10 == 0) {
                ...
                this.h[i10].setTextColor(j6.v0(j6.z6, e6Var));
                x5Var.addView(this.h[i10], y5.i(-2.0f, -2.0f, 8388659, 0.0f, 33.0f, 0.0f, 10.0f));
                ...
                for (int i12 = 0; i12 < 2; i12++) {
                    ...
                    this.n[i10][i12].setTextColor(j6.v0(j6.z6, e6Var));
                ...
                for (int i13 = 0; i13 < 2; i13++) {
                    ...
                    this.c[i13].setTextColor(j6.v0(j6.z6, e6Var));
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.z6, e6Var), PorterDuff.Mode.SRC_IN));
                ...
                ViewGroup e = wh.e(context, 0);
                this.h[i10] = new TextView(context);
                this.h[i10].setTextSize(1, 14.0f);
                this.h[i10].setTextColor(j6.v0(j6.G6, e6Var));
                this.h[i10].setGravity(LocaleController.isRTL ? 5 : 3);
                ...
                for (int i15 = 0; i15 < 2; i15++) {
                    ...
                    this.n[i10][i15].setTextColor(j6.v0(j6.z6, e6Var));
                    this.n[i10][i15].setGravity(LocaleController.isRTL ? 3 : 5);
                    frameLayout2.addView(this.n[i10][i15], y5.e(-1, -1, 119));
                }
                if (LocaleController.isRTL) {
                    e.addView(frameLayout2, y5.q(-2, -1, 51));
                    e.addView(this.h[i10], y5.q(-1, -1, 53));
                } else {
                    e.addView(this.h[i10], y5.q(-2, -1, 51));
                    e.addView(frameLayout2, y5.q(-1, -1, 53));
                }
                this.f[i10] = e;
                addView(e, y5.u(-1.0f, -2.0f, 51, 18.0f, i10 == 1 ? 1.0f : 11.66f, 28.0f, i10 == 6 ? 16.66f : 0.0f));
            }
            i10++;
        }
    ...
    public final void b(TL_account.TL_businessWorkHours tL_businessWorkHours, boolean z10, boolean z11, boolean z12) {
        ...
        if (!tL_businessWorkHours.weekly_open.isEmpty()) {
            ...
            if (z14) {
                ...
                textViewArr3[1].animate().alpha((z18 || !z19) ? 0.0f : 1.0f).setDuration(320L).setInterpolator(qrVar).start();
                textViewArr[0][0].animate().alpha(z18 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(qrVar).start();
                textViewArr[0][1].animate().alpha(z18 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(qrVar).start();
                imageView.animate().rotation(z18 ? 180.0f : 0.0f).setDuration(320L).setInterpolator(qrVar).start();
            } else {
                    ...
                    if (i26 < textViewArr4.length) {
                        if (i11 != 0 || z18) {
                            if ((i26 == i22) == z19) {
                                f10 = 1.0f;
                                if (this.y) {
                                    textViewArr4[i26].animate().alpha(f10).setDuration(320L).setInterpolator(qr.h).start();
                                } else {
            ...
            dqVar.c(LocaleController.getString(!z19 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
            this.y = false;
            ...
            Collections.sort(arrayList2, new a4.e(15));
        ...
        dqVar2.c(LocaleController.getString(!z19 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
        this.y = false;
