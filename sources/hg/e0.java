    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                break;
            case 3:
                AndroidUtilities.runOnUIThread(new lh.e1(tLObject, obj5, obj4, obj3, obj2, obj, 9));
                break;
            case 4:
                ...
                if (!(tLObject instanceof TLRPC.Updates)) {
                    ...
                    while (true) {
                        ...
                        if (i11 >= size) {
                            ...
                            AndroidUtilities.runOnUIThread(new uf0(xf0Var, i12));
                            break;
                        } else {
                            Object obj6 = findUpdatesAndRemove.get(i11);
                            i11++;
                            AndroidUtilities.runOnUIThread(new if0((Object) xf0Var, (Object) tL_inputStorePaymentAuthCode, obj6, i12));
                        }
                    }
                }
                break;
