...
public final class g1 extends o2 implements NotificationCenter.NotificationCenterDelegate {
    public f61 a;
    public pr b;
    ...
    public static void U(g1 g1Var, TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        g1Var.b.a(0.0f);
        org.telegram.messenger.w1.p(R.string.UnknownError, vc.a0(g1Var), null);
    }
    ...
    public static void V(g1 g1Var, ArrayList arrayList) {
        ...
        while (true) {
            ...
            if (i12 >= arrayListArr.length) {
                ...
                arrayList.add(j51.f(LocaleController.getString(R.string.BusinessHoursTimezone), f2.b(g1Var.currentAccount).d(g1Var.r, false), -2));
    ...
    public static ArrayList[] Z(ArrayList arrayList) {
        ...
        while (i15 < 7) {
            ...
            if (i19 >= i18) {
                int i21 = (i15 + 6) % 7;
                if (!arrayListArr[i21].isEmpty() && ((f1) k0.h(1, arrayListArr[i21])).b >= 1440) {
                    ((f1) k0.h(1, arrayListArr[i21])).b = 1439;
                }
                ...
                if (!arrayListArr[i15].isEmpty() && !arrayListArr[i22].isEmpty()) {
                    f1 f1Var = (f1) k0.h(1, arrayListArr[i15]);
    ...
    public final void X(int i10) {
        if ((this.h[i10].isEmpty() ? null : (f1) k0.h(1, this.h[i10])) == null) {
            return;
        }
        int i11 = (i10 + 6) % 7;
        f1 f1Var = this.h[i11].isEmpty() ? null : (f1) k0.h(1, this.h[i11]);
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        this.b = new pr(mutate, new tp(j6.w0(null, i10, false)));
        ...
        f61 f61Var = new f61(this, new bi.v(this, 27), new d5(this, 3), null);
        this.a = f61Var;
        f61Var.q1();
        f61 f61Var2 = this.a;
        f61Var2.Y2.r = false;
