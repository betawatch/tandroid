...
public abstract class g extends View implements i {
    ...
    /* JADX WARN: Type inference failed for: r1v10, types: [hg.b] */
    /* JADX WARN: Type inference failed for: r1v9, types: [hg.b] */
    public g(Context context, f6 f6Var) {
        ...
        this.L0 = new ValueAnimator.AnimatorUpdateListener(this) { // from class: hg.b
        ...
        this.M0 = new ValueAnimator.AnimatorUpdateListener(this) { // from class: hg.b
            public final /* synthetic */ g b;
    ...
    public final void E(long j3, long j10, boolean z10, boolean z11, boolean z12) {
        ...
        if (currentTimeMillis - this.b1 >= 320 || z11) {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                jg.d dVar = (jg.d) arrayList.get(i11);
                if (dVar != f7) {
                    dVar.g = dVar.f;
                }
            }
            ValueAnimator e = e(0.0f, 255.0f, new t1(i10, this, f7));
            this.b0 = e;
            e.addListener(new u3(4, this, f7));
            this.b0.start();
        }
    }
    ...
    public final void F() {
        ...
        if (f10 != f11) {
            ...
            if (f12 > 1.0f) {
                ...
                float f13 = this.T0;
                this.v = (wr.g.getInterpolation(f12) * (f11 - f13)) + f13;
            }
            invalidate();
        }
        if (this.P0) {
            ...
            if (f14 != f15) {
                ...
                if (f16 > 1.0f) {
                    ...
                    float f17 = this.U0;
                    this.w = (wr.g.getInterpolation(f16) * (f15 - f17)) + f17;
                }
                invalidate();
            }
        }
    ...
    public jg.d f(int i10, long j3, long j10) {
        return new jg.d(j3, j10, this.P0, this.h0.h, i10, this.N, this.O);
    }
    ...
    public void j(Canvas canvas) {
        ...
        while (true) {
            ...
            int i15 = ((jg.b) arrayList.get(this.n0)).a;
            if (i15 == 0) {
                i15 = 1;
            }
                    ...
                    if (i19 < jArr.length - i12) {
                        ...
                        if (f15 > 0.0f) {
                            ...
                            if (f15 <= f16 + f12) {
                                ...
                                if (f15 < f17) {
                                    textPaint.setAlpha((int) (i10 * a2.y(f17, f15, f17, f7) * this.h * f10));
                                } else if (f15 > f16) {
                                    textPaint.setAlpha((int) (i10 * a2.y(f15, f16, f12, f7) * this.h * f10));
                                } else {
    ...
    */
    public void l(Canvas canvas, jg.d dVar) {
        float f7;
        int i10;
        int i11;
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void p(Canvas canvas, jg.d dVar) {
        float f7;
        int i10;
        int i11;
        TextPaint textPaint;
    ...
    public long r(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            if (((jg.f) arrayList.get(i12)).n) {
                long rMaxQ = ((jg.f) arrayList.get(i12)).a.b.rMaxQ(i10, i11);
                if (rMaxQ > j3) {
                    j3 = rMaxQ;
                }
            }
    ...
    public long s(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            if (((jg.f) arrayList.get(i12)).n) {
                long rMinQ = ((jg.f) arrayList.get(i12)).a.b.rMinQ(i10, i11);
                if (rMinQ < j3) {
                    j3 = rMinQ;
                }
            }
        ...
        while (true) {
            ...
            if (fVar.n && fVar.o != 1.0f) {
                ...
                if (valueAnimator4 == null || !valueAnimator4.isRunning()) {
                    final int i12 = 0;
                    ValueAnimator e = e(fVar.o, 1.0f, new ValueAnimator.AnimatorUpdateListener(this) { // from class: hg.c
                        public final /* synthetic */ g b;
            ...
            if (!fVar.n && fVar.o != 0.0f && ((valueAnimator = fVar.i) == null || !valueAnimator.isRunning())) {
                final int i13 = 1;
                ValueAnimator e7 = e(fVar.o, 0.0f, new ValueAnimator.AnimatorUpdateListener(this) { // from class: hg.c
                    public final /* synthetic */ g b;
