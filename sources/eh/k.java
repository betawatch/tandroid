...
public final class k extends Drawable {
    ...
    public static void g(View view, boolean z10, int i10, int i11, AtomicReference atomicReference, int i12, Layout layout, List list, Canvas canvas, boolean z11) {
        ...
        while (it2.hasNext()) {
            ...
            kVar.p = false;
            if (z13) {
                kVar.h(i0.b.d(Math.max(0.0f, kVar.n), i10, (i12 == 1 ? layout.getPaint() : g6.o2).getColor()));
            } else {
                kVar.h(i10);
            }
            kVar.draw(canvas);
    ...
    public final void e(Path path) {
        path.addCircle(this.k, this.l, h7.n.a(this.n, 0.0f, 1.0f) * this.m, Path.Direction.CW);
    }
    ...
    public final void h(int i10) {
        ...
        while (true) {
            ...
            if (i11 >= fArr.length) {
                ...
                this.a[i11].setColor(i0.b.k(i10, (int) (this.s * fArr[i11])));
                i11++;
            }
        }
    }
    ...
    public final void j(float f10, float f11, float f12, boolean z10) {
        ...
        ValueAnimator duration = ValueAnimator.ofFloat(this.n, z10 ? 0.0f : 1.0f).setDuration((long) h7.n.a(this.m * 0.3f, 250.0f, 550.0f));
        this.r = duration;
        duration.setInterpolator(this.t);
        this.r.addUpdateListener(new b(this, alpha, 0));
        this.r.addListener(new r1(this, 4));
        this.r.start();
        invalidateSelf();
    }
