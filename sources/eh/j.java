...
public final class j extends Drawable implements DownloadController.FileDownloadProgressListener, fo0 {
    ...
    public final void c(boolean z4) {
        ...
        if (svgDrawable != null) {
            svgDrawable.setColorKey(z4 ? k6.Pb : k6.qe);
        }
        boolean z10 = this.U;
        ...
        if (messageMedia != null && !(messageMedia instanceof TLRPC.TL_messageMediaEmpty)) {
            if (messageMedia instanceof TLRPC.TL_messageMediaPhoto) {
                ...
                if (messageMedia.geo != null) {
                    if (this.K == null) {
                        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(R.raw.map_placeholder, k6.Pb, (k6.I.q() ? 3 : 6) * 0.12f);
                        this.K = svgThumb;
                        svgThumb.setAspectCenter(true);
                        this.L = new eq(this.K);
                    }
                    if (this.M == null) {
