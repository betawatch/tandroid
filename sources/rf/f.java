...
public final class f implements a3.b, z, n {
    ...
    public boolean A(k.a aVar, MenuItem menuItem) {
        return ((ActionMode.Callback) this.b).onActionItemClicked(s(aVar), new r((Context) this.c, (l0.a) menuItem));
    }
    ...
    public boolean B(k.a aVar, Menu menu) {
        ...
        if (menu2 == null) {
            menu2 = new a0((Context) this.c, (l.k) menu);
            kVar.put(menu, menu2);
        }
    ...
    public ne.f C(String str) {
        ...
        eVar.f(eVar.n);
        oe.a P0 = eVar.j.P0(new f7.b(22, eVar.k, eVar.m));
    ...
    public void D() {
        ...
        e eVar = (e) ((ArrayDeque) this.b).pollFirst();
        this.c = eVar;
        if (eVar == null) {
            return;
        }
    ...
    public Task H(Callable callable) {
        Task continueWith;
        synchronized (this.d) {
            continueWith = ((Task) this.c).continueWith((Executor) this.b, new ja.c(callable, 13));
            this.c = continueWith.continueWith((Executor) this.b, new z9.d(8));
        }
        return continueWith;
    }
    ...
    public Task I(Callable callable) {
        ...
        synchronized (this.d) {
            continueWithTask = ((Task) this.c).continueWithTask((Executor) this.b, new ja.c(callable, 13));
            this.c = continueWithTask.continueWith((Executor) this.b, new z9.d(8));
        }
    ...
    public Object get() {
        ...
        af.d dVar2 = (af.d) ((af.d) this.d).get();
    ...
    public boolean y(int i10, v vVar) {
        ...
        m mVar = (m) this.d;
        if (mVar.a == i10 && d0.a(mVar.b, vVar2)) {
            return true;
        }
        this.d = new m(v0Var.d.c, i10, vVar2);
        return true;
    }
    ...
    public f(c5.j jVar) {
        ...
        this.c = arrayList3;
        bVar.P0(new f7.b(22, arrayList3, Collections.EMPTY_MAP));
    }
