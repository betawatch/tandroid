...
public class b {
    ...
    public b(JSONObject jSONObject) {
        ...
        for (int i9 = 0; i9 < jSONArray.length(); i9++) {
            ...
            if (jSONArray2.getString(0).equals("x")) {
                ...
                while (i10 < length) {
                    int i11 = i10 + 1;
                    this.a[i10] = jSONArray2.getLong(i11);
                    i10 = i11;
                }
            } else {
                a aVar = new a();
                ...
                while (i12 < length2) {
                    int i13 = i12 + 1;
                    aVar.a[i12] = jSONArray2.getLong(i13);
                    long j10 = aVar.a[i12];
                    if (j10 > aVar.e) {
                        aVar.e = j10;
                    }
            ...
            if (optJSONObject != null) {
                ...
                if (matcher.matches()) {
                    if (!TextUtils.isEmpty(matcher.group(1))) {
                        aVar2.g = e5.s("statisticChartLine_" + matcher.group(1).toLowerCase());
                    }
    ...
    public final int c(float f10) {
        int length;
        int i9 = 0;
        if (f10 == 0.0f || (length = this.b.length) < 2) {
            return 0;
        }
        int i10 = length - 1;
        while (i9 <= i10) {
    ...
    public void e() {
        ...
        if (length == 1) {
            ...
            for (int i9 = 0; i9 < length; i9++) {
                this.b[i9] = (this.a[i9] - j10) / (j11 - j10);
            }
        }
        for (int i10 = 0; i10 < this.d.size(); i10++) {
            if (((a) this.d.get(i10)).e > this.e) {
                this.e = ((a) this.d.get(i10)).e;
            }
            if (((a) this.d.get(i10)).f < this.f) {
                this.f = ((a) this.d.get(i10)).f;
            }
            ((a) this.d.get(i10)).b = new SegmentTree(((a) this.d.get(i10)).a);
        }
        long j12 = this.k;
        this.c = new String[((int) ((j11 - j10) / j12)) + 10];
        ...
        while (true) {
            ...
            if (i11 >= strArr.length) {
                float f10 = this.k;
                long[] jArr2 = this.a;
                this.g = f10 / (jArr2[jArr2.length - 1] - jArr2[0]);
                return;
            } else {
                if (this.k == 1) {
                    strArr[i11] = String.format(Locale.ENGLISH, "%02d:00", Integer.valueOf(i11));
                } else {
                    strArr[i11] = simpleDateFormat.format(new Date((i11 * this.k) + j10));
                }
                i11++;
            }
        }
