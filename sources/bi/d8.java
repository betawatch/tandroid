...
public final class d8 extends l8 {
    ...
    public d8(int i10, String str, String str2) {
    ...
    public final boolean q(final int i10, final List list, final boolean z10) {
        ...
        if (isEmpty) {
            ...
            if (tLObject == null) {
                MessagesController.getInstance(i11).getUserNameResolver().resolve(str2, new e2.h() { // from class: bi.c8
                    @Override // e2.h
                    public final void accept(Object obj) {
                        d8 d8Var = d8.this;
                        g8 g8Var = d8Var.q;
                        TLObject userOrChat = MessagesController.getInstance(d8Var.c).getUserOrChat(d8Var.D);
                        d8Var.G = false;
                        if (userOrChat != null) {
                            d8Var.q(i10, list, z10);
                            return;
                        }
                        d8Var.J = 0;
                        d8Var.H = "";
        ...
        this.I = ConnectionsManager.getInstance(i11).sendRequest(tL_stories_searchPosts, new v7(this, 1));
        return true;
    }
    ...
    public d8(int i10, TL_stories.MediaArea mediaArea) {
        super(i10, 0L, 3, -1, null);
        this.F = new ArrayList();
        this.H = "";
        this.C = null;
