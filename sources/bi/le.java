...
public final class le extends Path {
    ...
    public final void a(float f7, float f10, float f11, float f12, float f13, float f14, ArrayList arrayList) {
        ...
        if (Math.abs(this.e - f12) <= 1.0f && Math.abs(this.f - f13) <= 0.01f && Math.abs(this.g - 0.0f) <= 0.1f && Math.abs(this.h - f14) <= 1.0f && Math.abs(this.i - f15) <= 1.0f && Math.abs(this.j - f10) <= 1.0f && Math.abs(this.k - f16) <= 1.0f) {
            ...
            if (arrayList2 != null && arrayList2.size() == arrayList.size()) {
                for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                    if (((Integer) arrayList2.get(i10)).intValue() == (arrayList.get(i10) == null ? 0 : ((fe) arrayList.get(i10)).b)) {
                    }
                }
            }
            ...
            for (int i11 = 0; i11 < arrayList3.size(); i11++) {
                if (((Float) arrayList3.get(i11)).floatValue() != (arrayList.get(i11) == null ? 0.0f : ((fe) arrayList.get(i11)).a.d(((fe) arrayList.get(i11)).c, false))) {
                    return;
                }
            }
        }
        ...
        while (i12 < arrayList.size()) {
            i12 = com.google.android.gms.internal.vision.e2.d(arrayList.get(i12) == null ? 0 : ((fe) arrayList.get(i12)).b, i12, 1, this.c);
        }
        ...
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            this.d.add(Float.valueOf(arrayList.get(i13) == null ? 0.0f : ((fe) arrayList.get(i13)).a.d(((fe) arrayList.get(i13)).c, false)));
        }
        this.i = f15;
        this.j = f10;
        this.k = f16;
        ...
        for (int i15 = 0; i15 < arrayList.size(); i15++) {
            if (arrayList.get(i15) != null) {
                i14 = Math.max(i14, ((fe) arrayList.get(i15)).b);
            }
        }
        ...
        while (max <= min) {
            ...
            for (int i17 = 0; i17 < arrayList.size(); i17++) {
                short s10 = (arrayList.get(i17) == null || max >= ((fe) arrayList.get(i17)).b) ? (short) 0 : ((fe) arrayList.get(i17)).d[max];
    ...
    public final void b(float f7, float f10, float f11, float f12, long j3, float f13, float f14, float f15, fe feVar) {
        ...
        int i10 = feVar.b;
        org.telegram.ui.Components.d6 d6Var = feVar.a;
        float d = d6Var.d(feVar.c, false);
        ...
        this.e = f13;
        this.h = f15;
        float d10 = d6Var.d(feVar.c, false);
        rewind();
        float round = Math.round(AndroidUtilities.dpf2(3.3333f));
        ...
        while (max <= min) {
            ...
            float f20 = f14 <= 0.0f ? 0.0f : (feVar.d[max] / f14) * f13 * 0.6f;
