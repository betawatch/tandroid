...
public final /* synthetic */ class j0 implements Utilities.Callback3 {
        ...
        switch (this.a) {
            case 0:
                ...
                if (((Boolean) obj2).booleanValue()) {
                    ...
                    deletegroupcallparticipantmessages.participant = MessagesController.getInstance(i10).getInputPeer(e1Var.c);
                    ...
                    ArrayList arrayList2 = e3Var.s;
                    int i11 = 0;
                    boolean z10 = false;
                    while (i11 < arrayList.size()) {
                        if (((e1) arrayList.get(i11)).c == j3) {
                            e1 e1Var2 = (e1) arrayList.get(i11);
                            int i12 = 0;
                            while (true) {
                                if (i12 < arrayList2.size()) {
                                    if (((f1) arrayList2.get(i12)).f.contains(e1Var2)) {
                                        ((f1) arrayList2.get(i12)).f.remove(e1Var2);
                ...
                if (bool2.booleanValue()) {
                    if (e3Var.M >= 0) {
                        ...
                        MessagesController.getInstance(i10).deleteParticipantFromChat(-e3Var.M, MessagesController.getInstance(i10).getInputPeer(e1Var.c), false, true);
                        return;
                    }
                }
                return;
            case 1:
                ...
                if (o8Var != null) {
                    ...
                    o8Var2.u0 = 1.0f;
                    pcVar.u();
                    if (pcVar.X0 == null || (rbVar = pcVar.v1) == null) {
                        pVar.a(false);
                        return;
                    }
                    rg.d2 m0 = rbVar.m0(pcVar.K1.p0, true);
                ...
                if (tVar != null) {
                    try {
                        ...
                        if (i13 < 23) {
                            ...
                            if (uVar != null) {
                                str2 = !TextUtils.isEmpty(sVar.g) ? new String(uVar.b.doFinal(Utilities.hexToBytes(sVar.g)), StandardCharsets.UTF_8) : sVar.g;
