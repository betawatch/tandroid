...
public final class e7 implements sy {
    ...
    public final boolean k() {
        pg.b editText = ((pg.v2) this.a.J0).getEditText();
    ...
    public final void l(String str) {
        ...
        pg.j jVar = this.a.J0;
        if ((jVar instanceof pg.v2) && (editText = (v2Var = (pg.v2) jVar).getEditText()) != null) {
    ...
    public final void n() {
        r7 r7Var = this.a;
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(r7Var.getContext(), 0, r7Var.G1);
        ...
        alertDialog$Builder.k(LocaleController.getString(R.string.ClearButton), new a1.c(this, 9));
