...
public final class x7 extends FrameLayout {
    ...
    public x7(Activity activity, int i10, zh.b bVar) {
        ...
        x2Var.a.getAvatarDrawable().m(i10, currentUser);
        gg.i1 i1Var = x2Var.a;
        i1Var.e(currentUser, i1Var.getAvatarDrawable());
        x2Var.b.l(Emoji.replaceEmoji(UserObject.getUserName(currentUser), x2Var.b.getPaint().getFontMetricsInt(), false), false);
