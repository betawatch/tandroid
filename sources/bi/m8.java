...
public final class m8 extends View implements l3 {
    ...
    public final org.telegram.ui.Components.d6 t0;
    public boolean u0;
    ...
    public m8(Activity activity) {
        ...
        this.h0 = new org.telegram.ui.Components.d6(this, 0L, 200L, wr.f);
        this.m0 = new org.telegram.ui.Components.d6(this, 0L, 350L, wrVar);
        this.n0 = -1.0f;
        this.o0 = true;
        this.p0 = new org.telegram.ui.Components.d6(this, 0L, 350L, wrVar);
        this.q0 = new org.telegram.ui.Components.d6(this, 0L, 850L, wrVar);
        this.s0 = new float[2];
        this.t0 = new org.telegram.ui.Components.d6(this, 0L, 350L, wrVar);
        this.B0 = new org.telegram.ui.Components.d6(this, 0L, 350L, wrVar);
        this.C0 = new org.telegram.ui.Components.d6(this, 0L, 650L, wrVar);
        this.D0 = new org.telegram.ui.Components.d6(this, 0L, 160L, wr.i);
    ...
    public final void h() {
        ...
        if (k8Var != null) {
            ...
            if (arrayList2 != null && !arrayList2.isEmpty() && ((r9) arrayList2.get(0)).O0 != null) {
                this.b.setImage(ImageLocation.getForPath(((r9) arrayList2.get(0)).O0.getAbsolutePath()), "80_80", null, null, this.c, 0L, null, null, 0);
                return;
            }
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d14 = this.C0.d((abs >= dp || !(this.r0 || xcVar2.h)) ? 0.0f : 1.0f, false) * d13;
        ...
        float lerp4 = AndroidUtilities.lerp(xcVar2.a(this.o0 ? 0.0f : 0.2f), (this.h0.d(this.g0, false) * 0.2f) + f14, d11);
        ...
        if (e10 <= 0.0f) {
            ...
            zp.a(this.s0, (SystemClock.elapsedRealtime() - this.v0) % 5400);
            invalidate();
            float[] fArr = this.s0;
            float f48 = fArr[0];
            float f49 = fArr[c10];
        ...
        float a10 = xcVar3.a(0.2f) * f33 * f16;
        if (a10 > 0.0f) {
            canvas3.save();
        ...
        if (d19 > 0.0f) {
            canvas3.save();
            float a11 = xcVar4.a(0.2f) * d19 * f16;
            canvas3.scale(a11, a11, this.l0, this.j0);
            canvas3.rotate(d6Var2.d(this.M, false) - getRotation(), this.l0, this.j0);
        ...
        if (d19 < 1.0f) {
            canvas3.save();
            f25 = f16;
            float A = org.telegram.messenger.a2.A(1.0f, d19, xcVar4.a(0.2f), f25);
        ...
        if (i10 > 0 || f28 > 0.0f) {
            float a12 = xcVar3.a(0.2f) * f18 * f29;
            canvas3.save();
            Path path3 = this.O0;
            path3.rewind();
            if (i10 > 0) {
            ...
            float a13 = xcVar.a(0.2f) * f29;
            canvas3.save();
            canvas3.scale(a13, a13, this.l0, this.j0);
            canvas3.rotate(d6Var.d(this.M, false) - getRotation(), this.l0, this.j0);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (z10) {
            ...
            xcVar2.c(c(clamp, y3, this.i0, this.j0, AndroidUtilities.dp(60.0f), false));
            xcVar3.c(c(clamp, y3, this.l0, this.j0, (float) AndroidUtilities.dp(30.0f), true) && !b());
            xcVar.c(c(clamp, y3, this.k0, this.j0, (float) AndroidUtilities.dp(30.0f), false) && !b());
        }
        j8 j8Var = this.M0;
        j8 j8Var2 = this.L0;
        if (action == 0) {
            this.w0 = true;
            this.x0 = xcVar2.h || xcVar3.h;
            ...
            if (action == 1 || action == 3) {
                if (this.w0) {
                    ...
                    boolean z12 = this.r0;
                    if (!z12 && xcVar.h) {
                        ce ceVar2 = ((sc) this.a).a;
                        if (ceVar2.f0 == 0 && !ceVar2.P1 && !ceVar2.Q1 && ce.b(ceVar2)) {
                            ceVar2.f(true);
                        }
                    } else if (z12 && this.z0) {
                        if (xcVar.h) {
                        ...
                        if (b()) {
                            ...
                            this.u0 = true;
                            ((sc) this.a).d(false);
                        } else if (ce.d(((sc) this.a).a)) {
                            this.R = 0L;
                            this.Q = System.currentTimeMillis();
                            this.A0 = false;
                            ((sc) this.a).e(new j8(this, 1), false);
                        }
                    }
                    this.z0 = false;
                    if (xcVar3.h) {
