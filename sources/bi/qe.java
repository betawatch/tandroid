...
public final class qe extends View {
    ...
    public final void a(boolean z10) {
        if (this.c || !z10) {
            ...
            animate().cancel();
            if (z10) {
                em.q(animate().translationY(AndroidUtilities.dp(6.0f)).alpha(0.0f).scaleX(0.8f).scaleY(0.8f), wr.h, 220L);
                return;
            }
