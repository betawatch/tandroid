...
public final class e1 {
    ...
    public e1(r9 r9Var) {
        ...
        this.q = r9Var.j0;
        this.r = j3;
        r9Var.n0.getValues(fArr);
        this.t = r9Var.A0;
        this.u = r9Var.B0;
        CharSequence[] charSequenceArr = {r9Var.C0};
        this.w = r9Var.D0 ? MediaDataController.getInstance(r9Var.a).getEntities(charSequenceArr, true) : null;
        ...
        this.i0 = r9Var.L0;
        this.j0 = r9Var.S;
        this.k0 = VideoEditedInfo.Part.toParts(r9Var);
    }
    ...
    public final r9 a() {
        ...
        if (str4 != null) {
            ...
            r9Var.C0 = MessageObject.replaceAnimatedEmoji(replaceEmoji, this.w, org.telegram.ui.ActionBar.j6.o2.getFontMetricsInt());
        } else {
            r9Var.C0 = "";
        }
        ...
        r9Var.L0 = this.i0;
        r9Var.S = this.j0;
        r9Var.T = VideoEditedInfo.Part.toStoryEntries(this.k0);
        return r9Var;
    }
    ...
    public final void b(NativeByteBuffer nativeByteBuffer) {
        ...
        x xVar = this.j0;
        if (xVar == null || xVar.e.size() <= 1 || (arrayList = this.k0) == null || arrayList.size() <= 1) {
            nativeByteBuffer.writeInt32(TLRPC.TL_null.constructor);
        } else {
            nativeByteBuffer.writeInt32(-559038737);
            nativeByteBuffer.writeString(xVar.a);
                    ...
                    if (nativeByteBuffer.readInt32(true) == 481674261) {
                        ...
                        if (nativeByteBuffer.readInt32(true) == 481674261) {
                            ...
                            if (nativeByteBuffer.remaining() > 0 && nativeByteBuffer.readInt32(true) == -559038737) {
                                this.j0 = new x(nativeByteBuffer.readString(true));
