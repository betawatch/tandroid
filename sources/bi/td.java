...
public final class td extends FrameLayout {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        ce ceVar = this.e;
        if (view == ceVar.h0) {
            float f7 = ceVar.V ? AndroidUtilities.statusBarHeight : 0.0f;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ce ceVar = this.e;
        int i14 = ceVar.V ? ceVar.Z : 0;
        int measuredWidth = getMeasuredWidth();
        int measuredHeight = getMeasuredHeight();
        ceVar.h0.layout(0, 0, ceVar.S, ceVar.T);
        ceVar.h0.setPivotX(ceVar.S * 0.5f);
        FrameLayout frameLayout = ceVar.i0;
        frameLayout.layout(0, i14, ceVar.S, frameLayout.getMeasuredHeight() + i14);
        FrameLayout frameLayout2 = ceVar.k0;
        ...
        ceVar.l0.layout(0, 0, ceVar.S, ceVar.T);
        nc ncVar = ceVar.t0;
        if (ncVar != null) {
            ncVar.layout(0, 0, measuredWidth, measuredHeight);
        }
        ceVar.s.c.layout(0, 0, measuredWidth, measuredHeight);
        k kVar = ceVar.c1.M;
        if (kVar != null) {
        ...
        ad adVar = ceVar.v1;
        if (adVar != null) {
            adVar.layout(0, 0, adVar.getMeasuredWidth(), ceVar.v1.getMeasuredHeight());
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ce ceVar = this.e;
        a(ceVar.h0, ceVar.S, ceVar.T);
        ceVar.j();
        a(ceVar.i0, ceVar.S, AndroidUtilities.dp(150.0f));
        a(ceVar.k0, ceVar.S, AndroidUtilities.dp(220.0f));
        a(ceVar.m0, ceVar.S, ceVar.U);
        a(ceVar.l0, ceVar.S, ceVar.T);
        a(ceVar.s.c, size, size2);
        nc ncVar = ceVar.t0;
        if (ncVar != null) {
            a(ncVar, size, size2);
        }
