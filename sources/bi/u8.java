...
public final class u8 {
    ...
    public u8(int i10) {
        ...
        h9 h9Var = new h9();
        h9Var.a = i10;
        h9Var.b = MessagesStorage.getInstance(i10);
        this.k = h9Var;
        ...
        h9 h9Var2 = this.k;
        h9Var2.b.getStorageQueue().postRunnable(new s8(4, h9Var2, new q7(this, 0)));
        this.K = new ah.g(this, i10, 1);
        this.w = new di.b1(i10);
    }
    ...
    public final l8 A(long j3, int i10, int i11, boolean z10) {
        if (i10 == 0 && i11 > 0) {
            ...
            l8 l8Var2 = new l8(this.a, j3, i10, i11, new o1(this, 3));
        ...
        if (i10 == 4) {
            ...
            b8 b8Var = new b8(this.a, j3, null, new o1(this, 3));
            hashMap4.put(valueOf2, b8Var);
            return b8Var;
        }
        HashMap hashMap5 = hashMapArr[i10];
        Long valueOf3 = Long.valueOf(j3);
        l8 l8Var4 = new l8(this.a, j3, i10, i11, new o1(this, 3));
    ...
    public final f8 B(long j3, boolean z10) {
        ...
        f8 f8Var2 = new f8(this.a, j3, this);
        iVar.k(f8Var2, j3);
        return f8Var2;
    }
    ...
    public final void P() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_contacts_getBlocked, new g7(this, 3));
    }
    ...
    public final void Q(boolean z10) {
        ...
        if ((z10 || !this.q) && !this.n) {
            ...
            ConnectionsManager.getInstance(this.a).sendRequest(tL_stories_getAllStories, new w7(this, z10, tL_stories_getAllStories, z11));
        }
    }
    ...
    public final void R() {
        ...
        this.U = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stories.TL_stories_getChatsToSend(), new g7(this, 2));
    }
    ...
    public final void S(final TL_stories.PeerStories peerStories, final boolean z10) {
        ...
        if (arrayList != null) {
            ...
            ConnectionsManager.getInstance(i11).sendRequest(tL_stories_getStoriesByID, new RequestDelegate() { // from class: bi.n7
    ...
    public final void T() {
        if (this.A) {
            ...
            h9 h9Var = this.k;
            h9Var.b.getStorageQueue().postRunnable(new s8(1, h9Var, q7Var));
        } else {
            Q(false);
            Q(true);
        }
    ...
    public final void Y(TL_stories.TL_stories_allStories tL_stories_allStories, boolean z10, boolean z11, boolean z12) {
        ...
        if (!z11) {
            ...
            h9 h9Var = this.k;
            h9Var.b.getStorageQueue().postRunnable(new i7(h9Var, arrayList4, z12, z10, jVar, 1));
        }
        ah.g gVar = this.K;
    ...
    public final void Z(TL_stories.TL_updateStory tL_updateStory) {
        ...
        if (peerDialogId > 0) {
            ...
            if (user != null && (M(user) || user.self)) {
                h9Var.b.getStorageQueue().postRunnable(new s8(3, h9Var, tL_updateStory));
            }
        } else {
            h9Var.b.getStorageQueue().postRunnable(new s8(3, h9Var, tL_updateStory));
            user = null;
    ...
    public final void b(int i10, long j3, ArrayList arrayList) {
        ...
        while (i14 < size3) {
            ...
            i14++;
            l8 A2 = u8Var.A(B.b, 0, ((m8) obj3).a, false);
            if (A2 != null) {
    ...
    public final void k0(long j3, List list) {
        ...
        while (i10 < size) {
            ...
            i10++;
            l8 A3 = u8Var.A(j3, 0, ((m8) obj).a, false);
            if (A3 != null) {
                A3.A(list);
            }
            u8Var = this;
    ...
    public final void l0(long j3, List list, boolean z10) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                ...
                if (peerStories.stories.get(i12).id == storyItem.id) {
                    ...
                    if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                        ...
                        i2.g.o(storyItem.id, new StringBuilder("StoriesController update story for full peer storyId="));
                    }
                } else {
                    i12++;
                }
            ...
            if (!z11) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    i2.g.o(storyItem.id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z10) {
                    i2.g.o(storyItem.id, new StringBuilder("StoriesController add new story for full peer storyId="));
    ...
    public final void m(TL_stories.PeerStories peerStories) {
        ...
        while (i10 < peerStories.stories.size()) {
            if (p9.w(this.a, peerStories.stories.get(i10))) {
    ...
    */
    ...
    public final void n0(long j3, List list, boolean z10) {
        ...
        while (i10 < size2) {
            int i12 = i10 + 1;
            l8 A3 = u8Var.A(j3, 0, ((m8) arrayList.get(i10)).a, false);
            if (A3 != null) {
                A3.D(list, z10);
            }
            u8Var = this;
    ...
    public final n8 o() {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_stories_canSendStory, new g7(this, 1), 1024);
        return null;
    }
    ...
    public final void q() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stories.TL_stories_getAllReadPeerStories(), new g7(this, 0));
    }
    ...
    public final t8 t(long j3, TL_stories.StoryItem storyItem) {
        ...
        return (t8) hashMap.get(Integer.valueOf(storyItem.id));
    }
