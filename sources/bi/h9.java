...
public final class h9 {
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x024c A[DONT_GENERATE] */
    ...
    */
    public static void a(h9 h9Var, q7 q7Var) {
        ...
        try {
            ...
            try {
                            ...
                            if (byteBufferValue != 0) {
                                ...
                                while (i15 < TLdeserialize.media_areas.size()) {
                                    if (TLdeserialize.media_areas.get(i15) instanceof TL_stories.TL_mediaAreaChannelPost) {
                                        ...
                                        obj2 = obj3;
                                        try {
                                            long j3 = ((TL_stories.TL_mediaAreaChannelPost) TLdeserialize.media_areas.get(i15)).channel_id;
                                ...
                                la.a(TLdeserialize, byteBufferValue2);
                ...
                Collections.sort(tL_stories_allStories.peer_stories, Comparator$-CC.comparingInt(new o6(2)));
                AndroidUtilities.runOnUIThread(new s8(2, q7Var, tL_stories_allStories));
            } catch (Throwable th5) {
                th = th5;
    ...
    public static void b(int i10, long j3, MessageObject messageObject, TL_stories.StoryItem storyItem) {
        ...
        if (i11 == 23 || i11 == 24) {
            b2 b2Var = new b2();
            b2Var.user_id = DialogObject.getPeerDialogId(messageObject.messageOwner.media.peer);
            TLRPC.MessageMedia messageMedia = messageObject.messageOwner.media;
            b2Var.peer = messageMedia.peer;
            b2Var.id = messageMedia.id;
            b2Var.storyItem = c(i10, j3, storyItem);
            TLRPC.Message message2 = messageObject.messageOwner;
            b2Var.via_mention = message2.media.via_mention;
            message2.media = b2Var;
        }
