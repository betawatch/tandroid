...
public class x4 extends View {
    ...
    public float o0;
    public final org.telegram.ui.Components.xc p0;
    ...
    public x4(Context context, int i10) {
        ...
        this.o0 = 1.0f;
        this.p0 = new org.telegram.ui.Components.xc(this, 2.0f, 5.0f);
        this.q0 = new Rect();
        this.r0 = new RectF();
        this.s0 = new RectF();
        this.t0 = new Path();
    ...
    */
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        float d = z10 ? this.O : n6Var.d();
        float f12 = this.I ? this.P : n6Var.e;
        if (this.r) {
            if (this.n == null) {
        ...
        if (this.I) {
            ...
            float f25 = ((f10 + rectF.left) + rectF2.left) - x4Var.N;
            x4Var.R = f25;
        ...
        if (x4Var.r) {
            ...
            x4Var.n.setAlpha((int) (f11 * f7));
            x4Var.n.setBounds((int) ((rectF.right - (rectF2.right * 0.66f)) - r1.getIntrinsicWidth()), (int) (rectF.centerY() - (x4Var.n.getIntrinsicHeight() / 2.0f)), (int) (rectF.right - (rectF2.right * 0.66f)), (int) ((x4Var.n.getIntrinsicHeight() / 2.0f) + rectF.centerY()));
            x4Var.n.draw(canvas2);
        }
        canvas2.restore();
    }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if ((this.T || hasOnClickListeners()) && this.V) {
                    ...
                    if (lineLeft <= f7 && this.L.getLineWidth(lineForVertical) + lineLeft >= f7 && i11 >= 0 && i11 <= this.L.getHeight()) {
                        ...
                        if (clickableSpanArr.length != 0 && !AndroidUtilities.isAccessibilityScreenReaderEnabled()) {
                            ...
                            if (clickableSpan == null && motionEvent.getAction() == 0) {
                                n90 n90Var = new n90(clickableSpan, null, motionEvent.getX(), motionEvent.getY(), 0);
                                this.K0 = n90Var;
                                ...
                                invalidate();
                                AndroidUtilities.runOnUIThread(new v4(this, n90Var, clickableSpan), ViewConfiguration.getLongPressTimeout());
                            ...
                            if (motionEvent.getAction() == 3) {
                                ...
                                long j10 = this.d;
                                if (j10 > 0) {
                                    AndroidUtilities.runOnUIThread(ql0Var, j10);
                                }
                                this.K0 = null;
                            }
                        }
            ...
            if (this.K0 == null) {
                ...
                org.telegram.ui.Components.xc xcVar = this.p0;
                if (action == 0) {
    ...
    public final void u() {
        if (this.V && this.U) {
            ...
            this.n0.addListener(new h(this, 3));
            this.n0.setInterpolator(wr.k);
