...
public final class f5 extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void c(Runnable runnable, boolean z10) {
        ...
        d dVar = e5Var.b;
        e5Var.animate().alpha(this.y ? 1.0f : 0.0f).setInterpolator(wr.h).setDuration(320L).withEndAction(new ai.j(2, this, z10)).start();
        dVar.setVisibility((!z10 || runnable == null) ? 8 : 0);
        dVar.setOnClickListener(runnable == null ? null : new ai.v(1, runnable));
    }
        ...
        if (this.s != j3) {
            ...
            if (j3 == 0) {
                ...
                if (j3 > 0) {
                    ...
                    int d = user != null ? org.telegram.ui.Components.g9.d(user.id) : i0.a.d(0.2f, -16777216, -1);
                    w9Var.getImageReceiver().setImage(ImageLocation.getForPath(absolutePath), "500_500_nocache", forUser, "50_50_b2", null, null, new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[]{i0.a.d(0.2f, d, -16777216), i0.a.d(0.4f, d, -16777216)}), 0L, null, user, 0);
                } else {
                    ...
                    int d10 = chat != null ? org.telegram.ui.Components.g9.d(chat.id) : i0.a.d(0.2f, -16777216, -1);
                    w9Var.getImageReceiver().setImage(ImageLocation.getForPath(absolutePath), "500_500_nocache", forChat, "50_50_b2", null, null, new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[]{i0.a.d(0.2f, d10, -16777216), i0.a.d(0.4f, d10, -16777216)}), 0L, null, chat, 0);
                }
            }
        }
        this.s = j3;
        this.v = vVar;
        if (this.r && vVar != null && !vVar.a) {
            vVar.a = true;
            vVar.b();
        }
        boolean z10 = (vVar == null || (t0Var2 = (zh.t0) vVar.b) == null || !t0Var2.n()) ? false : true;
        if (vVar == null || (t0Var = (zh.t0) vVar.b) == null || !t0Var.a()) {
            c5Var = null;
        } else {
            zh.t0 t0Var3 = (zh.t0) vVar.b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.liveStoryUpdated) {
            ...
            k2.v vVar = this.v;
            if (vVar == null || (t0Var = (zh.t0) vVar.b) == null || t0Var.g() != longValue) {
                return;
            }
            boolean n10 = ((zh.t0) this.v.b).n();
            if (((zh.t0) this.v.b).a()) {
                zh.t0 t0Var2 = (zh.t0) this.v.b;
    ...
    public final void e(boolean z10, boolean z11) {
        if (z10 || !z11) {
            if (z11) {
                em.q(getTextureView().animate().alpha(z10 ? 1.0f : 0.0f), wr.h, 320L);
            } else {
