...
public final class da extends View implements org.telegram.ui.Cells.z9 {
    ...
    public da(ea eaVar, Context context) {
        ...
        this.f = paint2;
        this.r = new ca[]{new ca(this), null};
        this.s = 0;
        new Path();
        this.y = true;
        this.H = false;
    ...
    public final void b(CharSequence charSequence, z9 z9Var, z9 z9Var2, boolean z10, boolean z11) {
        ...
        ca[] caVarArr = this.r;
        if (MediaDataController.stringsEqual(caVarArr[0].n, charSequence)) {
            ca caVar = caVarArr[0];
            if (caVar.o == z9Var && caVar.p == z9Var2) {
                caVar.q = z10;
                invalidate();
                return;
            }
        ...
        caVar2.g(caVar3.n, caVar3.o, caVar3.p);
        ca caVar4 = caVarArr[1];
        ca caVar5 = caVarArr[0];
        caVar4.q = caVar5.q;
        caVar4.r.d(caVar5.r.c, true);
        caVarArr[0].g(charSequence, z9Var, z9Var2);
        ca caVar6 = caVarArr[0];
        caVar6.q = z10;
        caVar6.r.d(0.0f, true);
        this.G = 1.0f;
    ...
    /* JADX WARN: Type inference failed for: r8v14, types: [bi.z9] */
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        boolean z14;
        ea eaVar = this.J;
        org.telegram.ui.Cells.aa aaVar = eaVar.W;
        if (motionEvent.getAction() == 0) {
            eaVar.g0 = motionEvent.getX();
            eaVar.h0 = motionEvent.getY();
        }
        eaVar.i0 = motionEvent.getX();
        eaVar.j0 = motionEvent.getY();
        if (this.v != null) {
            ...
            if (rectF.contains(motionEvent.getX(), motionEvent.getY())) {
                ...
                caVarArr = this.r;
                caVar = caVarArr[0];
                if (caVar != null || (z9Var = caVar.o) == null) {
                    r13 = 0;
                    z11 = false;
                    i10 = 0;
                } else {
                    i10 = AndroidUtilities.dp(8.0f) + z9Var.b();
                    RectF rectF2 = AndroidUtilities.rectTmp;
                    int i11 = this.E;
                    int i12 = this.F;
                    z9 z9Var2 = caVarArr[0].o;
                    rectF2.set(i11, i12, i11 + z9Var2.x, z9Var2.b() + i12);
                    z11 = rectF2.contains(motionEvent.getX(), motionEvent.getY());
                    if (z11) {
                        z10 = false;
                    }
                    if (motionEvent.getAction() == 0 && z11) {
                        caVarArr[0].o.e(motionEvent.getX(), motionEvent.getY(), true);
                    } else if (motionEvent.getAction() == 2) {
                        z9 z9Var3 = caVarArr[0].o;
                        if (z9Var3.i.h && !z11) {
                            r13 = 0;
                            z9Var3.e(motionEvent.getX(), motionEvent.getY(), false);
                        }
                    } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                        if (motionEvent.getAction() == 1 && z11) {
                            z14 = false;
                            z14 = false;
                            z9 z9Var4 = caVarArr[0].o;
                            if (z9Var4.i.h) {
                                eaVar.I(z9Var4);
                            }
                        } else {
                        ...
                        caVarArr[z14 ? 1 : 0].o.e(motionEvent.getX(), motionEvent.getY(), z14);
                        r13 = z14;
                    }
                    r13 = 0;
                }
                if (!z11 && (caVar3 = caVarArr[r13]) != null && caVar3.p != null) {
                    RectF rectF3 = AndroidUtilities.rectTmp;
                    float f10 = this.E;
                    float lerp = (AndroidUtilities.lerp(caVar3.m, caVar3.l, this.w) + this.F) - caVarArr[0].p.b();
                    int i13 = this.E;
                    ca caVar4 = caVarArr[0];
                    rectF3.set(f10, lerp, i13 + caVar4.p.x, AndroidUtilities.lerp(caVar4.m, caVar4.l, this.w) + this.F);
                    contains = rectF3.contains(motionEvent.getX(), motionEvent.getY());
                    if (contains) {
                        z10 = false;
                    }
                    if (motionEvent.getAction() != 0 && contains) {
                        caVarArr[0].p.e(motionEvent.getX(), motionEvent.getY(), true);
                    } else if (motionEvent.getAction() != 2) {
                        z9 z9Var5 = caVarArr[0].p;
                        if (z9Var5.i.h && !contains) {
                            z9Var5.e(motionEvent.getX(), motionEvent.getY(), false);
                        }
                    } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                        if (motionEvent.getAction() == 1 && contains) {
                            r132 = 0;
                            r132 = 0;
                            z9 z9Var6 = caVarArr[0].p;
                            if (z9Var6.i.h) {
                                eaVar.I(z9Var6);
                            }
                        } else {
                        ...
                        caVarArr[r132].p.e(motionEvent.getX(), motionEvent.getY(), r132);
                    }
                    if (contains) {
                        return true;
                    }
                }
                if (z10 && (eaVar.v0 || (caVar2 = caVarArr[0]) == null || caVar2.g == null)) {
                    float f11 = this.E;
                    float f12 = this.F + i10;
                    Rect rect = aaVar.B;
                    org.telegram.ui.Cells.z9 z9Var7 = aaVar.u0;
                    staticTextLayout = z9Var7.getStaticTextLayout();
                ...
                if (aaVar.y() && z10 && this.y) {
                    z13 = false;
                    if (((GestureDetector) caVarArr[0].k.a.b).onTouchEvent(motionEvent)) {
        ...
        if (!z11) {
            ...
            float f102 = this.E;
            float lerp2 = (AndroidUtilities.lerp(caVar3.m, caVar3.l, this.w) + this.F) - caVarArr[0].p.b();
            int i132 = this.E;
            ca caVar42 = caVarArr[0];
            rectF32.set(f102, lerp2, i132 + caVar42.p.x, AndroidUtilities.lerp(caVar42.m, caVar42.l, this.w) + this.F);
        ...
        if (z10) {
            ...
            Rect rect2 = aaVar.B;
            org.telegram.ui.Cells.z9 z9Var72 = aaVar.u0;
            staticTextLayout = z9Var72.getStaticTextLayout();
            if (staticTextLayout != null) {
            }
            aaVar.N(motionEvent);
        }
    ...
    public float getAnimatedHeight() {
        int i10 = this.F * 2;
        ca[] caVarArr = this.r;
        int i11 = caVarArr[0].l;
        return AndroidUtilities.lerp(i11, caVarArr[1] != null ? r1.l : 0, this.G) + i10;
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        org.telegram.ui.Components.z5.release(daVar, caVar.f);
        if (caVar.h == null) {
            return;
        }
        while (true) {
            ...
            if (aaVar != null) {
                org.telegram.ui.Components.z5.release(daVar, aaVar.a);
            }
            i10++;
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i14 = this.F * 2;
        int i15 = caVarArr[0].l;
        ca caVar2 = caVarArr[1];
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.lerp(i15, caVar2 != null ? caVar2.l : 0, this.G) + i14, TLObject.FLAG_30));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x0109, code lost:
        ...
        r9 = r1.a;
        r6.W.f(false);
        r4.postDelayed(new bi.s8(10, r1, r9), android.view.ViewConfiguration.getLongPressTimeout());
        r4 = true;
     */
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ca[] caVarArr;
        if (!this.J.s0 && (caVarArr = this.r) != null) {
            ca caVar = caVarArr[0];
            if (caVar.e != null) {
                a90 a90Var = caVar.c;
                da daVar = caVar.v;
                StaticLayout staticLayout = daVar.v;
                ea eaVar = daVar.J;
                if (staticLayout != null) {
                    RectF rectF = AndroidUtilities.rectTmp;
                    float f7 = daVar.n;
                    rectF.set(f7, daVar.h, staticLayout.getWidth() + f7, daVar.h + daVar.v.getHeight());
                }
            }
        }
        return false;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        ...
        if ((caVar2 == null || (caVar2.s != drawable && (((z9Var3 = caVar2.o) == null || z9Var3.j != drawable) && ((z9Var4 = caVar2.p) == null || z9Var4.j != drawable)))) && ((caVar = caVarArr[1]) == null || (caVar.s != drawable && (((z9Var = caVar.o) == null || z9Var.j != drawable) && ((z9Var2 = caVar.p) == null || z9Var2.j != drawable))))) {
