...
public final class y extends Drawable {
    ...
    public y() {
        ...
        this.e = paint3;
        this.g = new org.telegram.ui.Components.d6(new kc0(this, 1), 320L, wr.h, 0);
    ...
    public y(x xVar, boolean z10) {
        ...
        while (i12 < size) {
            ...
            float f19 = f17 + f16;
            float f20 = dpf26;
            rectF2.set(f12 + f11, f19, org.telegram.ui.Cells.r6.a(max, i15 + 1, f7, f12), org.telegram.ui.Cells.r6.a(max2, i14 + 1, f13, f17));
