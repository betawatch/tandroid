...
public abstract class v extends o {
    ...
    public v(Context context, FrameLayout frameLayout, aw0 aw0Var, FrameLayout frameLayout2, zh.b bVar, org.telegram.ui.Components.ia iaVar) {
        ...
        wr wrVar2 = wr.h;
        this.s1 = new org.telegram.ui.Components.d6(pVar, 350L, wrVar2);
        this.t1 = new RectF();
        this.u1 = new RectF();
        this.v1 = new RectF();
        this.w1 = new Path();
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        t tVar;
        Drawable drawable;
        if (this.O1 && (tVar = this.D1) != null && tVar.a != null && (drawable = this.Y0) != null) {
            ...
            if (motionEvent.getAction() == 2) {
                if (!this.K1) {
                    ...
                    if (!z10 && !this.K1 && this.c1 >= 1.0f) {
                        ...
                        if (tVar2 != null) {
                            tVar2.x = true;
                            AndroidUtilities.cancelRunOnUIThread(tVar2.h);
                            CameraController.getInstance().stopVideoRecording(tVar2.a.getCameraSessionRecording(), false, false);
                            tVar2.a(false);
                        }
                        AndroidUtilities.runOnUIThread(pVar, 800L);
        ...
        ce ceVar = qdVar.S1;
        if (!isCameraAllowed ? false : ce.d(ceVar)) {
            ...
            tVar3.n = new od(0, qdVar, tVar3);
            tVar3.r = new p(qdVar, 2);
            kd kdVar = ceVar.h0;
            ceVar.q1 = tVar3;
            kdVar.addView(tVar3, w7.a6.c(-1.0f, -1));
            return true;
        }
        return true;
    }
    ...
    public final void j(Canvas canvas, RectF rectF) {
        ...
        if (this.D1 != null) {
            ...
            if (f7 > 0.0f) {
                ...
                float a2 = com.google.android.gms.internal.vision.e2.a(1.0f, this.c1, AndroidUtilities.dp(6.0f) * sin, (rectF.centerX() - ((this.x1.l() + AndroidUtilities.dp(11.33f)) / 2.0f)) - (AndroidUtilities.lerp(this.c1, 1.0f, e7) * (rectF.width() / 6.0f)));
                ...
                f12 = 15.0f;
                f13 = 0.0f;
                this.x1.c(a2 + AndroidUtilities.dp(11.33f), rectF.centerY(), 1.0f, l1, canvas3);
            } else {
                f12 = 15.0f;
                f13 = 0.0f;
            }
    ...
    public final void k(Canvas canvas, RectF rectF, float f7) {
        ...
        float lerp = AndroidUtilities.lerp(com.google.android.gms.internal.vision.e2.a(1.0f, e7, getWidth() * 0.35f * this.c1, rectF.right - AndroidUtilities.dp(20.0f)), rectF.left + AndroidUtilities.dp(20.0f), e);
        ...
        float f17 = d6Var.c;
        float f18 = d6Var2.c;
        float A = org.telegram.messenger.a2.A(1.0f, f17, AndroidUtilities.lerp(this.s1.e(this.c1 < 0.4f), 0.0f, f18), f7);
        ...
        if (tVar != null) {
            if (!z10) {
                if (z11) {
                    ...
                    CameraController.getInstance().stopVideoRecording(tVar.a.getCameraSessionRecording(), false, false);
                    tVar.a(false);
                } else {
                    tVar.c();
                }
