    ...
    */
    public final void onDraw(Canvas canvas) {
        if (this.n) {
            ...
            l5 l5Var = this.a;
            if (d < 1.0f) {
                Drawable drawable = l5Var.o;
                Drawable drawable2 = l5Var.o;
            ...
            if (d > 0.0f) {
                Drawable drawable3 = l5Var.p;
                Drawable drawable4 = l5Var.p;
    ...
    public void setReaction(ah.j1 j1Var) {
        String str;
        String str2;
        this.n = j1Var == null || ((str2 = j1Var.f) != null && str2.equals("❤"));
        if (j1Var == null || (str = j1Var.f) == null || !str.equals("❤")) {
            this.b = false;
        } else {
            this.b = true;
        }
        ...
        if (j1Var != null) {
            if (j1Var.g != 0) {
                org.telegram.ui.Components.q5 q5Var2 = new org.telegram.ui.Components.q5(3, UserConfig.selectedAccount, j1Var.g);
                this.f = q5Var2;
                if (this.s) {
                    q5Var2.a(this);
                }
