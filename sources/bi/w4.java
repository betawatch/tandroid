...
public final class w4 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        switch (this.a) {
            case 0:
                canvas.save();
                x4 x4Var = (x4) this.b;
                canvas.drawPath(x4Var.t0, x4Var.b0);
                canvas.restore();
                break;
            case 1:
                canvas.save();
            ...
            case 5:
                ...
                break;
            case 6:
                ((t01) this.b).c(getBounds().centerX() - (((t01) this.b).c / 2.0f), getBounds().centerY(), 1.0f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false), canvas);
                break;
            case 7:
                canvas.save();
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        switch (this.a) {
            case 1:
                ((di.n3) this.b).I0.setColorFilter(colorFilter);
                break;
            case 4:
