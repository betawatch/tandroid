...
public final /* synthetic */ class gc implements Runnable {
    ...
    public /* synthetic */ gc(ce ceVar, TLObject tLObject, TL_stories.TL_startLive tL_startLive, boolean z10, long j3, boolean z11, TLRPC.TL_error tL_error, a3.d dVar) {
        this.e = ceVar;
        this.f = tLObject;
        this.h = tL_startLive;
        this.b = z10;
    ...
    */
    public final void run() {
        ...
        switch (i12) {
                ...
                if (!(tLObject3 instanceof TLRPC.Updates)) {
                    if (tL_error != null) {
                        if (!tL_error.text.startsWith("STORY_LIVE_ALREADY_")) {
                            rb rbVar = ceVar.q0;
                            if (rbVar != null) {
                                new org.telegram.ui.Components.wc(rbVar.container, bVar).d0(tL_error, true);
                                dVar.run();
                                break;
                            }
                        } else {
                            AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(ceVar.b, 0, bVar);
                                    ...
                                    if (inputGroupCall != null) {
                                        ...
                                        if (t0Var != null) {
                                            ...
                                            if (zh.t0.W != null) {
                                                ...
                                                objArr[c10] = Long.valueOf(zh.t0.W.g());
                                                notificationCenter.lambda$postNotificationNameOnUIThread$1(i16, objArr);
                                            }
                                        }
                                        AndroidUtilities.runOnUIThread(new hc(ceVar, this.b, storyItem, this.d, inputGroupCall, this.c), 100L);
                                        break;
                                    }
                                }
                            }
            ...
            default:
                ((boolean[]) obj2)[0] = true;
                ((xh.v5) obj3).i((TL_stars.StarGift) tLObject2, this.b, this.c, this.d, (TLRPC.TL_textWithEntities) tLObject, (wh.m4) obj);
                break;
        }
    }

    public /* synthetic */ gc(xh.v5 v5Var, boolean[] zArr, TL_stars.StarGift starGift, boolean z10, boolean z11, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, wh.m4 m4Var) {
        this.e = v5Var;
        this.f = zArr;
        this.h = starGift;
        this.b = z10;
