...
public final class g5 extends FrameLayout {
    ...
    public /* synthetic */ g5(Context context, int i10) {
        super(context);
        this.a = i10;
    }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            case 13:
                ...
                break;
            case 18:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), TLObject.FLAG_30), wl.C(48.0f, 1, TLObject.FLAG_30));
                break;
            case 20:
    ...
    public g5(u41 u41Var, Context context, int i10, String str, CharSequence charSequence) {
        ...
        f6Var = ((org.telegram.ui.ActionBar.f3) u41Var).resourcesProvider;
        ...
        f6Var2 = ((org.telegram.ui.ActionBar.f3) u41Var).resourcesProvider;
        ...
        f6Var3 = ((org.telegram.ui.ActionBar.f3) u41Var).resourcesProvider;
        d90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, f6Var3));
        int i13 = org.telegram.ui.ActionBar.j6.gc;
        f6Var4 = ((org.telegram.ui.ActionBar.f3) u41Var).resourcesProvider;
        d90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(i13, f6Var4));
    ...
    public g5(k41 k41Var, Context context, int i10, String str, CharSequence charSequence) {
        ...
        Drawable mutate = getContext().getResources().getDrawable(i10).mutate();
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        f6Var = ((org.telegram.ui.ActionBar.f3) k41Var).resourcesProvider;
        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, f6Var), PorterDuff.Mode.MULTIPLY));
        imageView.setImageDrawable(mutate);
        addView(imageView, w7.x5.d(24, 24.0f, z10 ? 5 : 3, z10 ? 0.0f : 27.0f, 6.0f, z10 ? 27.0f : 0.0f, 0.0f));
        TextView textView = new TextView(getContext());
        textView.setText(str);
        f6Var2 = ((org.telegram.ui.ActionBar.f3) k41Var).resourcesProvider;
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var2));
        com.google.android.gms.internal.vision.e2.m(14.0f, 1, textView);
        addView(textView, w7.x5.d(-2, -2.0f, z10 ? 5 : 3, z10 ? 27.0f : 68.0f, 0.0f, z10 ? 68.0f : 27.0f, 0.0f));
        d90 d90Var = new d90(getContext(), null);
        ...
        d90Var.setTextSize(1, 14.0f);
        int i12 = org.telegram.ui.ActionBar.j6.Pi;
        f6Var3 = ((org.telegram.ui.ActionBar.f3) k41Var).resourcesProvider;
        d90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, f6Var3));
        int i13 = org.telegram.ui.ActionBar.j6.gc;
        f6Var4 = ((org.telegram.ui.ActionBar.f3) k41Var).resourcesProvider;
        d90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(i13, f6Var4));
        d90Var.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
    ...
    public g5(Context context, int i10, String str, CharSequence charSequence, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        d90Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.y6, f6Var));
