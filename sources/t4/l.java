...
public final class l implements o4.t, u4.q {
    ...
    */
    public final void J(o4.s sVar, long j10) {
        boolean z4;
        List list;
        List list2;
        int i10;
        ...
        if (isEmpty) {
            ...
            if (i15 > 0) {
                ...
                if (z4 && z15) {
                    ...
                    if (o10 <= 0) {
                        ...
                        if (list6 != null) {
                            for (int i19 = 0; i19 < list6.size(); i19++) {
                                arrayList3.add(new s0(k0.j(i19, "main:cc:"), (j3.n0) list6.get(i19)));
                            }
                        }
                    } else {
                    ...
                    d.n((s0[]) arrayList3.toArray(new s0[0]), arrayList3.indexOf(s0Var));
                }
            } else {
                z10 = z13;
                i11 = size;
            ...
            if (z4) {
                ...
                d.n((s0[]) arrayList32.toArray(new s0[0]), arrayList32.indexOf(s0Var2));
            }
        }
        ...
        while (i21 < list.size()) {
            ...
            if (hashSet.add(str3)) {
                ...
                arrayList.add(d10);
                if (z4 && z16) {
                    d10.n(new s0[]{new s0(concat, (j3.n0[]) arrayList5.toArray(new j3.n0[0]))}, new int[0]);
                }
            } else {
                i10 = i21;
                list = list7;
        ...
        for (int i25 = 0; i25 < list2.size(); i25++) {
            ...
            StringBuilder m9 = k0.m(i25, "subtitle:", ":");
            String str5 = jVar2.c;
            ...
            arrayList.add(d11);
            d11.n(new s0[]{new s0(sb, n0Var5)}, new int[0]);
        }
            ...
            if (!z13) {
                ...
                if (rVar3.R != 0) {
                    ...
                    if (arrayList.isEmpty() || d0.a(cVar3, cVar2)) {
                        ...
                        if (rVar3.f0) {
                            ...
                            iArr2 = iArr4;
                            rVar = rVar3;
                            cVar5.v(j10, j11, -9223372036854775807L, rVar3.B, iVar2.a(i33, j10));
                            if (cVar5.i() != iVar3.h.a(i33.d)) {
                                z16 = true;
                            } else {
                                z16 = true;
                            }
                ...
                while (i16 < cVarArr.length) {
                    ...
                    if (iArr2[i16] == i35) {
                        ...
                        r82 = l0VarArr3;
                        r82[i16] = r72;
                        identityHashMap.put(r72, Integer.valueOf(i35));
                        z12 = true;
                    } else {
                        r82 = l0VarArr3;
                        if (iArr[i16] == i35) {
