...
public final class r implements h0, k0, n0, r3.m, j0 {
    ...
    public final void A(g5.j0 j0Var, long j10, long j11) {
        ...
        o4.j jVar = new o4.j();
        this.r.getClass();
        this.v.n(jVar, eVar.c, this.b, eVar.d, eVar.e, eVar.f, eVar.h, eVar.n);
        if (this.Q) {
            this.c.Z(this);
        } else {
            C(this.c0);
    ...
    */
    public final boolean C(long j10) {
        ...
        if (n()) {
            ...
            k j13 = j();
            max = j13.U ? j13.n : Math.max(this.c0, j13.h);
            list = this.B;
        }
        List list3 = list;
        ...
        k kVar4 = kVar3;
        int i13 = i10;
        iVar3.q.v(j10, j14, j16, list3, iVar3.a(kVar3, j18));
        int i14 = iVar3.q.i();
        boolean z15 = i13 != i14;
        Uri uri4 = uriArr[i14];
        if (cVar.c(uri4)) {
            ...
            long j20 = j19 - cVar.y;
            k kVar5 = kVar;
            Pair c3 = iVar3.c(kVar5, z16, a10, j20, j18);
            ...
            if (longValue >= a10.k || kVar5 == null || !z16) {
                ...
                j20 = a10.h - cVar.y;
                iVar = iVar3;
                Pair c10 = iVar.c(kVar5, false, a10, j20, j18);
            ...
            if (j22 < j23) {
                ...
                if (i15 == vVar.size()) {
                    ...
                    if (i12 < vVar2.size()) {
                        hVar = new h((u4.g) vVar2.get(i12), j22, i12);
                        if (hVar == null) {
                            if (!a10.o) {
                                oVar2.c = uri;
                                ...
                                hVar = new h((u4.g) s8.l.h(vVar), (j23 + vVar.size()) - 1, -1);
                            }
                        }
                        boolean z19 = hVar.d;
                        u4.g gVar = hVar.a;
                        ...
                        if (d == null) {
                            ...
                            if (d10 == null) {
                                    ...
                                    if (!z18 || j25 < kVar5.n) {
                                        ...
                                        if (z4 || !z19) {
                                            ...
                                            if (H2 != null) {
                                                ...
                                                z10 = z20;
                                                f1Var = f1Var2;
                                                bArr = (byte[]) ((d) f1Var.b).get(H2);
                                            }
                                            byte[] bArr4 = H != null ? null : (byte[]) ((d) f1Var.b).get(H);
                                            k3.k kVar6 = iVar.k;
                                            ...
                                            g5.p pVar2 = new g5.p(H3, 1, null, n0Var2, j27, j28, null, i16);
                                            z11 = bArr == null;
                                            if (z11) {
                                                bArr2 = null;
                                            } else {
                                            ...
                                            if (fVar == null) {
                                                ...
                                                g5.p pVar3 = new g5.p(H4, 1, null, n0Var2, j29, j30, null, 0);
                                                if (bArr4 != null) {
                                                    bArr3.getClass();
                                            ...
                                            boolean z24 = !z19;
                                            boolean z25 = gVar.v;
                                            SparseArray sparseArray = (SparseArray) oVar3.b;
                                            c0Var = (c0) sparseArray.get(i17);
                                            if (c0Var == null) {
                                                c0Var = new c0(9223372036854775806L);
                                                sparseArray.put(i17, c0Var);
                                            }
                                            oVar2.b = new k(jVar, mVar, pVar2, n0Var, z11, mVar2, pVar, z12, uri3, list2, k10, j26, j31, j32, j33, i18, z24, i17, z25, z10, c0Var, gVar.f, bVar, iVar4, wVar, z4, kVar2);
                                            z13 = oVar2.a;
                                            ...
                                            this.v.t(new o4.j(eVar.b), eVar.c, this.b, eVar.d, eVar.e, eVar.f, eVar.h, eVar.n);
                                            return true;
                                        }
                                    }
                                }
                                ...
                                g5.p pVar22 = new g5.p(H32, 1, null, n0Var22, j272, j282, null, i16);
                                if (bArr == null) {
                                }
                                if (z11) {
                                }
                                ...
                                boolean z242 = !z19;
                                boolean z252 = gVar.v;
                                SparseArray sparseArray2 = (SparseArray) oVar3.b;
                                c0Var = (c0) sparseArray2.get(i172);
                                if (c0Var == null) {
                                }
                                oVar2.b = new k(jVar2, mVar, pVar22, n0Var3, z11, mVar2, pVar, z12, uri3, list2, k102, j262, j312, j322, j332, i182, z242, i172, z252, z10, c0Var, gVar.f, bVar, iVar42, wVar, z4, kVar2);
                                z13 = oVar2.a;
                    ...
                    if (i12 == -1) {
                        hVar = new h(fVar3, j22, -1);
                    } else if (i12 < fVar3.x.size()) {
                        hVar = new h((u4.g) fVar3.x.get(i12), j22, i12);
                    } else {
                        int i22 = i15 + 1;
                        if (i22 < vVar.size()) {
                            hVar = new h((u4.g) vVar.get(i22), j22 + 1, -1);
                        } else {
                            if (!vVar2.isEmpty()) {
                                hVar = new h((u4.g) vVar2.get(0), j22 + 1, 0);
                            }
                            hVar = null;
                        }
                    }
    ...
    public final long X() {
        ...
        if (!j11.U) {
            ...
            j11 = arrayList.size() > 1 ? (k) a2.i(2, arrayList) : null;
        }
        if (j11 != null) {
            j10 = Math.max(j10, j11.n);
        }
        if (this.P) {
            for (q qVar : this.I) {
    ...
    public final c4.e m(g5.j0 j0Var, IOException iOException, int i10) {
        ...
        d0.S(eVar2.h);
        d0.S(eVar2.n);
        p2.w wVar = new p2.w(iOException, i10, 4);
        i iVar = this.d;
        g0 a2 = i7.a(iVar.q);
        this.r.getClass();
        ...
        c4.e eVar3 = eVar;
        boolean a10 = eVar3.a();
        this.v.q(jVar, eVar2.c, this.b, eVar2.d, eVar2.e, eVar2.f, eVar2.h, eVar2.n, iOException, !a10);
        if (!a10) {
            this.H = null;
        }
        if (z4) {
            ...
            while (i20 < length) {
                ...
                if (i20 == i16) {
                    ...
                    for (int i21 = 0; i21 < i18; i21++) {
                        ...
                        n0VarArr[i21] = i18 == 1 ? t10.c(n0Var3) : g(n0Var3, t10, true);
                    }
    ...
    public final void s(g5.j0 j0Var, long j10, long j11, boolean z4) {
        ...
        o4.j jVar = new o4.j();
        this.r.getClass();
        this.v.l(jVar, eVar.c, this.b, eVar.d, eVar.e, eVar.f, eVar.h, eVar.n);
        if (z4) {
            return;
        }
        if (n() || this.R == 0) {
