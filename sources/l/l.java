...
public class l implements Menu {
    ...
    public final n a(int i10, int i11, int i12, CharSequence charSequence) {
        ...
        n nVar = new n(this, i10, i11, i12, i15, charSequence, this.l);
    ...
    public final MenuItem findItem(int i10) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (nVar.hasSubMenu() && (findItem = nVar.o.findItem(i10)) != null) {
                return findItem;
            }
        }
        return null;
    ...
    public final void h(List list, int i10, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i10 == 67) {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                n nVar = (n) arrayList.get(i11);
                if (nVar.hasSubMenu()) {
                    nVar.o.h(list, i10, keyEvent);
                }
                char c3 = n10 ? nVar.j : nVar.h;
                if ((modifiers & 69647) == ((n10 ? nVar.k : nVar.i) & 69647) && c3 != 0) {
                    char[] cArr = keyData.meta;
    ...
    */
    public final boolean q(MenuItem menuItem, y yVar, int i10) {
        ...
        l lVar = nVar.n;
        MenuItem.OnMenuItemClickListener onMenuItemClickListener = nVar.p;
        if ((onMenuItemClickListener == null || !onMenuItemClickListener.onMenuItemClick(nVar)) && !lVar.e(lVar, nVar)) {
            ...
            o oVar = nVar.A;
            if (oVar == null || !oVar.a.onPerformDefaultAction()) {
                z4 = false;
                o oVar2 = nVar.A;
                boolean z10 = oVar2 == null && oVar2.a.hasSubMenu();
                if (!nVar.e()) {
                    z4 |= nVar.expandActionView();
                    if (z4) {
                        c(true);
                    }
                    ...
                    if (!nVar.hasSubMenu()) {
                        e0 e0Var = new e0(this.a, this, nVar);
                        nVar.o = e0Var;
                        e0Var.setHeaderTitle(nVar.e);
                    }
                    e0 e0Var2 = nVar.o;
                    if (z10) {
                        oVar2.a.onPrepareSubMenu(e0Var2);
                    }
                    CopyOnWriteArrayList copyOnWriteArrayList = this.u;
                    if (!copyOnWriteArrayList.isEmpty()) {
                        r0 = yVar != null ? yVar.j(e0Var2) : false;
                        Iterator it = copyOnWriteArrayList.iterator();
                        while (it.hasNext()) {
                            WeakReference weakReference = (WeakReference) it.next();
    ...
    public final void removeGroup(int i10) {
        ...
        while (true) {
            if (i12 >= size) {
                i12 = -1;
                break;
            } else if (((n) arrayList.get(i12)).b == i10) {
                break;
            } else {
                i12++;
            }
        ...
        if (i12 >= 0) {
            ...
            while (true) {
                int i13 = i11 + 1;
                if (i11 >= size2 || ((n) arrayList.get(i12)).b != i10) {
                    break;
                }
    ...
    public final void removeItem(int i10) {
        ...
        while (true) {
            if (i11 >= size) {
                i11 = -1;
                break;
            } else if (((n) arrayList.get(i11)).a == i10) {
                break;
            } else {
                i11++;
            }
    ...
    public final SubMenu addSubMenu(int i10, int i11, int i12, CharSequence charSequence) {
        ...
        e0 e0Var = new e0(this.a, this, a2);
        a2.o = e0Var;
